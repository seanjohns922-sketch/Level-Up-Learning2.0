...
const Y3_MEASURELANDS_LESSONS: Y3MeasurelandsLessonEntry[] = [
  ...
  },
  {
    ...
    practisedSkills: ["Recognise angles as turns", "Find angles in everyday objects", "Ignore arm length"],
    completionTitle: "Angles as Turns Complete!",
    unlockMessage: "Lesson 2 unlocked.",
  ...
  },
  {
    ...
    week: 7,
    lessonNumber: 2,
    title: "Compare with a Right Angle",
    subtitle: "Angle Turns",
    ...
    practisedSkills: ["Use a right-angle benchmark", "Compare angle size", "Ignore orientation"],
    completionTitle: "Right-Angle Comparison Complete!",
    unlockMessage: "Lesson 3 unlocked.",
    returnRoute: "/program?year=Year 3&week=7&legacy=1&realm_id=measurement",
  },
  {
    ...
    practisedSkills: ["Compare everyday angles", "Use a right-angle benchmark", "Explain turn size"],
  ...
  },
  {
    ...
    practisedSkills: ["Choose a metric unit", "Estimate from a benchmark", "Check reasonableness"],
    completionTitle: "Estimate and Check Complete!",
    unlockMessage: "Lesson 2 unlocked.",
  ...
  },
  {
    ...
    practisedSkills: ["Compare formal time units", "Reason about duration", "Explain a time comparison"],
    completionTitle: "Time Reasoning Complete!",
    unlockMessage: "Lesson 3 unlocked.",
    returnRoute: "/program?year=Year 3&week=8&legacy=1&realm_id=measurement",
  },
  {
    ...
    practisedSkills: ["Recognise angles as turns", "Use a right-angle benchmark", "Compare everyday angles"],
    completionTitle: "Angle Mission Complete!",
