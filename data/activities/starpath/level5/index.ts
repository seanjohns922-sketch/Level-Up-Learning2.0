...
export const LEVEL_FIVE_LESSON_CONTENT: Record<string, StarpathLessonContent> = {
  ...
  "y5-space-w2-l1": FOLD_NET_CONTENT,
  "y5-space-w2-l2": TRACK_FACE_CONTENT,
  "y5-space-w2-l3": RELATION_CONTENT,
  "y5-space-w3-l1": COMPARE_NETS_CONTENT,
  "y5-space-w3-l2": ARRANGE_CONTENT,
  "y5-space-w3-l3": TEST_FOLD_CONTENT,
