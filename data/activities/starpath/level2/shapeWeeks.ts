...
export const createSameFeatureTaskSet = (): RealmLessonTaskSet =>
  set(0, [(r, t) => compareTask(r, t, "same"), (r, t) => compareTask(r, t, "same"), (r, t) => compareTask(r, t, "same")], teaching("featureCompare", "What is the same?", "Find what is the same about two shapes.", "Look at two shapes. Work out what is the same about them."));
export const createWhatIsDifferentTaskSet = (): RealmLessonTaskSet =>
  set(0, [(r, t) => compareTask(r, t, "diff"), (r, t) => compareTask(r, t, "diff"), (r, t) => compareTask(r, t, "diff")], teaching("featureCompare", "What Is Different?", "Find the difference.", "Compare two shapes and find what is different about them."));
