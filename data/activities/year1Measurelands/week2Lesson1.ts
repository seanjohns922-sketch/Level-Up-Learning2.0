...
export const MASS_OBJECTS: MassObject[] = [
  ...
  { id: "orange", label: "Orange", image: `${BASE}/orange.png`, cubes: 3, look: 2 },
  { id: "boot", label: "Shoe", image: `${BASE}/boot.png`, cubes: 5, look: 3 },
  { id: "bucket", label: "Bucket", image: `${BASE}/bucket.png`, cubes: 5, look: 4 },
  { id: "lunchbox", label: "Lunchbox", image: `${BASE}/lunchbox.png`, cubes: 5, look: 3 },
  { id: "drink-bottle", label: "Drink Bottle", image: `${BASE}/drink-bottle.png`, cubes: 6, look: 3 },
  ...
  { id: "brick", label: "Brick", image: `${BASE}/brick.png`, cubes: 9, look: 2 },
  ...
  { id: "teddy-bear", label: "Teddy Bear", image: `${BASE}/teddy-bear.png`, cubes: 3, look: 5 },
