...
function buildIntroTask(): ToolTask {
  return {
    ...
    introTools: [
      ...
      { id: "mass", label: "Mass", focus: "How heavy?", iconKey: "cubes" },
...
const TOOL_SPECS: ToolSpec[] = [
  {
    ...
    tools: [
      ...
      { id: "ruler", label: "Small ruler", iconKey: "ruler" },
      { id: "scales", label: "Kitchen scales", iconKey: "cubes" },
    ],
    correctToolId: "wheel",
  ...
  },
  {
    ...
    tools: [
      { id: "ruler", label: "Ruler", iconKey: "ruler" },
      { id: "wheel", label: "Trundle wheel", iconKey: "wheel" },
      { id: "jug", label: "Measuring jug", iconKey: "bottle" },
    ],
    correctToolId: "ruler",
  ...
  },
  {
    ...
    tools: [
      { id: "mass", label: "Mass (scales)", iconKey: "cubes" },
      { id: "length", label: "Length (ruler)", iconKey: "ruler" },
      { id: "capacity", label: "Capacity (jug)", iconKey: "bottle" },
    ],
    correctToolId: "mass",
  ...
  },
  {
    ...
    tools: [
      { id: "perimeter", label: "Perimeter", iconKey: "tape" },
      { id: "area", label: "Area", iconKey: "oval" },
      { id: "mass", label: "Mass", iconKey: "cubes" },
    ],
  ...
  },
  {
    ...
    tools: [
      { id: "area", label: "Area", iconKey: "oval" },
      { id: "perimeter", label: "Perimeter", iconKey: "tape" },
      { id: "capacity", label: "Capacity", iconKey: "bottle" },
    ],
    correctToolId: "area",
