...
const TEACHING_MOMENTS: NonNullable<CompareTask["teachingMoments"]> = [
  {
    ...
    objects: [
      { ...toTeachingObj(CONTAINERS.cup, "sky", 0), label: "Tiny Cup" },
      toTeachingObj(CONTAINERS.bottle, "rose", 0),
      toTeachingObj(CONTAINERS.bucket, "gold", 0),
    ],
    left: { ...toTeachingObj(CONTAINERS.cup, "sky", 0), label: "Tiny Cup" },
    right: toTeachingObj(CONTAINERS.bucket, "gold", 0),
  ...
  },
  {
    ...
    objects: [
      toTeachingObj(CONTAINERS.bottle, "rose", 0),
      toTeachingObj(CONTAINERS.fishTank, "sky", 0),
      toTeachingObj(CONTAINERS.bathtub, "gold", 0),
    ],
    left: toTeachingObj(CONTAINERS.bottle, "rose", 0),
    right: toTeachingObj(CONTAINERS.bathtub, "gold", 0),
