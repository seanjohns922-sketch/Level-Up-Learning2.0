...
import {
  generateY2MeasurelandsWeek7Lesson2Task,
...
const Y2_MEASURELANDS_LESSONS: Y2MeasurelandsLessonEntry[] = [
  ...
  },
  {
    ...
    practisedSkills: [
      "Recognising equal halves and quarters",
      "Recognising eighths",
      "Connecting fractional parts to events",
    ],
    completionTitle: "Equal Parts Complete!",
    unlockMessage: "Week complete.",
    returnRoute: "/program?year=Year 2&week=5&legacy=1&realm_id=measurement",
  },
  {
  ...
  },
  {
    ...
    practisedSkills: [
      "Identifying quarter and half turns",
      "Identifying three-quarter and full turns",
      "Tracking the starting direction",
      "Distinguishing turn size from direction",
    ],
    completionTitle: "Fractional Turns Complete!",
    unlockMessage: "Week complete.",
    returnRoute: "/program?year=Year 2&week=6&legacy=1&realm_id=measurement",
  },
  {
  ...
  {
    prefix: "y2-measurement-w7-l2",
    week: 7,
    lessonNumber: 2,
    title: "How Many Days Until?",
    subtitle: "Calendar Keep",
    generate: generateY2MeasurelandsWeek7Lesson2Task,
    reset: resetY2MeasurelandsWeek7Lesson2TaskSessionState,
    quizContributionBuilder: buildY2MeasurelandsWeek7Lesson2QuizTasks,
    practisedSkills: [
      "Starting at today's date on a calendar",
      "Counting forward one day at a time",
      "Finding how many days until a familiar event",
      "Comparing which event happens first",
    ],
  ...
  },
  {
    ...
    practisedSkills: [
      ...
      "Applying mixed length, mass, capacity, clock and calendar skills",
      "Explaining measurement reasoning",
    ],
