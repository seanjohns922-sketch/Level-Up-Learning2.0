...
const Y2_MEASURELANDS_LESSONS: Y2MeasurelandsLessonEntry[] = [
  ...
  },
  {
    ...
    practisedSkills: [
      "Noticing that some measurements don't finish on a whole block",
      "Judging exact vs in-between from a measurement bar",
      "Understanding a measurement is not always a whole number",
    ],
    completionTitle: "Exact Detective Complete!",
    unlockMessage: "Lesson 2 unlocked.",
