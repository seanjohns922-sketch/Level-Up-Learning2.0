...
const Y2_MEASURELANDS_LESSONS: Y2MeasurelandsLessonEntry[] = [
  ...
  },
  {
    ...
    week: 4,
    lessonNumber: 3,
    title: "Measure with Different Informal Units",
    subtitle: "Closer Count",
    ...
    practisedSkills: [
      "Choosing everyday objects as informal measuring units",
      "Explaining why different-sized units make different counts",
      "Choosing a practical informal unit for the object being measured",
    ],
    completionTitle: "Informal Unit Expert Complete!",
    unlockMessage: "Week complete.",
    returnRoute: "/program?year=Year 2&week=4&legacy=1&realm_id=measurement",
  },
];
