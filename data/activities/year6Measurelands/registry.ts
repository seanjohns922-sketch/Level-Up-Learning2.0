...
const BUILT_LESSONS: Record<string, BuiltOverride> = {
  ...
  "y6-measurement-w3-l1": {
    ...
    practisedSkills: ["Choose rectangle dimensions", "Apply the area formula", "Solve practical area designs"],
    completionTitle: "Area Design Choices Complete!",
  },
  "y6-measurement-w3-l2": {
    ...
    practisedSkills: ["Split a practical layout", "Calculate each rectangle area", "Combine areas accurately"],
    completionTitle: "Composite Area Complete!",
  },
  "y6-measurement-w3-l3": {
    ...
    practisedSkills: ["Compare area strategies", "Solve design constraints", "Justify an efficient solution"],
    completionTitle: "Area Constraints Complete!",
  },
  ...
  "y6-measurement-w8-l2": {
    ...
    practisedSkills: ["Combine area, perimeter and conversions", "Interpret and compare measurements", "Optimise a real design"],
