...
export type TermPositionCardVisualData = {
  type: "term_position_card";
  title: string;
  pairs: Array<{
    term: string;
    value: string;
...
function generateGenericQuestion(
  ...
  if (explicitMode === "y6_common_denominator_find_smart") {
    const templates: Array<TypedResponseQuestion> = [
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 5/12 and 7/18.",
        answer: "36",
        helper: "List multiples quickly, then choose the smallest shared one.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 3/8 and 5/12.",
        answer: "24",
        helper: "Look for the first shared multiple.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 7/15 and 2/9.",
        answer: "45",
        helper: "Use multiples and factor thinking together.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 4/14 and 5/21.",
        answer: "42",
        helper: "The best denominator is the smallest useful shared multiple.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 11/16 and 3/20.",
        answer: "80",
        helper: "One denominator may need more scaling than the other.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 5/18 and 7/24.",
        answer: "72",
        helper: "Check common factors before listing too many multiples.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 2/15 and 9/20.",
        answer: "60",
        helper: "A shared multiple works, but the best one is the lowest.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 7/10 and 11/15.",
        answer: "30",
        helper: "Think about factor links between 10 and 15.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 5/14 and 3/8.",
        answer: "56",
        helper: "Use the least common multiple, not just any large multiple.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 4/9 and 7/12.",
        answer: "36",
        helper: "Choose the most efficient shared multiple.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 13/18 and 5/27.",
        answer: "54",
        helper: "Use factor reasoning before over-listing multiples.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 7/16 and 9/24.",
        answer: "48",
        helper: "One denominator may already be close to the shared multiple.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 8/21 and 5/14.",
        answer: "42",
        helper: "Think about the shared factor in 21 and 14.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 3/25 and 7/15.",
        answer: "75",
        helper: "The smallest shared multiple keeps the work efficient.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 11/18 and 7/30.",
        answer: "90",
        helper: "Some pairs need a bigger denominator, but still the lowest one.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 9/20 and 11/28.",
        answer: "140",
        helper: "Check common factors before multiplying everything.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 5/18 and 11/12.",
        answer: "36",
        helper: "Look for a shared multiple that fits both denominators quickly.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 7/22 and 3/33.",
        answer: "66",
        helper: "The best denominator is any shared multiple, but choose the lowest.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 4/15 and 13/25.",
        answer: "75",
        helper: "Use factor links to avoid unnecessarily large numbers.",
        placeholder: "Type the denominator",
      },
      {
        kind: "typed_response",
        prompt: "Find the lowest common denominator of 7/18, 5/12, and 11/9.",
        answer: "36",
        helper: "For three fractions, use one denominator that works for all of them.",
        placeholder: "Type the denominator",
      },
    ];
    const chosen = templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  ...
  if (explicitMode === "y6_common_denominator_build_equivalents") {
    const templates: Array<TypedResponseQuestion> = [
      ...
      {
        kind: "typed_response",
        prompt: "Rewrite both fractions with denominator 36: 5/12 and 7/18.",
        answer: "15/36 and 14/36",
        helper: "Rename both fractions using the same denominator.",
        placeholder: "Type both fractions",
      },
      {
        kind: "typed_response",
        prompt: "Rewrite both fractions with denominator 30: 2/3 and 7/10.",
        answer: "20/30 and 21/30",
        helper: "Build both equivalent fractions carefully.",
        placeholder: "Type both fractions",
      },
      {
        kind: "typed_response",
        prompt: "Rewrite both fractions with denominator 42: 5/14 and 8/21.",
        answer: "15/42 and 16/42",
        helper: "Match both fractions to the same denominator.",
        placeholder: "Type both fractions",
      },
      {
        kind: "typed_response",
      ...
      {
        kind: "typed_response",
        prompt: "Rewrite both fractions with denominator 90: 11/18 and 7/30.",
        answer: "55/90 and 21/90",
        helper: "Both equivalent fractions should share the same denominator.",
        placeholder: "Type both fractions",
      },
    ];
    const chosen = templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  ...
  if (explicitMode === "y6_common_denominator_choose_strategy") {
    const templates: Array<MultipleChoiceQuestion> = [
      {
        kind: "multiple_choice",
        prompt: "Which is the best common denominator for 4/9 and 5/6?",
        options: ["18", "36", "54"],
        answer: "18",
        helper: "Choose the lowest shared multiple that works.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which pair has the largest lowest common denominator?",
        options: ["1/8 and 1/12", "1/9 and 1/10", "1/6 and 1/15"],
        answer: "1/9 and 1/10",
        helper: "Compare the LCMs, not just the denominators.",
      },
      {
        kind: "multiple_choice",
        prompt: "A student rewrites 2/3 as 8/12 to match 5/12. Is this efficient?",
        options: ["Yes", "No"],
        answer: "Yes",
        helper: "Twelve is the lowest common denominator here, so the method is efficient.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which denominator would you choose first for 3/5 and 7/10?",
        options: ["10", "20", "50"],
        answer: "10",
        helper: "Pick the smallest denominator that already works for both.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is more efficient: 4/6 → 8/12 or 4/6 → 2/3?",
        options: ["4/6 → 8/12", "4/6 → 2/3", "Both are equally efficient"],
        answer: "4/6 → 2/3",
        helper: "Simplifying first can make later comparison faster.",
      },
      {
        kind: "multiple_choice",
        prompt: "To compare 5/8 and 7/12, which denominator is best?",
        options: ["24", "96", "120"],
        answer: "24",
        helper: "Use the smallest useful common denominator.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is the best denominator for 7/12, 5/18, and 11/9?",
        options: ["18", "36", "72"],
        answer: "36",
        helper: "One denominator must work efficiently for all three fractions.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is the best reason to avoid 72 for 4/9 and 5/6?",
        options: [
          "72 is a common denominator but not the lowest one",
          "72 cannot be used as a denominator",
          "72 changes the value of the fractions",
        ],
        answer: "72 is a common denominator but not the lowest one",
        helper: "A common denominator can work without being the most efficient.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which denominator is most efficient for 3/8 and 5/12?",
        options: ["24", "48", "96"],
        answer: "24",
        helper: "The first shared multiple is usually best.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which strategy is best first for denominators 15 and 20?",
        options: ["Use factor thinking", "Jump to 300", "Convert to decimals"],
        answer: "Use factor thinking",
        helper: "Factors help you reach the LCM faster.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which denominator would you choose to compare 5/14 and 3/8?",
        options: ["56", "112", "224"],
        answer: "56",
        helper: "The smallest shared multiple keeps the comparison efficient.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which explanation is correct?",
        options: [
          "A common denominator is any shared multiple, but the best one is usually the lowest",
          "The largest common denominator is always the best",
          "Any denominator larger than both denominators is efficient",
        ],
        answer: "A common denominator is any shared multiple, but the best one is usually the lowest",
        helper: "Efficiency matters, not just correctness.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which denominator should you choose first for 11/16 and 3/20?",
        options: ["80", "160", "320"],
        answer: "80",
        helper: "Choose the denominator that works with the least extra scaling.",
      },
      {
        kind: "multiple_choice",
        prompt: "Why is 120 a useful denominator for 8 and 15?",
        options: [
          "Because it is the lowest common multiple",
          "Because it is even",
          "Because it is larger than both denominators",
        ],
        answer: "Because it is the lowest common multiple",
        helper: "Sometimes the LCD is large, but it is still the best shared denominator.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which denominator is best for 7/10 and 11/15?",
        options: ["30", "60", "90"],
        answer: "30",
        helper: "Think about factor links before jumping to large multiples.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which pair is easiest to compare with denominator 30?",
        options: ["2/3 and 7/10", "5/8 and 7/12", "11/16 and 3/20"],
        answer: "2/3 and 7/10",
        helper: "Choose the pair whose denominators fit 30 exactly.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which denominator is best for 13/18 and 5/27?",
        options: ["54", "108", "162"],
        answer: "54",
        helper: "Use the lowest shared multiple, not just any multiple.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is more efficient for 6 and 9?",
        options: ["Use 18", "Use 54", "Use 108"],
        answer: "Use 18",
        helper: "The smallest working denominator is usually the smartest choice.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which denominator should you choose first for 4/15 and 13/25?",
        options: ["75", "150", "300"],
        answer: "75",
        helper: "You only need one shared denominator, not the biggest one you can find.",
      },
      {
        kind: "multiple_choice",
        prompt: "Why is choosing 180 for 3/8 and 5/12 not efficient?",
        options: [
          "Because 24 already works",
          "Because 180 is not a common multiple",
          "Because larger denominators are never allowed",
        ],
        answer: "Because 24 already works",
        helper: "Use the lowest common denominator when you can.",
      },
    ];
    const chosen = templates[randInt(0, templates.length - 1)] ?? templates[0]!;
    return {
  ...
  if (explicitMode === "y6_fraction_quantity_structure") {
    const templates: Array<TypedResponseQuestion> = [
      {
        kind: "typed_response",
        prompt: "1/7 of 42 = ?",
        answer: "6",
        helper: "Scale the whole by the fraction.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "4/7 of 42 = ?",
        answer: "24",
        helper: "Find the unit fraction first, then scale up.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 1/9 of a number is 6, what is the whole?",
        answer: "54",
        helper: "Scale back from the part to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 3/8 of a number is 15, what is the whole?",
        answer: "40",
        helper: "Work out 1/8 first, then rebuild the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 5/6 of a number is 35, what is the whole?",
        answer: "42",
        helper: "Find the value of 1/6 before scaling back up.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 2/5 of a number is 18, what is the whole?",
        answer: "45",
        helper: "Find 1/5 first, then the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "3/8 of 64 = ?",
        answer: "24",
        helper: "Use the structure of eighths.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "5/9 of 45 = ?",
        answer: "25",
        helper: "Scale from ninths to five ninths.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 7/10 of a number is 42, what is the whole?",
        answer: "60",
        helper: "Use 1/10 as the key part.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 4/11 of a number is 20, what is the whole?",
        answer: "55",
        helper: "Find one part first, then scale back.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "2/7 of 63 = ?",
        answer: "18",
        helper: "Find 1/7 first, then double it.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "6/11 of 88 = ?",
        answer: "48",
        helper: "Use elevenths as the scaling unit.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 3/5 of a number is 27, what is the whole?",
        answer: "45",
        helper: "Backtrack from three fifths to one fifth.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 4/9 of a number is 32, what is the whole?",
        answer: "72",
        helper: "A reverse fraction problem still uses scaling.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "5/12 of 84 = ?",
        answer: "35",
        helper: "Partition into twelfths, then scale to five twelfths.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 7/8 of a number is 49, what is the whole?",
        answer: "56",
        helper: "Find the missing one eighth first.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "3/10 of 90 = ?",
        answer: "27",
        helper: "Use tenths efficiently.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 5/12 of a number is 25, what is the whole?",
        answer: "60",
        helper: "Convert five twelfths back to one twelfth.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "8/15 of 75 = ?",
        answer: "40",
        helper: "Use the denominator to structure the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "If 9/14 of a number is 45, what is the whole?",
        answer: "70",
        helper: "Reverse-scale from nine parts to fourteen.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
    ];
  ...
  if (explicitMode === "y6_fraction_quantity_nonclean") {
    const templates: Array<TypedResponseQuestion | MultipleChoiceQuestion> = [
      ...
      },
      {
        ...
        prompt: "7/9 of 36 = ?",
        answer: "28",
        helper: "Scale the quantity by sevenths of ninths structure.",
        placeholder: "Type a fraction or mixed number",
        inputType: "flexible_fraction",
      },
      {
      ...
      },
      {
        ...
        prompt: "4/7 of 35 = ?",
        answer: "20",
        helper: "Scale the whole in equal sevenths first.",
        placeholder: "Type a fraction or mixed number",
        inputType: "flexible_fraction",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is greater: 3/5 of 40 or 2/3 of 40?",
        options: ["3/5 of 40", "2/3 of 40", "They are equal"],
        answer: "2/3 of 40",
        helper: "Compare the scaled values, not just the fractions.",
      },
      {
        kind: "typed_response",
        prompt: "5/6 of 22 = ?",
      ...
      },
      {
        ...
        prompt: "11/15 of 30 = ?",
        answer: "22",
        helper: "The structure can still produce a whole result.",
        placeholder: "Type a fraction or mixed number",
        inputType: "flexible_fraction",
      },
      {
      ...
      {
        kind: "multiple_choice",
        prompt: "Which is greater: 5/8 of 32 or 3/4 of 32?",
        options: ["5/8 of 32", "3/4 of 32", "They are equal"],
        answer: "3/4 of 32",
        helper: "Use the same whole to compare the scaled results.",
      },
      {
        kind: "typed_response",
        prompt: "9/10 of 26 = ?",
      ...
      },
      {
        ...
        prompt: "7/11 of 44 = ?",
        answer: "28",
        helper: "Sometimes the common structure still gives a whole number.",
        placeholder: "Type a fraction or mixed number",
        inputType: "flexible_fraction",
      },
      {
      ...
      {
        kind: "multiple_choice",
        prompt: "Which is greater: 7/10 of 45 or 3/4 of 45?",
        options: ["7/10 of 45", "3/4 of 45", "They are equal"],
        answer: "3/4 of 45",
        helper: "Scale both using the same whole, then compare.",
      },
      {
        kind: "typed_response",
        prompt: "2/7 of 31 = ?",
      ...
      },
      {
        ...
        prompt: "11/18 of 54 = ?",
        answer: "33",
        helper: "The whole can still scale to a clean result.",
        placeholder: "Type a fraction or mixed number",
        inputType: "flexible_fraction",
      },
      {
      ...
      {
        kind: "multiple_choice",
        prompt: "Which is greater: 4/5 of 27 or 7/9 of 27?",
        options: ["4/5 of 27", "7/9 of 27", "They are equal"],
        answer: "4/5 of 27",
  ...
  if (explicitMode === "y6_fraction_quantity_multistep") {
    const templates: Array<TypedResponseQuestion> = [
      {
        kind: "typed_response",
        prompt: "A tank holds 72 L. It is filled to 5/6 capacity. How much water is in the tank?",
        answer: "60",
        helper: "Scale the full capacity by the fraction filled.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt:
          "A student completes 3/4 of a 64-question test. Then completes 1/2 of the remaining questions. How many questions have they completed in total?",
        answer: "56",
        helper: "Track the first fraction, the remainder, then the second fraction.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          ...
          start: "1",
          steps: [
            { kind: "remove", fraction: "3/4", stageLabel: "Completed first" },
            { kind: "remove", fraction: "1/8", stageLabel: "Completed second" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "2/5 of a number is 18. What is the number?",
        answer: "45",
        helper: "Reverse-scale from the known fraction back to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A rope is 60 m long. 2/3 is used. Then 1/4 of the remainder is used. How much rope is left?",
        answer: "15",
        helper: "Use the fraction of the whole, then the fraction of the remainder.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          context: "rope",
          title: "Rope remaining",
          start: "1",
          steps: [
            { kind: "remove", fraction: "2/3", stageLabel: "First part used" },
            { kind: "remove", fraction: "1/12", stageLabel: "More used from the remainder" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "A tank is 3/4 full with 27 L. What is the full capacity?",
        answer: "36",
        helper: "Find the value of 1/4 first, then scale to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A project is 2/3 complete after 18 tasks. How many tasks are in the whole project?",
        answer: "27",
        helper: "Backtrack from the known fraction to the whole amount.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        visual: makeFractionContextVisual({
          ...
          start: "1",
          steps: [
            { kind: "remove", fraction: "5/8", stageLabel: "Completed first" },
            { kind: "remove", fraction: "3/32", stageLabel: "Completed from the remainder" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "A book has 84 pages. A student reads 2/7 of it, then 1/3 of the remaining pages. How many pages have been read in total?",
        answer: "36",
        helper: "Track both reading stages separately before adding them.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          context: "book",
          ...
          start: "1",
          steps: [
            { kind: "remove", fraction: "2/7", stageLabel: "Read first" },
            { kind: "remove", fraction: "5/21", stageLabel: "Read from the remainder" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "A container is 4/5 full with 32 L. What is its full capacity?",
        answer: "40",
        helper: "Use the known part to reconstruct the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        visual: makeFractionContextVisual({
          ...
          start: "7/9",
          steps: [{ kind: "remove", fraction: "7/27", stageLabel: "Fuel used" }],
        }),
      },
      {
        kind: "typed_response",
        prompt: "A runner completes 3/5 of a 50 km event. Then completes 1/2 of the remaining distance. How far has the runner completed in total?",
        answer: "40",
        helper: "Use the remainder as the new whole for the second step.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          context: "runner",
          ...
          start: "1",
          steps: [
            { kind: "remove", fraction: "3/5", stageLabel: "Completed first" },
            { kind: "remove", fraction: "1/5", stageLabel: "Completed from the remainder" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "3/8 of a tank is 21 L. What is the full capacity?",
        answer: "56",
        helper: "Reverse-scale from the known fraction to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A project has 96 tasks. 5/8 are completed, then 1/3 of the remaining tasks are completed. How many tasks are completed in total?",
        answer: "76",
        helper: "First track the completed fraction, then the fraction of what remains.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          context: "project",
          ...
          steps: [
            { kind: "remove", fraction: "5/8", stageLabel: "Completed first" },
            { kind: "remove", fraction: "1/8", stageLabel: "Completed from the remainder" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "A rope is 48 m long. 5/6 is used. Then 1/2 of the remainder is used. How much rope is left?",
        answer: "4",
        helper: "Use the remainder after the first fraction before the second step.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          context: "rope",
          ...
          start: "1",
          steps: [
            { kind: "remove", fraction: "5/6", stageLabel: "First part used" },
            { kind: "remove", fraction: "1/12", stageLabel: "Half of the remainder used" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "A tank is 7/10 full with 42 L. What is the full capacity?",
        answer: "60",
        helper: "Find 1/10 first, then scale to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A trail is 36 km long. A walker completes 5/9 of it, then 1/4 of the remaining distance. How far has the walker completed in total?",
        answer: "24",
        helper: "Track each stage carefully using the remainder.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          context: "trail",
          ...
          start: "1",
          steps: [
            { kind: "remove", fraction: "5/9", stageLabel: "Completed first" },
            { kind: "remove", fraction: "1/9", stageLabel: "Completed from the remainder" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "4/7 of a number is 20. What is the number?",
        answer: "35",
        helper: "Use one seventh as the unit to scale back.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A tank holds 84 L. It is filled to 11/12 capacity. How much water is in the tank?",
        answer: "77",
        helper: "Scale the whole by the fraction filled.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A book has 120 pages. A student reads 3/5, then 1/4 of the remaining pages. How many pages are still unread?",
        answer: "30",
        helper: "Track what is read first, then what remains unread.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: makeFractionContextVisual({
          context: "book",
          ...
          start: "1",
          steps: [
            { kind: "remove", fraction: "3/5", stageLabel: "Read first" },
            { kind: "remove", fraction: "1/10", stageLabel: "Read from the remainder" },
          ],
        }),
      },
      {
        kind: "typed_response",
        prompt: "A container is 5/8 full with 25 L. What is the full capacity?",
        answer: "40",
        helper: "Backtrack from the known fraction of the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
    ];
  ...
  if (explicitMode === "y6_percent_benchmark") {
    const templates: Array<TypedResponseQuestion> = [
      ...
      },
      {
        ...
        prompt: "50% of 86 = ?",
        answer: "43",
        helper: "A half is a benchmark fraction.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      },
      {
        ...
        prompt: "10% of 730 = ?",
        answer: "73",
        helper: "Ten percent scales the whole by one tenth.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "75% of 84 = ?",
        answer: "63",
        helper: "Three quarters is a fast benchmark.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      },
      {
        ...
        prompt: "50% of 118 = ?",
        answer: "59",
        helper: "Half of the amount gives 50%.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "25% of 92 = ?",
        answer: "23",
        helper: "Quartering is efficient here.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "10% of 640 = ?",
        answer: "64",
        helper: "Move to one tenth of the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "75% of 96 = ?",
        answer: "72",
        helper: "Use three lots of one quarter or three quarters directly.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      },
      {
        ...
        prompt: "5% of 380 = ?",
        answer: "19",
        helper: "Five percent is half of ten percent.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "50% of 154 = ?",
        answer: "77",
        helper: "Half is still the fastest method.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "25% of 124 = ?",
        answer: "31",
        helper: "Quarter the whole efficiently.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "10% of 980 = ?",
        answer: "98",
        helper: "Use the fraction one tenth.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
    ];
  ...
  if (explicitMode === "y6_percent_break_apart") {
    const templates: Array<TypedResponseQuestion | MultipleChoiceQuestion> = [
      ...
      },
      {
        ...
        prompt: "15% of 60 = ?",
        answer: "9",
        helper: "Break 15% into parts you know.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      },
      {
        ...
        prompt: "65% of 40 = ?",
        answer: "26",
        helper: "Break it into 50%, 10%, and 5%.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      },
      {
        ...
        prompt: "35% of 140 = ?",
        answer: "49",
        helper: "Scale 30% and 5% separately.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "12% of 75 = ?",
        answer: "9",
        helper: "Use 10% and 2% efficiently.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "65% of 120 = ?",
        answer: "78",
        helper: "Break the percentage into easier parts.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        prompt: "30% of 95 = ?",
        answer: "28.5",
        helper: "Three lots of 10% can produce a decimal result.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
      ...
      },
      {
        ...
        prompt: "35% of 66 = ?",
        answer: "23.1",
        helper: "Break the percent into benchmark parts.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
      ...
      },
      {
        ...
        prompt: "65% of 68 = ?",
        answer: "44.2",
        helper: "Use 50%, 10%, and 5%.",
        placeholder: "Type the answer",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easier to calculate first: 35% of 80 or 7/20 of 80?",
        options: ["35% of 80", "7/20 of 80", "They are exactly the same difficulty"],
        answer: "7/20 of 80",
        helper: "Equivalent forms can make the scaling faster.",
      },
      {
        kind: "typed_response",
        prompt: "45% of 84 = ?",
      ...
      },
      {
        ...
        prompt: "18% of 90 = ?",
        answer: "16.2",
        helper: "Use 10%, 5%, and 3% efficiently.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "35% of 48 = ?",
        answer: "16.8",
        helper: "Break 35% into easier pieces.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "12% of 240 = ?",
        answer: "28.8",
        helper: "Use 10% and 2% on the same whole.",
        placeholder: "Type the answer",
      },
    ];
    return templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  ...
  if (explicitMode === "y6_percent_real_multistep") {
    const templates: Array<TypedResponseQuestion | MultipleChoiceQuestion> = [
      ...
      {
        kind: "typed_response",
        prompt: "A shop increases a price of $60 by 20%. What is the new price?",
        answer: "72",
        helper: "Find the increase, then add it to the original price.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: {
          type: "percent_structured_method",
          ...
          steps: [
            { prompt: "What is 10% of 60?", answer: "6" },
            { prompt: "What is 20% of 60?", answer: "12" },
            { prompt: "Add the increase to 60. What is the new price?", answer: "72" },
          ],
        },
      },
      {
        kind: "typed_response",
        prompt: "A student completes 40% of a 50-question test. Then completes 20% more. How many questions have they completed in total?",
        answer: "30",
        helper: "Find each percentage of the full test, then combine them.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: {
          type: "multi_step_method",
          title: "Percentage progress",
          contextLabel: "Track the two percentage parts of the same whole.",
          steps: [
            { prompt: "What is 40% of 50?", answer: "20" },
            { prompt: "What is 20% of 50?", answer: "10" },
            { prompt: "Add them. How many questions are completed?", answer: "30" },
          ],
        },
      },
      {
        kind: "typed_response",
        prompt: "30% of a number is 24. What is the number?",
        answer: "80",
        helper: "Use 10% as the bridge back to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: {
          type: "multi_step_method",
          title: "Reverse 30%",
          contextLabel: "Scale from the known part back to the whole.",
          steps: [
            { prompt: "If 30% is 24, what is 10%?", answer: "8" },
            { prompt: "What is 100% of the number?", answer: "80" },
          ],
        },
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easier to calculate: 35% of 80 or 7/20 of 80?",
        options: ["35% of 80", "7/20 of 80", "They are equally easy"],
        answer: "7/20 of 80",
        helper: "Equivalent fractions can create a faster route.",
      },
      {
        kind: "typed_response",
        prompt: "A class scored 54 points. That was 60% of the total possible points. What was the total possible score?",
        answer: "90",
        helper: "Work backwards from 60% to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        answer: "92",
        helper: "Find the increase first, then add it.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A student completes 25% of an 84-question test, then another 50% of the full test. How many questions have they completed in total?",
        answer: "63",
        helper: "Both percentages are of the same whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "45% of a number is 27. What is the number?",
        answer: "60",
        helper: "Choose a useful benchmark part, then scale back.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easier to calculate: 15% of 60 or 3/20 of 60?",
        options: ["15% of 60", "3/20 of 60", "They are equally easy"],
        answer: "3/20 of 60",
        helper: "Equivalent fraction forms can make the structure clearer.",
      },
      {
        kind: "typed_response",
        prompt: "A water tank is 40% full with 36 L. What is the full capacity?",
        answer: "90",
        helper: "Reverse-scale from the known percentage to 100%.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A shop increases a price of $45 by 35%. What is the new price?",
        answer: "60.75",
        helper: "Find 35% of the price, then add it back.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A player completes 30% of a level, then 45% more of the same level. What percent of the level is completed altogether?",
        answer: "75",
        helper: "Add percentages when they refer to the same whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "12% of a number is 9. What is the number?",
        answer: "75",
        helper: "Choose a useful benchmark percent, then scale back to the whole.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easier to calculate: 75% of 64 or 3/4 of 64?",
        options: ["75% of 64", "3/4 of 64", "They are equally easy"],
        answer: "3/4 of 64",
        helper: "Benchmark fractions can be the fastest route.",
      },
      {
        kind: "typed_response",
        prompt: "A test score of 42 was 70% of the total. What was the total score?",
        answer: "60",
        helper: "Use 10% as the bridge back to 100%.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A price of $120 is increased by 12%. What is the new price?",
        answer: "134.4",
        helper: "Break the increase into 10% and 2%, then add it.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A student completes 35% of a 40-question quiz, then 15% more of the full quiz. How many questions have they completed in total?",
        answer: "20",
        helper: "Both percentages are of the same total number of questions.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "65% of a number is 52. What is the number?",
        answer: "80",
        helper: "Think about 5% or 10% chunks to reverse-scale.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easier to calculate: 20% of 90 or 1/5 of 90?",
        options: ["20% of 90", "1/5 of 90", "They are equally easy"],
        answer: "1/5 of 90",
  ...
  const cartesianGridVisual = (
    ...
    movementArrow: options?.movementArrow,
  ...
  const termPositionVisual = (
    title: string,
    pairs: Array<{ term: number | string; value: number | string }>
  ): TermPositionCardVisualData => ({
    type: "term_position_card",
    title,
    pairs: pairs.map((pair) => ({
  ...
  if (explicitMode === "y6_pattern_describe_rule") {
    const templates: MultipleChoiceQuestion[] = [
      {
        kind: "multiple_choice",
        ...
        options: ["+5", "+4", "×2"],
        answer: "+5",
        helper: "Check the difference between terms.",
        visual: ruleBuilderVisual("Rule Builder", [4, 9, 14, 19, "?"], "Rule"),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule describes this pattern?",
        options: ["×3 + 1", "×2 + 4", "+7 each time"],
        answer: "×3 + 1",
        helper: "Test the jump from 10 to 31.",
        visual: patternSequenceStrip("Describe the Rule", [3, 10, 31, 94, "?"], [null, null, null, null]),
      },
      {
        kind: "multiple_choice",
        prompt: "Build the rule.",
        options: ["×3", "+12", "×2"],
        answer: "×3",
        helper: "Check whether each term is scaled.",
        visual: ruleBuilderVisual("Rule Builder", [2, 6, 18, 54, "?"], "Rule"),
      },
      {
        kind: "multiple_choice",
        ...
        options: ["×2 + 1", "+6 each time", "×3"],
        answer: "×2 + 1",
        helper: "Use more than one step to test it.",
        visual: patternSequenceStrip("Describe the Rule", [5, 11, 23, 47, "?"], [null, null, null, null]),
      },
      {
        kind: "multiple_choice",
        prompt: "How would you describe this pattern?",
        options: ["Square numbers", "Add 3 each time", "Double each time"],
        answer: "Square numbers",
        helper: "Think about how each term is built.",
        visual: patternSequenceStrip("Describe the Rule", [1, 4, 9, 16, 25, "?"], [null, null, null, null, null]),
      },
      {
        kind: "multiple_choice",
        prompt: "Build the rule.",
        options: ["−8", "÷2", "+8"],
        answer: "−8",
        helper: "Watch the direction and size of change.",
        visual: ruleBuilderVisual("Rule Builder", [50, 42, 34, 26, "?"], "Rule"),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule describes this pattern?",
        options: ["×4 − 1", "×3 + 2", "+15 each time"],
        answer: "×4 − 1",
        helper: "Check the jump from 11 to 43.",
        visual: patternSequenceStrip("Describe the Rule", [3, 11, 43, 171, "?"], [null, null, null, null]),
      },
      {
        kind: "multiple_choice",
        prompt: "Build the rule.",
        options: ["+0.5", "×0.5", "+5"],
        answer: "+0.5",
        helper: "Look at the exact difference each time.",
        visual: ruleBuilderVisual("Rule Builder", [1.5, 2.0, 2.5, 3.0, "?"], "Rule"),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule is correct?",
        options: ["Add increasing numbers", "Add 4 each time", "Double each time"],
        answer: "Add increasing numbers",
        helper: "Look at the gaps between terms.",
        visual: patternSequenceStrip("Describe the Rule", [2, 5, 9, 14, 20, "?"], ["+3", "+4", "+5", "+6", null]),
      },
      {
        kind: "multiple_choice",
        prompt: "Build the rule.",
        options: ["×5", "+5", "×2 + 1"],
        answer: "×5",
        helper: "See whether the pattern grows by scaling.",
        visual: ruleBuilderVisual("Rule Builder", [1, 5, 25, 125, "?"], "Rule"),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule describes this pattern?",
        options: ["Alternate +2, ×2", "Add 4 each time", "×2 each time"],
        answer: "Alternate +2, ×2",
        helper: "Look for two moves repeating.",
        visual: patternSequenceStrip("Describe the Rule", [4, 6, 12, 14, 28, "?"], ["+2", "×2", "+2", "×2", null]),
      },
      {
        kind: "multiple_choice",
        prompt: "Build the rule.",
        options: ["÷2 + 1", "÷2", "−2"],
        answer: "÷2 + 1",
        helper: "Check the move from 18 to 10.",
    ...
    const templates: TypedResponseQuestion[] = [
      {
        ...
        helper: "Use term number thinking.",
        placeholder: "Type the number",
        inputType: "integer",
        visual: termPositionVisual("Term Positions", [
          { term: 1, value: 5 },
          { term: 2, value: 10 },
          { term: 3, value: 15 },
        ]),
      ...
      {
        kind: "typed_response",
        prompt: "What is the 20th number?",
        answer: "59",
        acceptedAnswers: ["59.0"],
        helper: "Start at 2 and count the equal jumps.",
        placeholder: "Type the number",
        inputType: "integer",
        visual: patternSequenceStrip("Position Thinking", [2, 5, 8, 11, "..."], ["+3", "+3", "+3", null]),
      },
      {
        kind: "typed_response",
        prompt: "What is the 15th number?",
        answer: "90",
        acceptedAnswers: ["90.0"],
        helper: "Link the step size to the term number.",
        placeholder: "Type the number",
        inputType: "integer",
        visual: patternSequenceStrip("Multiples Pattern", [6, 12, 18, 24, "..."], ["+6", "+6", "+6", null]),
      },
      {
        kind: "typed_response",
        prompt: "What is the 12th number?",
        answer: "47",
        acceptedAnswers: ["47.0"],
        helper: "Start value plus equal steps.",
        placeholder: "Type the number",
        inputType: "integer",
        visual: termPositionVisual("Term Positions", [
          { term: 1, value: 3 },
      ...
      },
      {
        ...
        answer: "7",
        acceptedAnswers: ["7.0"],
        helper: "Reverse the rule in the opposite order.",
        placeholder: "Type the input",
        inputType: "integer",
        visual: functionMachineVisual("Reverse Function Machine", "?", "×2 + 1", 15),
      },
      {
        kind: "typed_response",
        prompt: "What is the input?",
        answer: "8",
        acceptedAnswers: ["8.0"],
        helper: "Undo the rule carefully.",
        placeholder: "Type the input",
        inputType: "integer",
        visual: functionMachineVisual("Reverse Function Machine", "?", "×4 − 3", 29),
      },
      {
        kind: "typed_response",
        prompt: "What is the 9th number?",
        answer: "81",
        acceptedAnswers: ["81.0"],
        helper: "Each term equals 9 times the term number.",
        placeholder: "Type the number",
        inputType: "integer",
        visual: termPositionVisual("Term Positions", [
          { term: 1, value: 9 },
      ...
      {
        kind: "typed_response",
        prompt: "What is the 8th number?",
        answer: "57",
        acceptedAnswers: ["57.0"],
        helper: "Keep the same additive rule going.",
        placeholder: "Type the number",
        inputType: "integer",
        visual: patternSequenceStrip("Position Thinking", [8, 15, 22, 29, "..."], ["+7", "+7", "+7", null]),
      },
      {
        kind: "typed_response",
        prompt: "What is the 6th number?",
        answer: "36",
        acceptedAnswers: ["36.0"],
        helper: "This pattern is built from square numbers.",
        placeholder: "Type the number",
        inputType: "integer",
      ...
      },
      {
        ...
        prompt: "What is the output?",
        answer: "53",
        acceptedAnswers: ["53.0"],
        helper: "Run the full rule once.",
        placeholder: "Type the output",
        inputType: "integer",
        visual: functionMachineVisual("Function Machine", 13, "×4 + 1", "?"),
      },
      {
        kind: "typed_response",
        prompt: "What is the 25th number?",
        answer: "124",
        acceptedAnswers: ["124.0"],
        helper: "Start at 4 and add 5 for each new term.",
        placeholder: "Type the number",
        inputType: "integer",
        visual: termPositionVisual("Term Positions", [
          { term: 1, value: 4 },
      ...
      },
      {
        ...
        helper: "Undo +5 first, then undo ×3.",
        placeholder: "Type the input",
        inputType: "integer",
    ...
    const templates: MultipleChoiceQuestion[] = [
      {
        ...
        prompt: "Which statement is true?",
        options: [
          "Each term = 4 × term number − 1",
          "Each term = 3 × term number",
          "Each term = term number + 4",
        ],
        answer: "Each term = 4 × term number − 1",
        helper: "Test the statement with more than one term.",
        visual: termPositionVisual("Term Positions", [
          { term: 1, value: 3 },
          { term: 2, value: 7 },
          { term: 3, value: 11 },
      ...
      {
        kind: "multiple_choice",
        prompt: "Which rule turns 5 into 17?",
        options: ["×3 + 2", "×2 + 7", "+12"],
        answer: "×3 + 2",
        helper: "Check the full operation, not just part of it.",
        visual: functionMachineVisual("Function Machine", 5, "?", 17),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule matches this sequence?",
        options: ["×3 + 1", "×2 + 5", "+15 each time"],
        answer: "×3 + 1",
        helper: "Find the multi-step rule, then test it.",
        visual: patternSequenceStrip("Multi-step Pattern", [2, 7, 22, 67, "?"], [null, null, null, null]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule card is correct?",
        options: ["+8", "×2 + 2", "×2"],
        answer: "×2",
        helper: "Check the change between every pair of terms.",
        visual: ruleBuilderVisual("Rule Builder", [6, 12, 24, 48, "?"], "Rule"),
      },
      {
        kind: "multiple_choice",
        prompt: "Which output is correct?",
        options: ["14", "12", "18"],
        answer: "14",
        helper: "Use the order of operations in the machine.",
        visual: functionMachineVisual("Function Machine", 4, "×3 + 2", "?"),
      },
      {
        kind: "multiple_choice",
        prompt: "Which statement best describes the pattern?",
        options: ["Add 5 each time", "Double, then add 1", "Square numbers"],
        answer: "Double, then add 1",
        helper: "Choose the rule that fits every jump.",
        visual: patternSequenceStrip("Describe the Relationship", [5, 11, 23, 47, "..."], [null, null, null, null]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule matches the cards?",
        options: ["5 × term number", "5 + term number", "2 × term number + 5"],
        answer: "5 × term number",
        helper: "Connect the term number to the value.",
        visual: termPositionVisual("Term Positions", [
          { term: 1, value: 5 },
          { term: 2, value: 10 },
          { term: 3, value: 15 },
      ...
      {
        kind: "multiple_choice",
        prompt: "Which rule turns 8 into 29?",
        options: ["×4 − 3", "×3 + 5", "×2 + 13"],
        answer: "×4 − 3",
        helper: "Test the whole rule once.",
        visual: functionMachineVisual("Function Machine", 8, "?", 29),
      },
      {
        kind: "multiple_choice",
        prompt: "Which rule is correct for the challenge pattern?",
        options: ["×3 + 1", "×2 + 3", "+15 each time"],
        answer: "×3 + 1",
        helper: "This is a multi-step growth pattern.",
      ...
      },
      {
        ...
        options: ["+0.5", "×0.5", "+5"],
        answer: "+0.5",
        helper: "Look at the exact increase.",
        visual: ruleBuilderVisual("Rule Builder", [2.5, 3.0, 3.5, 4.0, "?"], "Rule"),
      },
      {
        kind: "multiple_choice",
        prompt: "Which statement is always true?",
        options: [
          "The 10th term is 7 × 10",
          "The 10th term is 7 + 10",
          "The 10th term is always odd",
        ],
        answer: "The 10th term is 7 × 10",
        helper: "Match the statement to the pattern structure.",
        visual: termPositionVisual("Term Positions", [
          { term: 1, value: 7 },
          { term: 2, value: 14 },
          { term: 3, value: 21 },
      ...
      {
        kind: "multiple_choice",
        prompt: "Which output fits the rule?",
        options: ["202", "201", "203"],
        answer: "202",
    ...
    const templates: TypedResponseQuestion[] = [
      {
        ...
        helper: "Tap the grid point.",
        placeholder: "Tap a point",
        visual: cartesianGridVisual("Find the Dot", []),
      },
      {
        kind: "typed_response",
        prompt: "Find and plot the coordinate (-3, 2).",
        answer: "(-3,2)",
        acceptedAnswers: ["(-3, 2)", "-3,2", "-3 2"],
        helper: "Tap the grid point.",
        placeholder: "Tap a point",
      ...
      {
        kind: "typed_response",
        prompt: "What coordinate is this point?",
        answer: "(4,1)",
        acceptedAnswers: ["(4, 1)", "4,1", "4 1"],
        helper: "Write the point as (x, y).",
        placeholder: "Type (x, y)",
        visual: cartesianGridVisual("Read the Point", [{ x: 4, y: 1 }], {
    ...
    const templates: MultipleChoiceQuestion[] = [
      {
        ...
        visual: cartesianGridVisual("Read the Point", [{ x: 2, y: 3 }], {
          subtitle: "One point is shown on the grid.",
        }),
      },
      {
      ...
      },
      {
        ...
        options: ["(3, -2)", "(-3, 2)", "(2, -3)"],
        answer: "(3, -2)",
        helper: "Right is positive x, down is negative y.",
        visual: cartesianGridVisual("Read the Point", [{ x: 3, y: -2 }], {
          subtitle: "One point is shown on the grid.",
        }),
      },
      {
        kind: "multiple_choice",
        prompt: "Which point is in the bottom-left quadrant?",
        options: ["(-2, -3)", "(2, -3)", "(-2, 3)"],
        answer: "(-2, -3)",
        ...
        visual: cartesianGridVisual(
          ...
          {
            subtitle: "Three points are shown on the grid.",
          }
        ),
      },
      {
        kind: "multiple_choice",
        prompt: "Which coordinate matches 5 right and 4 down?",
        options: ["(5, -4)", "(-5, 4)", "(4, -5)"],
        answer: "(5, -4)",
        helper: "Write coordinates as (x, y).",
        visual: cartesianGridVisual("Read the Grid", [{ x: 5, y: -4 }], {
          subtitle: "Right is positive x and down is negative y.",
        }),
      },
    ];
    return templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  ...
  if (explicitMode === "y6_cartesian_follow_origin") {
    const templates: TypedResponseQuestion[] = [
      {
        kind: "typed_response",
        prompt: "Start at the origin. Right 3, up 2. Where are you now?",
        answer: "(3,2)",
        acceptedAnswers: ["(3, 2)", "3,2", "3 2"],
        helper: "Write the point as (x, y).",
        placeholder: "Type (x, y)",
        visual: cartesianGridVisual("Follow the Directions", [], {
          subtitle: "Start at the origin.",
        }),
      },
      {
        kind: "typed_response",
        prompt: "Start at the origin. Right 4, up 1. Where are you now?",
        answer: "(4,1)",
        acceptedAnswers: ["(4, 1)", "4,1", "4 1"],
        helper: "Write the point as (x, y).",
        placeholder: "Type (x, y)",
      ...
      {
        kind: "typed_response",
        prompt: "Start at the origin. Left 3, up 2. Where are you now?",
        answer: "(-3,2)",
        acceptedAnswers: ["(-3, 2)", "-3,2", "-3 2"],
        helper: "Write the point as (x, y).",
        placeholder: "Type (x, y)",
      ...
      {
        kind: "typed_response",
        prompt: "Start at the origin. Right 2, down 4. Where are you now?",
        answer: "(2,-4)",
        acceptedAnswers: ["(2, -4)", "2,-4", "2 -4"],
        helper: "Write the point as (x, y).",
        placeholder: "Type (x, y)",
      ...
      {
        kind: "typed_response",
        prompt: "Start at the origin. Left 5, down 3. Where are you now?",
        answer: "(-5,-3)",
  ...
  if (explicitMode === "y6_cartesian_move_interpret") {
    const templates: TypedResponseQuestion[] = [
      ...
      {
        kind: "typed_response",
        prompt: "Point (4, -2) moves to (-4, -2). Which coordinate changed?",
        answer: "x",
        acceptedAnswers: ["x-value", "x value"],
        helper: "The y-value stayed the same.",
        placeholder: "Type x or y",
        visual: cartesianGridVisual("Interpret the Move", [{ x: 4, y: -2 }, { x: -4, y: -2 }], {
          connectPoints: true,
          movementArrow: true,
          subtitle: "Compare the start and end point.",
        }),
      ...
      },
      {
        ...
        helper: "Down movement decreases y. x stays the same.",
        placeholder: "Type (x, y)",
      ...
      {
        kind: "typed_response",
        prompt: "Point (-2, -1) moves to (3, -1). What movement happened?",
        answer: "moved right 5",
        acceptedAnswers: ["right 5", "move right 5", "moved 5 right"],
        helper: "The y-value stayed the same, so the move was horizontal.",
        placeholder: "Type the movement",
        visual: cartesianGridVisual("Interpret the Move", [{ x: -2, y: -1 }, { x: 3, y: -1 }], {
          connectPoints: true,
          movementArrow: true,
          subtitle: "Compare the start and end point.",
        }),
  ...
  if (explicitMode === "y6_fdp_choose_form") {
    const templates: MultipleChoiceQuestion[] = [
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to find 25% of 80?",
        options: ["Fraction: 1/4", "Decimal: 0.25", "Percentage: 25%"],
        answer: "Fraction: 1/4",
        helper: "Choose the form that makes the calculation easiest.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to find 50% of 96?",
        options: ["Fraction: 1/2", "Decimal: 0.5", "Percentage: 50%"],
        answer: "Fraction: 1/2",
        helper: "Try using a benchmark percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to compare 3/4 and 70%?",
        options: ["Convert 3/4 to 75%", "Convert both to fractions", "Convert both to decimals"],
        answer: "Convert 3/4 to 75%",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to find 0.2 of 75?",
        options: ["Fraction: 1/5", "Decimal: 0.2", "Percentage: 20%"],
        answer: "Fraction: 1/5",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest for finding 10% of 240?",
        options: ["Divide by 10", "Convert to a fraction", "Convert to a decimal"],
        answer: "Divide by 10",
        helper: "Choose the form that makes the number easier.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest for 75% of 64?",
        options: ["3/4", "0.75", "75/100"],
        answer: "3/4",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easiest to compare 0.6 and 5/8?",
        options: ["Convert 5/8 to decimal", "Convert 0.6 to percentage", "Keep both unchanged"],
        answer: "Convert 5/8 to decimal",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest for 1/5 of 90?",
        options: ["Fraction", "Decimal", "Percentage"],
        answer: "Fraction",
        helper: "Choose the form that makes the calculation easiest.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to find 0.75 of 40?",
        options: ["Fraction: 3/4", "Decimal: 0.75", "Percentage: 75%"],
        answer: "Fraction: 3/4",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to compare 3/5 and 65%?",
        options: ["Convert 3/5 to 60%", "Convert both to fractions", "Convert both to decimals"],
        answer: "Convert 3/5 to 60%",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to find 20% of 150?",
        options: ["Fraction: 1/5", "Decimal: 0.2", "Percentage: 20%"],
        answer: "Fraction: 1/5",
        helper: "Choose the form that makes the number easier.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to find 5% of 200?",
        options: ["Find 10%, then halve it", "Convert to a fraction over 100", "Write it as 0.05 first"],
        answer: "Find 10%, then halve it",
        helper: "Try using a benchmark percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easiest to compare 0.75 and 2/3?",
        options: ["Convert 2/3 to decimal", "Convert 0.75 to percentage", "Convert both to fractions"],
        answer: "Convert 2/3 to decimal",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest for 25% of 120?",
        options: ["Fraction: 1/4", "Decimal: 0.25", "Percentage: 25%"],
        answer: "Fraction: 1/4",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easiest to compare 40% and 3/8?",
        options: ["Convert 3/8 to percent", "Convert 40% to fraction", "Keep both unchanged"],
        answer: "Convert 3/8 to percent",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest for 0.5 of 84?",
        options: ["Fraction: 1/2", "Decimal: 0.5", "Percentage: 50%"],
        answer: "Fraction: 1/2",
        helper: "Try using a benchmark percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest for 75% of 48?",
        options: ["3/4", "0.75", "75/100"],
        answer: "3/4",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is easiest to compare 0.25 and 30%?",
        options: ["Convert 0.25 to 25%", "Convert both to fractions", "Keep both unchanged"],
        answer: "Convert 0.25 to 25%",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest for 10% of 360?",
        options: ["Divide by 10", "Convert to a fraction", "Multiply by 0.10"],
        answer: "Divide by 10",
        helper: "Try using a benchmark percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is easiest to find 0.25 of 64?",
        options: ["Fraction: 1/4", "Decimal: 0.25", "Percentage: 25%"],
        answer: "Fraction: 1/4",
        helper: "Choose the form that makes the number easier.",
      },
    ...
    const templates: Array<TypedResponseQuestion | MultipleChoiceQuestion> = [
      {
        ...
        prompt: "25% of 80 = ?",
        answer: "20",
        helper: "Choose a form that makes the number easier.",
        placeholder: "Type the answer",
        inputType: "integer",
        visual: {
          type: "percent_structured_method",
          ...
          method: "strategy",
          steps: [
            { prompt: "What is 1/4 of 80?", answer: "20" },
          ],
        },
      },
      {
        ...
        prompt: "50% of 96 = ?",
        answer: "48",
        helper: "Can you use 10%, 50%, 25%, or 75%?",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        ...
        visual: {
          ...
          method: "strategy",
          steps: [
            { prompt: "What is 1/4 of 40?", answer: "10" },
            { prompt: "What is 3/4 of 40?", answer: "30" },
          ],
        },
      },
      {
        ...
        prompt: "0.2 of 75 = ?",
        answer: "15",
        helper: "Choose the easiest form before solving.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      },
      {
        ...
        prompt: "15% of 60 = ?",
        answer: "9",
        helper: "Break the percentage into parts you know.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      {
        kind: "multiple_choice",
        prompt: "Which is larger: 3/5 or 65%?",
        options: ["3/5", "65%", "They are equal"],
        answer: "65%",
        helper: "Compare the values, not just the symbols.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is larger: 0.75 or 2/3?",
        options: ["0.75", "2/3", "They are equal"],
        answer: "0.75",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "typed_response",
        prompt: "Find 0.25 of 120.",
        answer: "30",
        helper: "Think about the fraction equivalent.",
        placeholder: "Type the answer",
        inputType: "integer",
      ...
      {
        kind: "typed_response",
        prompt: "Find 5% of 200.",
        answer: "10",
        helper: "Find 10% first, then halve it.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
      ...
      },
      {
        ...
        options: ["0.6", "5/8", "They are equal"],
        answer: "5/8",
        helper: "Compare the values, not just the symbols.",
      },
      {
        kind: "typed_response",
        prompt: "Find 10% of 360.",
        answer: "36",
        helper: "Choose a form that makes the number easier.",
        placeholder: "Type the answer",
        inputType: "integer",
      ...
      {
        kind: "multiple_choice",
        prompt: "Which is larger: 40% or 3/8?",
        options: ["40%", "3/8", "They are equal"],
        answer: "40%",
        helper: "Think about the fraction equivalent.",
      },
    ];
  ...
  if (explicitMode === "y6_fdp_justify_decide") {
    const templates: Array<MultipleChoiceQuestion | TypedResponseQuestion> = [
      {
        kind: "multiple_choice",
        prompt: "A student uses decimal multiplication to find 50% of 200. Is this the most efficient method?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "Choose the form that makes the calculation easiest.",
      },
      {
        kind: "multiple_choice",
        prompt: "Why is 25% often easier as a fraction?",
        options: ["Because 25% = 1/4", "Because 25% = 2/5", "Because 25% = 3/10"],
        answer: "Because 25% = 1/4",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient for 10% of 90?",
        options: ["Divide by 10", "Convert to a fraction", "Multiply by 0.10"],
        answer: "Divide by 10",
        helper: "Try using a benchmark percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "A student converts 1/2 to 0.5 to find half of 60. Is that necessary?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "Choose the form that makes the number easier.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient for 75% of 48?",
        options: ["Find 3/4 of 48", "Multiply by 75", "Convert to 75/100 and simplify slowly"],
        answer: "Find 3/4 of 48",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is the best strategy for 45% of 60?",
        options: ["Use 50% minus 5%", "Count by ones", "Convert every percent to a fraction over 100"],
        answer: "Use 50% minus 5%",
        helper: "Break the percentage into parts you know.",
      },
      {
        kind: "multiple_choice",
        prompt: "A student says 0.8 is smaller than 75% because 8 is smaller than 75. Is this correct?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "Compare the values, not just the symbols.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form makes 1/4 of 84 easiest?",
        options: ["Fraction", "Decimal", "Percentage"],
        answer: "Fraction",
        helper: "Choose the form that makes the calculation easiest.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient for 25% of 120?",
        options: ["Find 1/4 of 120", "Multiply by 25", "Convert to 0.25 and do long multiplication"],
        answer: "Find 1/4 of 120",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient for 20% of 150?",
        options: ["Find 1/5 of 150", "Multiply by 20", "Convert every number to hundredths"],
        answer: "Find 1/5 of 150",
        helper: "Choose the form that makes the number easier.",
      },
      {
        kind: "multiple_choice",
        prompt: "A student converts 0.75 to 75/100 to find 0.75 of 40. Is that the most efficient method?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which strategy is best for comparing 3/5 and 65%?",
        options: ["Convert 3/5 to 60%", "Convert both to quarters", "Multiply each by 1000"],
        answer: "Convert 3/5 to 60%",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient for 5% of 240?",
        options: ["Find 10%, then halve it", "Multiply by 5", "Convert 5% to 5/100 and expand it"],
        answer: "Find 10%, then halve it",
        helper: "Try using a benchmark percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "A student uses 0.2 to find 0.2 of 75. Is converting to 1/5 likely to be more efficient?",
        options: ["Yes", "No"],
        answer: "Yes",
        helper: "Think about the fraction equivalent.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient for 50% of 118?",
        options: ["Halve 118", "Multiply 118 by 50", "Convert to 50/100 and simplify slowly"],
        answer: "Halve 118",
        helper: "Try using a benchmark percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is best for comparing 0.25 and 30%?",
        options: ["Percentages", "Fractions", "Keep them unchanged"],
        answer: "Percentages",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "A student says 40% and 3/8 are equal because both are less than one half. Is this correct?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "Compare the values, not just the symbols.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which strategy is best for 35% of 80?",
        options: ["Use 30% + 5%", "Count by ones", "Convert straight to hundredths and stop there"],
        answer: "Use 30% + 5%",
        helper: "Break the percentage into parts you know.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which form is best for comparing 0.6 and 5/8?",
        options: ["Decimals", "Percentages", "Fractions"],
        answer: "Decimals",
        helper: "Choose the form that makes the values easiest to compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient for 75% of 64?",
        options: ["Find 3/4 of 64", "Multiply by 75", "Convert to 75/100 and expand every step"],
        answer: "Find 3/4 of 64",
        helper: "Think about the fraction equivalent.",
      },
    ];
    return templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  ...
  if (explicitMode === "y6_discount_compare_deals") {
    const templates: MultipleChoiceQuestion[] = [
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["30% off $100", "20% off $80", "They save the same"],
        answer: "30% off $100",
        helper: "Calculate the actual saving, not just the percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["15% off $200", "25% off $120", "They save the same"],
        answer: "They save the same",
        helper: "Compare the actual dollar savings.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$150 with 20% off", "$120 with 10% off", "They cost the same"],
        answer: "$120 with 10% off",
        helper: "Compare final prices, not percentages.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is the better deal?",
        options: ["$96 with 25% off", "$84 with 10% off", "They are equal"],
        answer: "$96 with 25% off",
        helper: "Work out the saving or the final price for both.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["50% off $40", "25% off $100", "They save the same"],
        answer: "25% off $100",
        helper: "A larger percentage does not always save more.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$60 with 25% off", "$72 with 40% off", "They cost the same"],
        answer: "$72 with 40% off",
        helper: "Calculate the actual saving first.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["10% off $300", "25% off $100", "They save the same"],
        answer: "10% off $300",
        helper: "Compare the dollar value of each discount.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$250 with 12% off", "$220 with 5% off", "They cost the same"],
        answer: "$220 with 5% off",
        helper: "Find each final price, then compare.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is the better deal?",
        options: ["$140 with 15% off", "$110 with 8% off", "They are equal"],
        answer: "$140 with 15% off",
        helper: "A higher original price can still lead to a better saving.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["35% off $80", "20% off $150", "They save the same"],
        answer: "20% off $150",
        helper: "Turn each percentage into an actual saving amount.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$180 with 30% off", "$150 with 12% off", "They cost the same"],
        answer: "$180 with 30% off",
        helper: "Compare final prices, not discount labels.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["40% off $90", "15% off $240", "They save the same"],
        answer: "They save the same",
        helper: "Calculate both savings before deciding.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is the better deal?",
        options: ["$75 with 20% off", "$90 with 30% off", "They are equal"],
        answer: "$90 with 30% off",
        helper: "Work out the final price of each option.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["5% off $600", "25% off $120", "They save the same"],
        answer: "They save the same",
        helper: "A small percentage on a high price can match a larger percentage on a lower price.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$64 with 25% off", "$56 with 10% off", "They cost the same"],
        answer: "$64 with 25% off",
        helper: "Calculate the actual final prices.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["12% off $250", "20% off $140", "They save the same"],
        answer: "12% off $250",
        helper: "Compare the value of each saving, not the percent alone.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$99 with 15% off", "$88 with 5% off", "They cost the same"],
        answer: "$99 with 15% off",
        helper: "Check the actual amount taken off each price.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which is the better deal?",
        options: ["$160 with 25% off", "$120 with 5% off", "They are equal"],
        answer: "$160 with 25% off",
        helper: "Compare the final prices properly.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which saves more money?",
        options: ["18% off $200", "30% off $110", "They save the same"],
        answer: "30% off $110",
        helper: "Turn each deal into a dollar saving first.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$84 with 20% off", "$70 with 2% off", "They cost the same"],
        answer: "$84 with 20% off",
  ...
  if (explicitMode === "y6_discount_stacked") {
    const templates: TypedResponseQuestion[] = [
      {
        kind: "typed_response",
        prompt: "A $100 item has 20% off, then 10% off. What is the final price?",
        answer: "72",
        helper: "Apply each discount step-by-step.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "Is 20% off then 10% off the same as 30% off? Type Yes or No.",
        answer: "No",
        helper: "The second discount applies to the new price, not the original.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $80 item has 25% off, then 20% off. What is the final price?",
        answer: "48",
        helper: "Find the first sale price before applying the second discount.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A student says, “20% + 10% = 30% total discount.” Type Correct or Incorrect.",
        answer: "Incorrect",
        helper: "Apply each discount to the current price, not by just adding percentages.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "For a $100 item, which is better: 30% off or 20% off then 10% off? Type the better offer.",
        answer: "30% off",
        helper: "Compare the final prices after both methods.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $120 item has 10% off, then 25% off. What is the final price?",
        answer: "81",
        helper: "Apply the second discount to the reduced price.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A $200 item has 30% off, then 5% off. What is the final price?",
        answer: "133",
        helper: "Apply the two discounts one after the other.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A $90 item has 20% off, then 20% off. What is the final price?",
        answer: "57.6",
        helper: "The second 20% comes off the reduced price.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $150 item has 15% off, then 10% off. What is the final price?",
        answer: "114.75",
        helper: "Calculate each step carefully.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "For a $60 item, which is better: 25% off or 10% off then 10% off? Type the better offer.",
        answer: "25% off",
        helper: "Compare the actual final prices.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $64 item has 25% off, then 10% off. What is the final price?",
        answer: "43.2",
        helper: "Find the new price after the first discount before taking the second one.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "Is 50% off then 10% off the same as 60% off? Type Yes or No.",
        answer: "No",
        helper: "A second discount is always applied to the reduced price.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $250 item has 20% off, then 15% off. What is the final price?",
        answer: "170",
        helper: "Work step-by-step and keep the current price updated.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "A $75 item has 40% off, then 10% off. What is the final price?",
        answer: "40.5",
        helper: "Subtract each discount from the updated price.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "For a $200 item, which is better: 35% off or 20% off then 20% off? Type the better offer.",
        answer: "35% off",
        helper: "Compare both final prices, not just the advertised percentages.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $96 item has 25% off, then 10% off. What is the final price?",
        answer: "64.8",
        helper: "Take 25% off first, then discount the new amount.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $84 item has 10% off, then 25% off. What is the final price?",
        answer: "56.7",
        helper: "Apply the discounts in order.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $300 item has 12% off, then 5% off. What is the final price?",
        answer: "250.8",
        helper: "Step through the discounts one at a time.",
        placeholder: "Type the answer",
      },
      {
        kind: "typed_response",
        prompt: "A $50 item has 20% off, then 20% off. What is the final price?",
        answer: "32",
        helper: "The second discount is on the reduced amount.",
        placeholder: "Type the answer",
        inputType: "integer",
      },
      {
        kind: "typed_response",
        prompt: "For a $180 item, which is better: 25% off or 10% off then 20% off? Type the better offer.",
        answer: "25% off",
        helper: "Compare the final prices after both offers.",
        placeholder: "Type the answer",
      },
    ];
    return templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  ...
  if (explicitMode === "y6_discount_budget_decide") {
    const templates: MultipleChoiceQuestion[] = [
      {
        kind: "multiple_choice",
        prompt: "You have $100. A jacket costs $120 with 25% off. Can you afford it?",
        options: ["Yes", "No"],
        answer: "Yes",
        helper: "Compare the final price with your budget.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which deal is misleading if you only look at the percentage?",
        options: ["50% off $20", "10% off $200", "Neither is misleading"],
        answer: "50% off $20",
        helper: "Compare the actual saving, not just the percentage.",
      },
      {
        kind: "multiple_choice",
        prompt: "Why can you not just compare percentages?",
        options: [
          "Prices are different, so you need the actual values",
          "Because percentages only work with fractions",
          "Because the larger number always wins",
        ],
        answer: "Prices are different, so you need the actual values",
        helper: "Think about what the percentage is applied to.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$80 with 10% off", "$90 with 20% off", "They cost the same"],
        answer: "$90 with 20% off",
        helper: "Find the final price of each option.",
      },
      {
        kind: "multiple_choice",
        prompt: "You have $150. Which is the better option?",
        options: ["A: $200 with 30% off", "B: $150 with 10% off", "They are the same"],
        answer: "B: $150 with 10% off",
        helper: "Compare final prices and check the budget.",
      },
      {
        kind: "multiple_choice",
        prompt: "You have $90. A bag costs $108 with 20% off. Can you afford it?",
        options: ["Yes", "No"],
        answer: "Yes",
        helper: "Work out the discounted price first.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which deal gives the cheaper final price?",
        options: ["$140 with 15% off", "$125 with 5% off", "They cost the same"],
        answer: "$140 with 15% off",
        helper: "Compare final prices, not the sticker prices.",
      },
      {
        kind: "multiple_choice",
        prompt: "Why is 30% off $50 not automatically better than 10% off $200?",
        options: [
          "Because the original prices are different",
          "Because 30% is too hard to work out",
          "Because 10% is always better",
        ],
        answer: "Because the original prices are different",
        helper: "A larger percentage does not always save more money.",
      },
      {
        kind: "multiple_choice",
        prompt: "You have $60. A game costs $72 with 20% off. Can you afford it?",
        options: ["Yes", "No"],
        answer: "Yes",
        helper: "Find the final price after the discount.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$99 with 15% off", "$86 with 2% off", "They cost the same"],
        answer: "$99 with 15% off",
        helper: "Calculate the discounted prices before comparing.",
      },
      {
        kind: "multiple_choice",
        prompt: "You have $70. A pair of shoes costs $84 with 20% off. Can you afford them?",
        options: ["Yes", "No"],
        answer: "Yes",
        helper: "Discount first, then compare with the budget.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which statement is correct?",
        options: [
          "The bigger percentage is always the better deal",
          "You need the actual saving or final price to compare deals",
          "Original prices do not matter",
        ],
        answer: "You need the actual saving or final price to compare deals",
        helper: "Percentages are used to make decisions, not just calculations.",
      },
      {
        kind: "multiple_choice",
        prompt: "You have $200. Which option should you choose?",
        options: ["A: $240 with 20% off", "B: $180 with 5% off", "They are the same"],
        answer: "B: $180 with 5% off",
        helper: "Compare the final prices, then check the budget.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which deal is more misleading if someone only looks at the advertised percent?",
        options: ["5% off $800", "40% off $20", "Neither is misleading"],
        answer: "40% off $20",
        helper: "A high percent on a low price can still save less money.",
      },
      {
        kind: "multiple_choice",
        prompt: "You have $50. A hoodie costs $60 with 10% off. Can you afford it?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "Find the final price and compare it with your budget.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which final price is cheaper?",
        options: ["$200 with 12% off", "$180 with 2% off", "They cost the same"],
        answer: "$180 with 2% off",
        helper: "A lower starting price can still stay lower after a smaller discount.",
      },
      {
        kind: "multiple_choice",
        prompt: "Why is step-by-step discounting important?",
        options: [
          "Because each discount is applied to the new price",
          "Because percentages always add directly",
          "Because the original price changes the percentage",
        ],
        answer: "Because each discount is applied to the new price",
        helper: "Multiple discounts are not just added together.",
      },
      {
        kind: "multiple_choice",
        prompt: "You have $95. A device costs $110 with 15% off. Can you afford it?",
        options: ["Yes", "No"],
        answer: "Yes",
        helper: "Work out the sale price first.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which choice is better if your budget is $130?",
        options: ["A: $160 with 20% off", "B: $135 with 5% off", "Neither fits the budget"],
        answer: "A: $160 with 20% off",
        helper: "Check both final prices against the budget.",
      },
      {
        kind: "multiple_choice",
        prompt: "Which statement is most accurate?",
        options: [
          "The best deal depends on the actual values",
          "The best deal is always the largest percentage",
          "The cheapest original price is always the best deal",
        ],
        answer: "The best deal depends on the actual values",
  ...
  const bestBuyVisual = (
    title: string,
    cards: BestBuyCardVisualData["cards"]
  ): BestBuyCardVisualData => ({
    type: "best_buy_card_comparison",
    title,
    cards,
  ...
  if (explicitMode === "y6_interpret_spot") {
    const templates: MultipleChoiceQuestion[] = [
      {
        kind: "multiple_choice",
      ...
      },
      {
        ...
        visual: bestBuyVisual("Spot the Thinking", [
          ...
          { label: "Second", productName: "Sports Bottle Set B", price: 95, quantityLabel: "10 bottles", unitRateLabel: "Per bottle", unitRate: 9.5, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        ...
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Battery Pack A", price: 88, quantityLabel: "8 batteries", unitRateLabel: "Per battery", unitRate: 11, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Battery Pack B", price: 117, quantityLabel: "13 batteries", unitRateLabel: "Per battery", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which method checks this fairly?",
        options: ["Find the unit price", "Choose the lower total", "Choose the larger quantity"],
        answer: "Find the unit price",
        helper: "Start with one matching unit.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Laundry Liquid A", price: 48, quantityLabel: "4 L", unitRateLabel: "Per L", unitRate: 12, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Laundry Liquid B", price: 66, quantityLabel: "6 L", unitRateLabel: "Per L", unitRate: 11, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which statement is true?",
        options: ["Smaller total always means better value", "Same-unit comparisons lead to fair decisions", "Bigger pack always wins"],
        answer: "Same-unit comparisons lead to fair decisions",
    ...
    const templates: TypedResponseQuestion[] = [
      {
        ...
        visual: bestBuyVisual("Explain Clearly", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar" },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar" },
        ]),
      },
      {
        kind: "typed_response",
        ...
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain Clearly", [
          { label: "First", productName: "Snack Pack A", price: 64, quantityLabel: "8 packs", unitRateLabel: "Per pack" },
          { label: "Second", productName: "Snack Pack B", price: 81, quantityLabel: "9 packs", unitRateLabel: "Per pack" },
        ]),
      },
      {
        kind: "typed_response",
        ...
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain Clearly", [
          { label: "First", productName: "Granola A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Granola B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", chunkCount: 10, chunkLabel: "100 g" },
        ]),
      },
      {
        kind: "typed_response",
        ...
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain Clearly", [
          { label: "First", productName: "Pasta Sauce A", price: 52, quantityLabel: "4 L", unitRateLabel: "Per L" },
          { label: "Second", productName: "Pasta Sauce B", price: 75, quantityLabel: "6 L", unitRateLabel: "Per L" },
        ]),
      },
      {
        kind: "typed_response",
        ...
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain Clearly", [
          { label: "First", productName: "Battery Pack A", price: 88, quantityLabel: "8 batteries", unitRateLabel: "Per battery" },
          { label: "Second", productName: "Battery Pack B", price: 117, quantityLabel: "13 batteries", unitRateLabel: "Per battery" },
        ]),
      },
    ];
    return templates[randInt(0, templates.length - 1)] ?? templates[0]!;
    ...
    const templates: MultipleChoiceQuestion[] = [
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "First",
        helper: "Compare the price for one pack.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Snack Pack A", price: 64, quantityLabel: "8 packs", unitRateLabel: "Per pack", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Snack Pack B", price: 81, quantityLabel: "9 packs", unitRateLabel: "Per pack", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which cereal bag is better value?",
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "Compare the cost per 100 g.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Cereal A", price: 63, quantityLabel: "700 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 7, chunkLabel: "100 g" },
          { label: "Second", productName: "Cereal B", price: 88, quantityLabel: "1.1 kg", unitRateLabel: "Per 100 g", unitRate: 8, hideUnitRateUntilReveal: true, chunkCount: 11, chunkLabel: "100 g" },
        ]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which method is most efficient?",
        options: ["Divide to find per litre", "Choose the bigger bottle", "Use the lower total only"],
        answer: "Divide to find per litre",
        helper: "Pick the method that creates one matching unit.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Sports Drink A", price: 52, quantityLabel: "4 L", unitRateLabel: "Per L", unitRate: 13, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Sports Drink B", price: 75, quantityLabel: "6 L", unitRateLabel: "Per L", unitRate: 12.5, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which product card is better value?",
        options: ["First", "Second", "Same"],
        answer: "Same",
        helper: "Check whether the unit prices match.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Notebook Set A", price: 48, quantityLabel: "6 notebooks", unitRateLabel: "Per notebook", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Notebook Set B", price: 72, quantityLabel: "9 notebooks", unitRateLabel: "Per notebook", unitRate: 8, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which reason is best?",
        options: ["Second has more rolls", "Second costs less per roll", "Second has a higher total"],
        answer: "Second costs less per roll",
        helper: "Choose the reason that proves value fairly.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Paper Towels A", price: 70, quantityLabel: "7 rolls", unitRateLabel: "Per roll", unitRate: 10, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Paper Towels B", price: 81, quantityLabel: "9 rolls", unitRateLabel: "Per roll", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        prompt: "Which juice box pack is better value?",
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "Compare the cost for one juice box.",
        visual: bestBuyVisual("Solve and Compare", [
