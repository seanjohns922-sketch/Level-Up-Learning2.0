  ...
  if (explicitMode === "y6_interpret_explain") {
    const templates: TypedResponseQuestion[] = [
      ...
      },
      {
        ...
        helper: "Name the matching unit in your answer.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain Clearly", [
      ...
      },
      {
        ...
        acceptedAnswers: ["costs less per box", "$6 per box", "lower per box", "per box is lower"],
      ...
      {
        kind: "typed_response",
        prompt: "Why is unit pricing useful here?",
        answer: "fair comparison",
        acceptedAnswers: ["fair comparison", "same unit", "compare different sizes fairly", "compare fairly"],
        helper: "Keep it short and practical.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain Clearly", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box" },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box" },
    ...
    const templates: MultipleChoiceQuestion[] = [
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "First",
        helper: "Snack Pack A is $8 per pack. Snack Pack B is $9 per pack.",
      ...
      },
      {
        ...
        options: ["Divide to find per item", "Multiply randomly", "Guess"],
        answer: "Divide to find per item",
        helper: "Per-item comparison is the cleanest method here.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Snack Pack A", price: 64, quantityLabel: "8 packs", unitRateLabel: "Per pack", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Snack Pack B", price: 81, quantityLabel: "9 packs", unitRateLabel: "Per pack", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "Rice B costs $8.20 per 100 g instead of $9.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", unitRate: 8.2, hideUnitRateUntilReveal: true, chunkCount: 10, chunkLabel: "100 g" },
        ]),
      },
      {
        ...
        options: ["$45 is cheaper", "$8.20 per 100 g is less than $9 per 100 g", "1 kg is bigger"],
        answer: "$8.20 per 100 g is less than $9 per 100 g",
        helper: "The strongest answer uses the same unit.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", unitRate: 8.2, hideUnitRateUntilReveal: true, chunkCount: 10, chunkLabel: "100 g" },
        ]),
      },
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "Same",
        helper: "Both protein bar packs cost $6 per bar.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which explanation best matches the cards?",
        options: ["They are the same because both cost $6 per bar", "$54 is smaller", "12 is bigger"],
        answer: "They are the same because both cost $6 per bar",
        helper: "A same-value answer should say why they match.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which notebook set is better value?",
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "Notebook Set B costs $7 per notebook instead of $8.",
        visual: bestBuyVisual("Solve and Compare", [
      ...
      },
      {
        ...
        options: ["Second costs less per notebook", "Second has more notebooks", "Second has a bigger total"],
        answer: "Second costs less per notebook",
        helper: "The best reason is the fair unit comparison.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Notebook Set A", price: 48, quantityLabel: "6 notebooks", unitRateLabel: "Per notebook", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Notebook Set B", price: 84, quantityLabel: "12 notebooks", unitRateLabel: "Per notebook", unitRate: 7, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "Juice Boxes B cost $6 per box instead of $7.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box", unitRate: 7, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which answer proves it?",
        options: ["Pack B is bigger", "Pack B costs less per box", "Pack B has a higher total"],
        answer: "Pack B costs less per box",
        helper: "Use the unit price to prove the decision.",
        visual: bestBuyVisual("Solve and Compare", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box", unitRate: 7, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
