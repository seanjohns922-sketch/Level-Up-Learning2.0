...
function generateGenericQuestion(
    ...
    const templates: MultipleChoiceQuestion[] = [
      {
        ...
        options: ["Yes", "No"],
        answer: "No",
        helper: "Both packs cost $6 per bar, so the totals alone do not decide it.",
      ...
      },
      {
        ...
        helper: "Best-buy decisions need the same unit.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        ...
        options: ["$54 is smaller", "$6 per item vs $6 per item — same value", "12 is bigger"],
        answer: "$6 per item vs $6 per item — same value",
        helper: "The strongest reasoning compares the unit rate directly.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which pack is better value?",
        options: ["First", "Second", "Same"],
        answer: "Same",
        helper: "Each pack works out to the same cost per bar.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "A student says, “$45 is cheaper so it is better.” Is this correct?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "You need a fair unit like cost per 100 g.",
        visual: bestBuyVisual("Spot the Thinking", [
      ...
      },
      {
        kind: "multiple_choice",
        prompt: "Why is that reasoning wrong?",
        options: ["Compared totals instead of per 100 g", "Used the wrong currency", "Rounded too early"],
        answer: "Compared totals instead of per 100 g",
      ...
      },
      {
        ...
        options: ["$45 is cheaper", "$8.20 per 100 g is less than $9 per 100 g", "1 kg is bigger"],
        answer: "$8.20 per 100 g is less than $9 per 100 g",
        helper: "A strong explanation compares matching units.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", unitRate: 8.2, hideUnitRateUntilReveal: true, chunkCount: 10, chunkLabel: "100 g" },
        ]),
      },
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "Rice B costs less per 100 g.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", unitRate: 8.2, hideUnitRateUntilReveal: true, chunkCount: 10, chunkLabel: "100 g" },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "A student says, “12 bottles means better value.” Is this correct?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "More items only helps if the cost per item is lower.",
        visual: bestBuyVisual("Spot the Thinking", [
      ...
      },
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "First",
        helper: "The first pack costs less per bottle.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Sports Drink A", price: 64, quantityLabel: "8 bottles", unitRateLabel: "Per bottle", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Sports Drink B", price: 81, quantityLabel: "9 bottles", unitRateLabel: "Per bottle", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        ...
        options: ["Divide to find per item", "Choose the smaller total", "Pick the bigger pack"],
        answer: "Divide to find per item",
        helper: "A unit rate makes the comparison fair.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Sports Drink A", price: 64, quantityLabel: "8 bottles", unitRateLabel: "Per bottle", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Sports Drink B", price: 81, quantityLabel: "9 bottles", unitRateLabel: "Per bottle", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "A student says, “The bigger quantity is always better value.” Is this correct?",
        options: ["Yes", "No"],
        answer: "No",
        helper: "Quantity alone does not decide value.",
        visual: bestBuyVisual("Spot the Thinking", [
      ...
      {
        kind: "multiple_choice",
        prompt: "Which reasoning is stronger?",
        options: ["16 is more", "$6 per box is less than $7 per box", "$96 is more"],
        answer: "$6 per box is less than $7 per box",
        helper: "The strongest explanation uses unit price.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box", unitRate: 7, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "The second pack costs less per box.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box", unitRate: 7, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Why is “the smaller total is better” weak reasoning?",
        options: ["It ignores the quantity", "It ignores the decimal point", "It ignores the product name"],
        answer: "It ignores the quantity",
        helper: "Fair comparisons match the unit first.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Why is “1 kg is bigger” weak reasoning here?",
        options: ["It ignores the unit price", "It uses the wrong unit", "It rounds too much"],
        answer: "It ignores the unit price",
        helper: "Bigger size only matters if the unit rate is better.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", unitRate: 8.2, hideUnitRateUntilReveal: true, chunkCount: 10, chunkLabel: "100 g" },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "What should be compared first?",
        options: ["Unit rate", "Total price only", "Quantity only"],
        answer: "Unit rate",
        helper: "Unit rate is the fair starting point.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Sports Drink A", price: 64, quantityLabel: "8 bottles", unitRateLabel: "Per bottle", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Sports Drink B", price: 81, quantityLabel: "9 bottles", unitRateLabel: "Per bottle", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which explanation is most mathematical?",
        options: ["The first total is lower", "They are the same because both are $6 per bar", "The second has more bars"],
        answer: "They are the same because both are $6 per bar",
        helper: "A mathematical explanation uses the same unit.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        ...
        options: ["$8 per bottle is less than $9 per bottle", "The first is cheaper per bottle", "The first total is smaller"],
        answer: "The first total is smaller",
        helper: "Totals alone do not show value clearly.",
        visual: bestBuyVisual("Spot the Thinking", [
          { label: "First", productName: "Sports Drink A", price: 64, quantityLabel: "8 bottles", unitRateLabel: "Per bottle", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Sports Drink B", price: 81, quantityLabel: "9 bottles", unitRateLabel: "Per bottle", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        ...
        helper: "Fair value decisions compare like with like.",
      },
    ];
    return templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  }
  ...
  if (explicitMode === "y6_interpret_explain") {
    const templates: TypedResponseQuestion[] = [
      {
        kind: "typed_response",
        prompt: "How should you compare these correctly?",
        answer: "find cost per item",
        acceptedAnswers: ["cost per item", "per item", "same unit", "unit price"],
        helper: "Use the same unit before deciding.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
      ...
      {
        kind: "typed_response",
        prompt: "Explain why “$45 is cheaper so it is better” is incorrect.",
        answer: "need per 100g",
        acceptedAnswers: ["per 100g", "same unit", "unit price", "compare per 100g"],
        helper: "Different sizes need a matching unit.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", chunkCount: 10, chunkLabel: "100 g" },
        ]),
      },
      {
        kind: "typed_response",
        prompt: "Explain how you know the first snack pack is better value.",
        answer: "$8 per item vs $9 per item",
        acceptedAnswers: ["8 per item vs 9 per item", "8 per item", "costs less per item", "lower per item"],
        helper: "A short unit-price comparison is enough.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Decision", [
      ...
      {
        kind: "typed_response",
        prompt: "Why is comparing per item fair?",
        answer: "same unit",
        acceptedAnswers: ["fair comparison", "same unit", "compare fairly", "unit price"],
        helper: "Fair comparisons use matching units.",
        placeholder: "Type a short explanation",
      },
      {
        kind: "typed_response",
        prompt: "Explain which granola bag is better and why.",
        answer: "second per 100g",
        acceptedAnswers: ["second because per 100g is lower", "second", "per 100g", "same unit"],
        helper: "Compare the cost per 100 g, not the total price.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Decision", [
      ...
      {
        kind: "typed_response",
        prompt: "Complete: “These offers are the same because ______”",
        answer: "same unit price",
        acceptedAnswers: ["same unit price", "same per item", "$6 per item", "same unit"],
        helper: "Say what is equal about the two offers.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar" },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar" },
      ...
      {
        kind: "typed_response",
        prompt: "How would you explain this to a classmate?",
        answer: "find per bottle",
        acceptedAnswers: ["find per bottle", "per bottle", "unit price", "same unit"],
        helper: "Keep the explanation short and clear.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Sports Drink A", price: 64, quantityLabel: "8 bottles", unitRateLabel: "Per bottle" },
          { label: "Second", productName: "Sports Drink B", price: 81, quantityLabel: "9 bottles", unitRateLabel: "Per bottle" },
        ]),
      },
      {
        kind: "typed_response",
        prompt: "Why is “12 is bigger” not enough of an explanation?",
        answer: "need unit price",
        acceptedAnswers: ["need unit price", "need per item", "same unit", "fair comparison"],
        helper: "A strong explanation says how the value was compared.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar" },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar" },
      ...
      {
        kind: "typed_response",
        prompt: "What unit should be used here?",
        answer: "per 100g",
        acceptedAnswers: ["per 100g", "100g", "same unit", "per 100 g"],
        helper: "A smaller common unit helps with mass comparisons.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", chunkCount: 10, chunkLabel: "100 g" },
      ...
      {
        kind: "typed_response",
        prompt: "Finish the sentence: “The first option is better because ______”",
        answer: "costs less per item",
        acceptedAnswers: ["costs less per item", "lower per item", "$8 per item", "per item is lower"],
        helper: "Focus on the matching unit.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Decision", [
          { label: "First", productName: "Snack Pack A", price: 64, quantityLabel: "8 packs", unitRateLabel: "Per pack" },
          { label: "Second", productName: "Snack Pack B", price: 81, quantityLabel: "9 packs", unitRateLabel: "Per pack" },
      ...
      {
        kind: "typed_response",
        prompt: "How do you show these rice prices fairly?",
        answer: "per 100g",
        acceptedAnswers: ["per 100g", "per 100 g", "same unit", "unit price"],
        helper: "Use a matching unit for both sizes.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", chunkCount: 10, chunkLabel: "100 g" },
      ...
      },
      {
        ...
        answer: "compare different sizes fairly",
        acceptedAnswers: ["compare different sizes fairly", "fair comparison", "same unit", "compare fairly"],
        helper: "Think about real shopping choices.",
        placeholder: "Type a short explanation",
      },
      {
        kind: "typed_response",
        prompt: "Explain why the second juice box pack is better.",
        answer: "costs less per box",
        acceptedAnswers: ["costs less per box", "lower per box", "$6 per box", "per box is lower"],
        helper: "Compare the cost per box, not just the totals.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Decision", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box" },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box" },
        ]),
      },
      {
        kind: "typed_response",
        prompt: "What should be calculated first here?",
        answer: "unit price",
        acceptedAnswers: ["unit price", "per item", "per 100g", "same unit"],
        helper: "Good explanations start with the fair comparison.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box" },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box" },
      ...
      {
        kind: "typed_response",
        prompt: "Why is a same-unit comparison more convincing?",
        answer: "fair comparison",
        acceptedAnswers: ["fair comparison", "same unit", "compare fairly", "unit price"],
        helper: "The same unit removes the size difference.",
        placeholder: "Type a short explanation",
      },
      {
        kind: "typed_response",
        prompt: "Explain why total price alone is not enough.",
        answer: "different quantities",
        acceptedAnswers: ["different quantities", "need same unit", "unit price", "different sizes"],
        helper: "Totals do not show value unless the quantities match.",
        placeholder: "Type a short explanation",
      },
      {
        kind: "typed_response",
        prompt: "What should a strong best-buy explanation include?",
        answer: "unit price comparison",
        acceptedAnswers: ["unit price comparison", "same unit", "per item", "per 100g"],
        helper: "A strong explanation gives the matching unit.",
        placeholder: "Type a short explanation",
      },
      {
        kind: "typed_response",
        prompt: "How do you know these protein bars are the same value?",
        answer: "$6 per bar",
        acceptedAnswers: ["$6 per bar", "6 per bar", "same per bar", "same unit price"],
        helper: "Say the matching rate directly.",
        placeholder: "Type a short explanation",
        visual: bestBuyVisual("Explain the Method", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar" },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar" },
      ...
      {
        kind: "typed_response",
        prompt: "How can you compare these two offers fairly?",
        answer: "same unit",
        acceptedAnswers: ["same unit", "per item", "unit price", "per 100g"],
        helper: "Keep the explanation short and mathematical.",
        placeholder: "Type a short explanation",
      },
      {
        kind: "typed_response",
        prompt: "Complete: “The better deal is the one with the lower ______”",
        answer: "unit price",
        acceptedAnswers: ["unit price", "per item cost", "cost per unit", "cost per 100g"],
        helper: "Think about what makes the comparison fair.",
        placeholder: "Type a short explanation",
      },
    ];
    return templates[randInt(0, templates.length - 1)] ?? templates[0]!;
  ...
  if (explicitMode === "y6_interpret_communicate") {
    const templates: MultipleChoiceQuestion[] = [
      {
        kind: "multiple_choice",
      ...
      },
      {
        ...
        options: ["It's cheaper", "It costs $8.20 per 100 g vs $9 per 100 g", "I think so"],
        answer: "It costs $8.20 per 100 g vs $9 per 100 g",
        helper: "The strongest explanation uses matching units.",
      ...
      },
      {
        ...
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "The second option costs less per 100 g.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", unitRate: 8.2, hideUnitRateUntilReveal: true, chunkCount: 10, chunkLabel: "100 g" },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which sentence communicates the decision clearly?",
        options: ["Second, because it costs less per item", "Second, because it looks better", "Second, because I guessed"],
        answer: "Second, because it costs less per item",
        helper: "A clear sentence names the unit.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Juice Boxes A", price: 84, quantityLabel: "12 boxes", unitRateLabel: "Per box", unitRate: 7, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Juice Boxes B", price: 96, quantityLabel: "16 boxes", unitRateLabel: "Per box", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      },
      {
        kind: "multiple_choice",
        prompt: "Which explanation is strongest?",
        options: ["The first total is smaller", "$8 per bottle is less than $9 per bottle", "8 is smaller than 9"],
        answer: "$8 per bottle is less than $9 per bottle",
        helper: "Strong explanations use the unit price directly.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Sports Drink A", price: 64, quantityLabel: "8 bottles", unitRateLabel: "Per bottle", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Sports Drink B", price: 81, quantityLabel: "9 bottles", unitRateLabel: "Per bottle", unitRate: 9, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which explanation best communicates “same value”?",
        options: ["They both cost $6 per bar", "$54 is smaller", "12 is bigger"],
        answer: "They both cost $6 per bar",
        helper: "Use the matching unit to communicate equality.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which reason best supports “Second is better”?",
        options: ["Second has more items", "Second costs less per item", "Second has a bigger total"],
        answer: "Second costs less per item",
        helper: "The best reason shows the unit price.",
        visual: bestBuyVisual("Communicate Clearly", [
          ...
          { label: "Second", productName: "Notebook Set B", price: 84, quantityLabel: "12 notebooks", unitRateLabel: "Per notebook", unitRate: 7, hideUnitRateUntilReveal: true },
        ]),
      },
      {
        kind: "multiple_choice",
        ...
        options: ["First", "Second", "Same"],
        answer: "Second",
        helper: "The second option costs $7 per notebook instead of $8.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Notebook Set A", price: 48, quantityLabel: "6 notebooks", unitRateLabel: "Per notebook", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Notebook Set B", price: 84, quantityLabel: "12 notebooks", unitRateLabel: "Per notebook", unitRate: 7, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which explanation is more convincing?",
        options: ["It has more items", "It costs less per notebook", "The total is bigger"],
        answer: "It costs less per notebook",
        helper: "A convincing explanation uses the same unit.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Notebook Set A", price: 48, quantityLabel: "6 notebooks", unitRateLabel: "Per notebook", unitRate: 8, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Notebook Set B", price: 84, quantityLabel: "12 notebooks", unitRateLabel: "Per notebook", unitRate: 7, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which statement communicates clearly?",
        options: ["Second is better because it costs $8.20 per 100 g instead of $9", "Second is better because 1 kg is bigger", "Second is better because $82 is more"],
        answer: "Second is better because it costs $8.20 per 100 g instead of $9",
        helper: "A clear statement uses the matching unit.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Rice A", price: 45, quantityLabel: "500 g", unitRateLabel: "Per 100 g", unitRate: 9, hideUnitRateUntilReveal: true, chunkCount: 5, chunkLabel: "100 g" },
          { label: "Second", productName: "Rice B", price: 82, quantityLabel: "1 kg", unitRateLabel: "Per 100 g", unitRate: 8.2, hideUnitRateUntilReveal: true, chunkCount: 10, chunkLabel: "100 g" },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "Which explanation best communicates the answer?",
        options: ["Same, because both cost $6 per bar", "Same, because both look similar", "Same, because 12 is bigger"],
        answer: "Same, because both cost $6 per bar",
        helper: "A good explanation gives the shared unit price.",
        visual: bestBuyVisual("Communicate Clearly", [
          { label: "First", productName: "Protein Bars A", price: 54, quantityLabel: "9 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
          { label: "Second", productName: "Protein Bars B", price: 72, quantityLabel: "12 bars", unitRateLabel: "Per bar", unitRate: 6, hideUnitRateUntilReveal: true },
        ]),
      ...
      {
        kind: "multiple_choice",
        prompt: "What is missing from “It’s cheaper”?",
