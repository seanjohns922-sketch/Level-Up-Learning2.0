...
export const YEAR1_PRETEST: Question[] = [
  ...
  },
  {
    ...
    options: [
      { id: "A", label: "12 shared into 3 groups of 4", groups: [4, 4, 4] },
      { id: "B", label: "12 shared into 6, 6, and 0", groups: [6, 6, 0] },
      { id: "C", label: "12 shared into 5, 5, and 2", groups: [5, 5, 2] },
      { id: "D", label: "12 shared into 1 group of 12", groups: [12] },
    ],
    answerOptionId: "A",
    skillId: "sharing_division",
    skillLabel: "Sharing Equally",
    linkedWeeks: [6],
    linkedLessons: [1, 2, 3],
    strand,
    difficultyBand,
