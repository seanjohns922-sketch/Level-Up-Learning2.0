...
function descriptor(
  ...
  return {
    ...
    learningIntentions,
    successCriteria,
    allocation: { pretest: allocation, posttest: allocation },
...
export function validateStarpathAssessmentBlueprints(levelFilter?: StarpathAssessmentLevel): string[] {
  const issues: string[] = [];
  const expectedConstructed = [10, 12, 10, 16, 14, 7, 7];
