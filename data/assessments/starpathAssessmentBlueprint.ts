...
const BLUEPRINT_DEFINITIONS: Array<{
  ...
  { level: 0, allocations: [
    ...
    ["AC9MFSP02", 10, ["Describe an object's position relative to a named reference.", "Place and move objects using familiar positional and directional language."], ["I can place an object where a direction says.", "I can describe where an object is and how it moved."], ["position-without-reference", "viewpoint-left-right", "route-start-order"], ["Place an object in a stated relative position.", "Move an object through a short unfamiliar route."], ["Build a small scene from positional instructions.", "Record a position using a word or oral choice after constructing it.", "Carry out and check an ordered movement sequence."]],
  ] },
  { level: 1, allocations: [
