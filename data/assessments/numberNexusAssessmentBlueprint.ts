...
const FORM_MIXES = {
  0: [{ ...form("pretest", { accessible: 8, moderate: 8, challenging: 4 }, { recall: 2, understanding: 6, application: 7, reasoning: 4, transfer: 1 }, 10, 10), purpose: "Record Ground baseline knowledge; every score begins the full twelve-week program." }, form("posttest", { accessible: 8, moderate: 8, challenging: 4 }, { recall: 2, understanding: 6, application: 7, reasoning: 4, transfer: 1 }, 10, 10)],
  1: [
    form("pretest", { accessible: 10, moderate: 8, challenging: 2 }, { recall: 4, understanding: 7, application: 6, reasoning: 3, transfer: 0 }, 8, 12),
    form("posttest", { accessible: 10, moderate: 8, challenging: 2 }, { recall: 4, understanding: 7, application: 6, reasoning: 3, transfer: 0 }, 8, 12),
  ],
  2: [
    form("pretest", { accessible: 8, moderate: 9, challenging: 3 }, { recall: 3, understanding: 6, application: 7, reasoning: 4, transfer: 0 }, 6, 14),
    form("posttest", { accessible: 8, moderate: 9, challenging: 3 }, { recall: 3, understanding: 6, application: 7, reasoning: 4, transfer: 0 }, 6, 14),
  ],
  3: [
    form("pretest", { accessible: 3, moderate: 13, challenging: 4 }, { recall: 0, understanding: 3, application: 17, reasoning: 0, transfer: 0 }, 3, 17),
    form("posttest", { accessible: 3, moderate: 13, challenging: 4 }, { recall: 0, understanding: 3, application: 17, reasoning: 0, transfer: 0 }, 3, 17),
  ],
  4: [
    form("pretest", { accessible: 6, moderate: 10, challenging: 4 }, { recall: 2, understanding: 5, application: 7, reasoning: 5, transfer: 1 }, 3, 17),
    form("posttest", { accessible: 6, moderate: 10, challenging: 4 }, { recall: 2, understanding: 5, application: 7, reasoning: 5, transfer: 1 }, 3, 17),
  ],
  5: [
    form("pretest", { accessible: 5, moderate: 10, challenging: 5 }, { recall: 1, understanding: 5, application: 7, reasoning: 5, transfer: 2 }, 2, 18),
    form("posttest", { accessible: 5, moderate: 10, challenging: 5 }, { recall: 1, understanding: 5, application: 7, reasoning: 5, transfer: 2 }, 2, 18),
  ],
  6: [
    form("pretest", { accessible: 4, moderate: 10, challenging: 6 }, { recall: 1, understanding: 4, application: 6, reasoning: 6, transfer: 3 }, 1, 19),
    form("posttest", { accessible: 4, moderate: 10, challenging: 6 }, { recall: 1, understanding: 4, application: 6, reasoning: 6, transfer: 3 }, 1, 19),
  ],
...
export const NUMBER_NEXUS_ASSESSMENT_BLUEPRINTS: readonly NumberNexusLevelBlueprint[] = [
  {
    ...
    descriptors: [
      D("AC9MFN01", "Name, represent and order numbers including zero to at least 20 using materials and numerals.", ["Connect number names, numerals, quantities and positions to 20.", "Order numbers and identify before, after and between."], ["I represent a named number accurately.", "I order numbers to 20 and explain their positions."], ["numeral-quantity-disconnect"], { pretest: 3, posttest: 3 }, "aligned", [1, 2, 3, 7, 8, 12], "Strong coverage; assessment must remain within Number rather than reuse retired Space contexts.", ["Build or select a quantity for a numeral.", "Complete a short number sequence."], ["Create a representation of a number.", "Order unfamiliar representations and explain one position."]),
      D("AC9MFN02", "Recognise and name the number of objects within a collection up to 5 using subitising.", ["Recognise structured quantities to 5 without counting one by one."], ["I name a quantity to 5 after a brief view."], ["subitising-vs-counting"], { pretest: 2, posttest: 2 }, "aligned", [4], "Week 4 is the dedicated subitising sequence and restricts instant-recognition tasks to collections of 1-5.", ["Briefly view and enter a quantity to 5."], ["Match differently arranged collections with the same subitised quantity."]),
      D("AC9MFN03", "Quantify and compare collections to at least 20 using counting and explain or demonstrate reasoning.", ["Count each object once and use cardinality.", "Compare collections using count evidence."], ["I count a rearranged collection accurately.", "I identify more, fewer or equal and show why."], ["counting-one-to-one", "cardinality-and-arrangement"], { pretest: 3, posttest: 3 }, "aligned", [2, 4, 5, 7, 12], "Coverage is broad; assessment must require count evidence rather than visual-size guessing.", ["Count and enter a collection total.", "Compare 2 collections after rearrangement."], ["Build a requested collection.", "Explain which collection has more using a count."]),
      D("AC9MFN04", "Partition and combine collections up to 10 using part-part-whole relationships and subitising to recognise and name the parts.", ["Split a whole into parts in more than one way.", "Combine known parts to make the whole."], ["I create 2 valid partitions of a whole to 10.", "I find a missing part without changing the whole."], ["part-whole-conservation", "subitising-vs-counting"], { pretest: 4, posttest: 4 }, "aligned", [6, 12], "Week 6 teaches the dedicated part-part-whole sequence; Week 12 independently reviews missing and flexible parts.", ["Complete a part-part-whole model.", "Build the same whole in another way."], ["Construct multiple partitions of one whole.", "Repair a model that changes the whole."]),
      D("AC9MFN05", "Represent practical situations involving addition, subtraction and quantification using materials and counting or subitising strategies.", ["Represent adding to, taking away and quantifying situations.", "Use a count or subitising strategy to solve."], ["I build the situation before answering.", "I produce and explain the resulting quantity."], ["operation-story-structure"], { pretest: 3, posttest: 3 }, "aligned", [9, 12], "Week 9 provides the dedicated construction sequence; Week 12 reviews practical collection changes independently.", [], ["Build and solve an unfamiliar add-to or take-away story."]),
      D("AC9MFN06", "Represent practical situations involving equal sharing and grouping using materials and counting or subitising strategies.", ["Model equal sharing and equal grouping.", "Distinguish groups from items in each group."], ["I make equal groups with no items left unfairly placed.", "I answer the quantity asked for in the situation."], ["equal-sharing-vs-grouping"], { pretest: 3, posttest: 3 }, "aligned", [10, 12], "Week 10 teaches sharing and grouping as distinct structures; Week 12 reviews an unfamiliar equal structure.", ["Share a small collection equally."], ["Build equal groups for an unfamiliar practical situation."]),
      D("AC9MFA01", "Recognise, copy and continue repeating patterns represented in different ways.", ["Identify the repeating unit.", "Copy and continue a repeating pattern across representations."], ["I mark the complete repeating unit.", "I continue the pattern without changing its rule."], ["repeating-unit"], { pretest: 2, posttest: 2 }, "aligned", [11, 12], "Week 11 progresses from recognising to continuing and constructing; Week 12 includes independent pattern transfer.", [], ["Create or continue a repeating pattern and identify its unit."]),
    ],
    forms: FORM_MIXES[0],
  },
  {
  ...
  },
  {
    ...
    curriculumSource: CURRICULUM_SOURCE,
    descriptors: [
      D("AC9M4N01", "Use place value to tenths and hundredths and decimal notation to name and represent decimals.", ["Represent, compare and locate tenths and hundredths."], ["I use decimal place value rather than digit length."], ["decimal-place-value", "decimal-length"], 2, "aligned", [1, 2], "Dedicated decimal place-value and reasoning sequences.", ["Enter, build or locate a decimal."], ["Compare decimal representations and diagnose a place-value error."]),
      D("AC9M4N02", "Explain and use properties of odd and even numbers.", ["Classify numbers and reason about parity of sums and products."], ["I justify parity using a property, not only the final digit."], ["odd-even-properties"], 2, "aligned", [3], "Dedicated parity sequence covering classification, sums and products.", ["Classify or complete a parity result."], ["Explain or diagnose an odd/even claim."]),
      D("AC9M4N03", "Find equivalent fractions with related denominators and connect fractions with decimal notation.", ["Generate equivalent fractions.", "Connect familiar fractions and decimals."], ["I scale numerator and denominator together.", "I preserve value across representations."], ["equivalent-fraction-scale", "fraction-decimal-connection"], 2, "aligned", [9, 12], "Dedicated equivalence sequence with cumulative integration.", ["Build an equivalent fraction or decimal match."], ["Explain equivalence across representations."]),
      D("AC9M4N04", "Count by fractions including mixed numerals and locate and represent them on number lines.", ["Continue fractional sequences.", "Place proper and mixed fractions on number lines."], ["I use equal intervals and preserve the counting step."], ["fraction-number-line", "mixed-number-whole"], 2, "aligned", [10, 12], "Dedicated fraction-sequence and number-line sequence with cumulative integration.", ["Place or enter a missing fraction."], ["Create and explain a fractional sequence on a number line."]),
      D("AC9M4N05", "Multiply and divide natural numbers by multiples and powers of 10 using place-value relationships.", ["Apply multiplicative place-value relationships without a calculator."], ["I predict direction and magnitude before calculating."], ["powers-ten-direction"], 1, "aligned", [4, 12], "Dedicated multiplicative place-value sequence with cumulative integration.", ["Enter a scaled value."], ["Diagnose and explain a powers-of-ten error."]),
      D("AC9M4N06", "Develop efficient strategies for addition, subtraction, multiplication and division with no remainder.", ["Choose and apply efficient operation strategies."], ["I solve accurately and explain why the strategy fits."], ["operation-story-structure", "additive-vs-multiplicative"], 3, "aligned", [5, 6, 12], "Dedicated additive and multiplicative strategy sequences with cumulative integration.", ["Produce a calculation result."], ["Compare strategies in a multi-step application."]),
      D("AC9M4N07", "Use estimation and rounding to check and explain calculations including financial transactions.", ["Select an estimation or rounding approach.", "Use it to judge reasonableness."], ["I justify the benchmark and conclusion."], ["estimation-vs-exact", "reasonableness-no-reference", "financial-operation-choice"], 2, "aligned", [7, 12], "Dedicated estimation sequence includes operation checks and financial transactions.", ["Estimate and judge a result."], ["Evaluate a financial calculation with a justified estimate."]),
      D("AC9M4N08", "Use mathematical modelling for practical additive and multiplicative problems including financial contexts.", ["Formulate, solve and interpret practical multi-operation problems."], ["I choose efficient operations and communicate contextual conclusions."], ["operation-story-structure", "financial-operation-choice", "additive-vs-multiplicative"], 4, "aligned", [8, 12], "Dedicated budgeting, transaction and multi-step modelling sequence.", ["Model and solve a practical problem."], ["Formulate and justify a multi-step financial or multiplicative model."]),
      D("AC9M4N09", "Follow and create algorithms using addition or multiplication to generate sets and describe patterns.", ["Run and create number-generating algorithms.", "Identify and explain emerging patterns."], ["I apply every decision correctly.", "I state a general pattern."], ["algorithm-step-order", "pattern-rule-vs-example"], 2, "aligned", [11, 12], "Dedicated addition, multiplication and algorithm-creation sequence.", ["Follow an algorithm and produce its outputs."], ["Create, test and explain an addition or multiplication algorithm."]),
    ],
    crossRealmCoverage: [{ codes: ["AC9M4A01", "AC9M4A02"], ownerRealm: "Pattern Peaks (Algebra)", implementationStatus: "owned-by-pattern-peaks", note: "Level 4 Algebra belongs to Pattern Peaks and is intentionally excluded from Number Nexus lessons, quizzes and assessments." }],
    forms: FORM_MIXES[4],
  },
  {
    level: 5,
    ...
    descriptors: [
      ...
      D("AC9M5N08", "Check and explain reasonableness in problems including financial contexts using suitable estimation.", ["Select and justify an estimation strategy."], ["I use the context to decide whether a result is reasonable."], ["estimation-vs-exact", "reasonableness-no-reference", "financial-operation-choice"], 2, "aligned", [1, 2, 5, 6, 11, 12], "Aligned.", ["Estimate and judge a result."], ["Explain whether a financial solution is reasonable."]),
      D("AC9M5N09", "Use mathematical modelling for practical additive and multiplicative problems including financial contexts.", ["Formulate, solve and interpret multi-step practical problems."], ["I choose efficient operations and communicate a contextual conclusion."], ["operation-story-structure", "financial-operation-choice", "additive-vs-multiplicative"], 2, "aligned", [1, 2, 11, 12], "Aligned; Year 6 percentage-of-quantity content is excluded.", ["Model and solve a practical problem."], ["Formulate and justify a multi-step model under a constraint."]),
      D("AC9M5N10", "Create and use algorithms to investigate factors, multiples and divisibility and describe patterns.", ["Build and run divisibility algorithms.", "Interpret resulting patterns."], ["I preserve decisions and explain the general pattern."], ["algorithm-step-order", "pattern-rule-vs-example", "factor-vs-multiple"], 2, "aligned", [3, 4, 12], "Algorithm and divisibility-pattern lessons carry AC9M5N10 explicitly, including cumulative review.", ["Follow a divisibility algorithm."], ["Create, test and explain an algorithm with decisions."]),
    ],
    crossRealmCoverage: [{ codes: ["AC9M5A01", "AC9M5A02"], ownerRealm: "Pattern Peaks (Algebra)", implementationStatus: "owned-by-pattern-peaks", note: "Level 5 Algebra belongs exclusively to Pattern Peaks. Number Nexus lessons, quizzes and assessments contain only AC9M5N-coded outcomes. AC9M5N10 algorithm evidence is also collected in Pattern Peaks and must retain the same curriculum code." }],
    forms: FORM_MIXES[5],
  },
  {
    level: 6,
    ...
    curriculumSource: CURRICULUM_SOURCE,
    descriptors: [
      D("AC9M6N01", "Use integers in situations including financial contexts and represent them on number lines and the Cartesian plane.", ["Interpret, order and represent positive and negative integers.", "Use signed coordinates accurately."], ["I reason correctly about order below zero.", "I preserve coordinate order and signs."], ["integer-order", "coordinate-sign"], 2, "aligned", [4, 10, 12], "Integer and coordinate learning is consolidated in Weeks 10 and 12.", ["Place or enter an integer/coordinate."], ["Interpret an unfamiliar integer context and justify a coordinate representation."]),
      D("AC9M6N02", "Identify properties of prime, composite and square numbers and use them to solve problems.", ["Classify numbers by their properties.", "Use factor structure to solve problems."], ["I treat one correctly and justify classifications with factors."], ["prime-composite-one", "factor-vs-multiple"], 2, "aligned", [2, 12], "Number properties are taught in Week 2 and revisited in the final review.", ["Classify or construct a number with stated properties."], ["Solve and justify a number-property constraint."]),
      D("AC9M6N03", "Use equivalence to compare, order and represent common fractions on the same number line and justify their order.", ["Create equivalent forms for comparison.", "Justify fraction order on one number line."], ["I use a shared scale and explain the order."], ["denominator-size", "equivalent-fraction-scale", "fraction-number-line"], 2, "aligned", [5, 9, 12], "Fraction comparison is taught in Week 5 and consolidated in Weeks 9 and 12.", ["Order or place fractions."], ["Justify an order using equivalence and a shared line."]),
      D("AC9M6N04", "Add and subtract decimals using place value, estimation and rounding to check reasonableness.", ["Align decimal place values and calculate.", "Estimate to check the result."], ["I align by place value and justify reasonableness."], ["decimal-operation-alignment", "reasonableness-no-reference"], 2, "aligned", [1, 9, 12], "Decimal calculation is taught in Week 1 and consolidated in Weeks 9 and 12.", ["Enter a decimal sum or difference."], ["Diagnose a place-value error and verify with estimation."]),
      D("AC9M6N05", "Solve addition and subtraction problems with fractions using equivalent fractions.", ["Create common denominators and solve fraction problems."], ["I preserve value while creating equivalent fractions."], ["fraction-add-denominator", "equivalent-fraction-scale"], 2, "aligned", [6, 12], "Fraction operations are taught in Week 6 and revisited in Week 12.", ["Enter a fraction sum or difference."], ["Solve and explain an unfamiliar fraction problem."]),
      D("AC9M6N06", "Multiply and divide decimals by powers-of-ten multiples using place value and reasonableness checks.", ["Scale decimals without a calculator.", "Check direction and magnitude."], ["I reason from place value and verify with estimation."], ["powers-ten-direction", "decimal-place-value", "reasonableness-no-reference"], 2, "aligned", [3, 12], "Decimal scaling is taught in Week 3 and revisited in Week 12.", ["Enter a scaled decimal."], ["Diagnose and explain a decimal-scaling error."]),
      D("AC9M6N07", "Find familiar fractions, decimals or percentages of quantities, including percentage discounts.", ["Choose an efficient representation to find part of a quantity.", "Calculate and interpret discounts."], ["I identify the whole and produce the correct part or sale amount."], ["percentage-of-quantity", "percentage-whole", "fraction-decimal-connection"], 3, "aligned", [7, 8, 9, 11, 12], "Quantity and discount learning is consolidated through rational-number and financial contexts.", ["Construct a fraction/decimal/percentage amount."], ["Solve and explain an unfamiliar discount or quantity problem."]),
      D("AC9M6N08", "Approximate solutions involving rational numbers and percentages, including financial contexts.", ["Select an appropriate approximation strategy.", "Use it to judge rational-number and percentage results."], ["I state the benchmark and explain why the approximation is useful."], ["estimation-vs-exact", "reasonableness-no-reference", "financial-operation-choice"], 2, "aligned", [1, 3, 8, 9, 11, 12], "Approximation and reasonableness recur across decimal, rational-number and financial contexts.", ["Approximate and judge a result."], ["Compare financial estimates and justify the useful one."]),
      D("AC9M6N09", "Use mathematical modelling with rational numbers and percentages, including financial contexts, and justify choices.", ["Formulate a rational-number or percentage model.", "Choose operations, interpret results and justify decisions."], ["I state assumptions and constraints.", "I communicate and defend the contextual solution."], ["operation-story-structure", "financial-operation-choice", "percentage-of-quantity"], 3, "aligned", [8, 11, 12], "Financial modelling is taught in Week 8 and strengthened through decision tasks in Weeks 11 and 12.", ["Model and solve a constrained problem."], ["Formulate, solve, interpret and justify an unfamiliar financial decision."]),
    ],
    crossRealmCoverage: [{ codes: ["AC9M6A01", "AC9M6A02", "AC9M6A03"], ownerRealm: "Pattern Peaks (Algebra)", implementationStatus: "owned-by-pattern-peaks", note: "Level 6 Algebra belongs exclusively to Pattern Peaks. Number Nexus lessons, quizzes and assessments contain only AC9M6N-coded outcomes." }],
    forms: FORM_MIXES[6],
  },
] as const;
...
export function validateNumberNexusAssessmentBlueprints(): string[] {
  ...
  for (const blueprint of NUMBER_NEXUS_ASSESSMENT_BLUEPRINTS) {
    ...
    for (const kind of ["pretest", "posttest"]) {
