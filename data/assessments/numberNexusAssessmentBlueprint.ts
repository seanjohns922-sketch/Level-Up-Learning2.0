...
export const NUMBER_NEXUS_ASSESSMENT_BLUEPRINTS: readonly NumberNexusLevelBlueprint[] = [
  ...
  },
  {
    ...
    crossRealmCoverage: [{ codes: ["AC9M3A01", "AC9M3A02", "AC9M3A03", "AC9M3A04"], ownerRealm: "Pattern Peaks (Algebra)", implementationStatus: "owned-by-pattern-peaks", note: "From Level 3 onward, Algebra is exclusively owned by Pattern Peaks; Number Nexus contains no AC9M3A-coded lessons or quizzes." }],
    forms: FORM_MIXES[3],
  },
  {
    level: 4,
  ...
  },
  {
    ...
    crossRealmCoverage: [{ codes: ["AC9M5A01", "AC9M5A02", "AC9M5A03"], ownerRealm: "Pattern Peaks (Algebra)", implementationStatus: "owned-by-pattern-peaks", note: "Level 5 Algebra belongs exclusively to Pattern Peaks. Number Nexus lessons, quizzes and assessments contain only AC9M5N-coded outcomes." }],
    forms: FORM_MIXES[5],
  },
  {
    level: 6,
