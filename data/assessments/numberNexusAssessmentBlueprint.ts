...
export const NUMBER_NEXUS_ASSESSMENT_BLUEPRINTS: readonly NumberNexusLevelBlueprint[] = [
  {
    ...
    descriptors: [
      ...
      D("AC9MFN02", "Recognise and name the number of objects within a collection up to 5 using subitising.", ["Recognise structured quantities to 5 without counting one by one."], ["I name a quantity to 5 after a brief view."], ["subitising-vs-counting"], { pretest: 0, posttest: 2 }, "aligned", [4, 6, 7, 12], "Week 4 now preserves the curriculum boundary by restricting instant-recognition tasks to collections of 1-5.", ["Briefly view and enter a quantity to 5."], ["Match differently arranged collections with the same subitised quantity."]),
      D("AC9MFN03", "Quantify and compare collections to at least 20 using counting and explain or demonstrate reasoning.", ["Count each object once and use cardinality.", "Compare collections using count evidence."], ["I count a rearranged collection accurately.", "I identify more, fewer or equal and show why."], ["counting-one-to-one", "cardinality-and-arrangement"], { pretest: 0, posttest: 3 }, "aligned", [2, 3, 4, 5, 7, 8, 12], "Coverage is broad; assessment must require count evidence rather than visual-size guessing.", ["Count and enter a collection total.", "Compare 2 collections after rearrangement."], ["Build a requested collection.", "Explain which collection has more using a count."]),
      D("AC9MFN04", "Partition and combine collections up to 10 using part-part-whole relationships and subitising to recognise and name the parts.", ["Split a whole into parts in more than one way.", "Combine known parts to make the whole."], ["I create 2 valid partitions of a whole to 10.", "I find a missing part without changing the whole."], ["part-whole-conservation", "subitising-vs-counting"], { pretest: 0, posttest: 4 }, "aligned", [6, 12], "Lesson metadata identifies the dedicated part-part-whole sequence explicitly.", ["Complete a part-part-whole model.", "Build the same whole in another way."], ["Construct multiple partitions of one whole.", "Repair a model that changes the whole."]),
      D("AC9MFN05", "Represent practical situations involving addition, subtraction and quantification using materials and counting or subitising strategies.", ["Represent adding to, taking away and quantifying situations.", "Use a count or subitising strategy to solve."], ["I build the situation before answering.", "I produce and explain the resulting quantity."], ["operation-story-structure"], { pretest: 0, posttest: 3 }, "aligned", [9], "Week 9 now provides a dedicated construction sequence for adding to, taking away and mixed collection changes.", [], ["Build and solve an unfamiliar add-to or take-away story."]),
      D("AC9MFN06", "Represent practical situations involving equal sharing and grouping using materials and counting or subitising strategies.", ["Model equal sharing and equal grouping.", "Distinguish groups from items in each group."], ["I make equal groups with no items left unfairly placed.", "I answer the quantity asked for in the situation."], ["equal-sharing-vs-grouping"], { pretest: 0, posttest: 3 }, "aligned", [10], "Week 10 now teaches equal sharing and equal grouping as distinct practical structures through student-built distributions.", ["Share a small collection equally."], ["Build equal groups for an unfamiliar practical situation."]),
      D("AC9MFA01", "Recognise, copy and continue repeating patterns represented in different ways.", ["Identify the repeating unit.", "Copy and continue a repeating pattern across representations."], ["I mark the complete repeating unit.", "I continue the pattern without changing its rule."], ["repeating-unit"], { pretest: 0, posttest: 2 }, "aligned", [11], "Week 11 now progresses from recognising the repeat to continuing and constructing repeating patterns.", [], ["Create or continue a repeating pattern and identify its unit."]),
    ],
    forms: FORM_MIXES[0],
  },
  {
