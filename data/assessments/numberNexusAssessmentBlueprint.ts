...
export type NumberNexusLevelBlueprint = {
  ...
  crossRealmCoverage?: readonly {
    ...
    implementationStatus: "relocation-required";
    note: string;
  }[];
  forms: readonly NumberNexusFormBlueprint[];
};

const CURRICULUM_SOURCE = "Australian Curriculum v9.0 Mathematics, Number and Algebra content descriptions, Foundation-Year 6; AC9M3M06 assigned to Number Nexus by platform curriculum ownership";
...
export const NUMBER_NEXUS_ASSESSMENT_BLUEPRINTS: readonly NumberNexusLevelBlueprint[] = [
  {
    ...
    descriptors: [
      D("AC9MFN01", "Name, represent and order numbers including zero to at least 20 using materials and numerals.", ["Connect number names, numerals, quantities and positions to 20.", "Order numbers and identify before, after and between."], ["I represent a named number accurately.", "I order numbers to 20 and explain their positions."], ["numeral-quantity-disconnect"], { pretest: 0, posttest: 3 }, "aligned", [1, 2, 3, 7, 8, 10, 11, 12], "Strong coverage; remove Space-based ordinal assessment contexts from the Number Nexus form.", ["Build or select a quantity for a numeral.", "Complete a short number sequence."], ["Create a representation of a number.", "Order unfamiliar representations and explain one position."]),
      D("AC9MFN02", "Recognise and name the number of objects within a collection up to 5 using subitising.", ["Recognise structured quantities to 5 without counting one by one."], ["I name a quantity to 5 after a brief view."], ["subitising-vs-counting"], { pretest: 0, posttest: 2 }, "partial", [4, 6, 7, 10, 11, 12], "Lessons extend subitising to 10; the descriptor-specific boundary to 5 is not preserved in metadata or assessment design.", ["Briefly view and enter a quantity to 5."], ["Match differently arranged collections with the same subitised quantity."]),
      D("AC9MFN03", "Quantify and compare collections to at least 20 using counting and explain or demonstrate reasoning.", ["Count each object once and use cardinality.", "Compare collections using count evidence."], ["I count a rearranged collection accurately.", "I identify more, fewer or equal and show why."], ["counting-one-to-one", "cardinality-and-arrangement"], { pretest: 0, posttest: 3 }, "aligned", [2, 3, 4, 5, 7, 8, 10, 11, 12], "Coverage is broad; assessment must require count evidence rather than visual-size guessing.", ["Count and enter a collection total.", "Compare 2 collections after rearrangement."], ["Build a requested collection.", "Explain which collection has more using a count."]),
      D("AC9MFN04", "Partition and combine collections up to 10 using part-part-whole relationships and subitising to recognise and name the parts.", ["Split a whole into parts in more than one way.", "Combine known parts to make the whole."], ["I create 2 valid partitions of a whole to 10.", "I find a missing part without changing the whole."], ["part-whole-conservation", "subitising-vs-counting"], { pretest: 0, posttest: 4 }, "aligned", [6, 10, 11, 12], "Lesson metadata now identifies the existing part-part-whole sequence explicitly.", ["Complete a part-part-whole model.", "Build the same whole in another way."], ["Construct multiple partitions of one whole.", "Repair a model that changes the whole."]),
      D("AC9MFN05", "Represent practical situations involving addition, subtraction and quantification using materials and counting or subitising strategies.", ["Represent adding to, taking away and quantifying situations.", "Use a count or subitising strategy to solve."], ["I build the situation before answering.", "I produce and explain the resulting quantity."], ["operation-story-structure"], { pretest: 0, posttest: 3 }, "missing", [], "No dedicated addition/subtraction situation sequence is present in the 12-week program.", [], ["Build and solve an unfamiliar add-to or take-away story."]),
      D("AC9MFN06", "Represent practical situations involving equal sharing and grouping using materials and counting or subitising strategies.", ["Model equal sharing and equal grouping.", "Distinguish groups from items in each group."], ["I make equal groups with no items left unfairly placed.", "I answer the quantity asked for in the situation."], ["equal-sharing-vs-grouping"], { pretest: 0, posttest: 3 }, "partial", [5, 12], "Equal groups appear, but explicit equal-sharing and grouping problem structures are not taught systematically.", ["Share a small collection equally."], ["Build equal groups for an unfamiliar practical situation."]),
      D("AC9MFA01", "Recognise, copy and continue repeating patterns represented in different ways.", ["Identify the repeating unit.", "Copy and continue a repeating pattern across representations."], ["I mark the complete repeating unit.", "I continue the pattern without changing its rule."], ["repeating-unit"], { pretest: 0, posttest: 2 }, "missing", [], "Current Number Patterns work is number ordering, not repeating-pattern structure.", [], ["Create or continue a repeating pattern and identify its unit."]),
    ],
    forms: FORM_MIXES[0],
  },
  {
    ...
    descriptors: [
      ...
      D("AC9M1A02", "Recognise, continue and create repeating patterns and identify the repeating unit.", ["Identify the complete repeat and use it to continue or create a pattern."], ["I mark the repeating unit and preserve it."], ["repeating-unit"], 2, "missing", [], "No explicit repeating-pattern sequence exists.", [], ["Construct a repeating pattern and identify its unit."]),
    ],
    forms: FORM_MIXES[1],
  },
  {
    ...
    descriptors: [
      ...
      D("AC9M2N03", "Recognise one-half as one of 2 equal parts and connect halves, quarters and eighths through repeated halving.", ["Create equal halves, quarters and eighths.", "Connect each fraction through repeated halving."], ["I verify equal parts.", "I show how one fraction is produced from another."], ["unequal-fraction-parts", "denominator-size", "fraction-whole"], 2, "aligned", [12], "Aligned but compressed into one week.", ["Create or identify equal fractional parts."], ["Build quarters or eighths by repeated halving and explain the connection."]),
      ...
      D("AC9M2N06", "Use mathematical modelling for additive and multiplicative problems including money transactions.", ["Formulate, solve and interpret practical additive or multiplicative situations."], ["I choose a fitting operation and communicate the contextual solution."], ["operation-story-structure", "financial-operation-choice", "additive-vs-multiplicative"], 3, "aligned", [11], "Money is explicit; broader modelling evidence should be strengthened.", ["Solve a practical transaction."], ["Model and interpret an unfamiliar transaction or grouping context."]),
      D("AC9M2A01", "Recognise, describe and create additive patterns with a constant increase or decrease and identify missing elements.", ["Determine a constant additive rule.", "Use it to find missing or future terms."], ["I state the rule and preserve it in both directions."], ["pattern-rule-vs-example"], 2, "aligned", [8], "Current multiplication-fluency work supplies constant additive sequences; explicit rule language needs confirmation.", ["Complete an additive pattern."], ["Create a pattern from a rule and explain a missing term."]),
      ...
      D("AC9M2A03", "Recall multiplication facts for twos and derive related division facts using doubling and halving.", ["Recall facts for twos.", "Use doubling and halving to derive related division facts."], ["I connect a twos fact to its division family."], ["fact-recall-transfer", "equal-sharing-vs-grouping"], 1, "partial", [8, 10], "Twos recall and inverse facts are now tagged correctly; explicit derivation through doubling and halving still needs strengthening.", ["Enter a related twos fact."], ["Derive and explain a multiplication/division fact using doubling or halving."]),
    ],
    forms: FORM_MIXES[2],
  },
  {
    ...
    curriculumSource: CURRICULUM_SOURCE,
    descriptors: [
      D("AC9M3N01", "Recognise, represent and order natural numbers beyond 10,000 using naming and writing conventions.", ["Read, write, partition, compare and order natural numbers beyond 10,000."], ["I preserve every place and use conventions accurately."], ["place-value-position", "zero-placeholder"], 3, "aligned", [1], "Aligned.", ["Enter or order large numbers."], ["Translate and compare unfamiliar large-number representations."]),
      D("AC9M3N02", "Represent and compare unit fractions and their multiples, and combine fractions with the same denominator to complete the whole.", ["Represent and compare specified unit fractions and multiples.", "Combine same-denominator fractions to make a whole."], ["I use equal parts and maintain the same whole.", "I complete the whole accurately."], ["unequal-fraction-parts", "denominator-size", "fraction-whole"], 3, "aligned", [11, 12], "Aligned.", ["Build a stated fraction or missing part."], ["Compare representations and complete a whole in a new context."]),
      D("AC9M3N03", "Add and subtract two- and three-digit numbers using place-value partitioning, rearranging and regrouping.", ["Choose and apply place-value strategies for addition and subtraction."], ["I regroup accurately and check the result."], ["operation-story-structure", "reasonableness-no-reference"], 3, "aligned", [3, 4, 5, 6], "Aligned.", ["Enter a sum, difference or missing value."], ["Solve a multi-step calculation and diagnose a regrouping error."]),
      D("AC9M3N04", "Multiply and divide one- and two-digit numbers using number sentences, diagrams, arrays and varied strategies.", ["Represent and solve multiplication and division problems."], ["I choose a valid model and interpret the result."], ["additive-vs-multiplicative", "equal-sharing-vs-grouping"], 3, "aligned", [6, 7, 8], "Aligned.", ["Build or solve an array/grouping."], ["Apply multiplication or division in an unfamiliar situation."]),
      D("AC9M3N05", "Estimate quantities and solutions to determine the reasonableness of calculations.", ["Make benchmark estimates.", "Use estimates to judge calculated results."], ["I explain why an estimate or result is reasonable."], ["estimation-vs-exact", "reasonableness-no-reference"], 2, "aligned", [2, 9], "Aligned.", ["Enter a reasonable estimate."], ["Evaluate a result against an estimate and justify the decision."]),
      D("AC9M3N06", "Use mathematical modelling for additive and multiplicative problems including financial contexts.", ["Formulate a practical problem with a number sentence.", "Choose, solve and interpret an efficient strategy."], ["I identify the operation from relationships, not keywords.", "I communicate the result in context."], ["operation-story-structure", "financial-operation-choice", "additive-vs-multiplicative"], 3, "partial", [6], "General problems are taught, but financial modelling and explicit AC9M3N06 mapping are absent.", ["Model a one- or two-step practical problem."], ["Formulate, solve and interpret an unfamiliar financial or multiplicative problem."]),
      D("AC9M3N07", "Follow and create algorithms with steps and decisions to investigate numbers and describe emerging patterns.", ["Follow a branching number algorithm.", "Create an algorithm and describe its pattern."], ["I preserve step order and decision conditions.", "I describe the pattern generated, not just examples."], ["algorithm-step-order", "pattern-rule-vs-example"], 1, "missing", [], "No number-algorithm sequence is present.", [], ["Create, test and explain a number algorithm."]),
      D("AC9M3M06", "Recognise relationships between dollars and cents and represent money values in different ways.", ["Use 100 cents = 1 dollar.", "Create equivalent representations of a money value."], ["I convert between dollar-cent forms accurately.", "I represent the same value with different denominations."], ["coin-count-vs-value", "dollar-cent-equivalence"], 2, "missing", [], "Intentionally owned by Number Nexus, but not currently taught or assessed at Year 3.", [], ["Construct equivalent dollar-cent representations and diagnose a non-equivalent value."]),
    ],
    crossRealmCoverage: [{ codes: ["AC9M3A01", "AC9M3A02", "AC9M3A03"], ownerRealm: "Pattern Peaks (Algebra)", implementationStatus: "relocation-required", note: "Level 3 Algebra is owned by the separate Algebra realm. Existing Number Nexus Weeks 3-4, 7-10 contain Algebra-coded content that must be relocated or remapped during the curriculum overhaul." }],
    forms: FORM_MIXES[3],
  },
  {
    level: 4,
