...
export const NUMBER_NEXUS_ASSESSMENT_BLUEPRINTS: readonly NumberNexusLevelBlueprint[] = [
  ...
  },
  {
    ...
    crossRealmCoverage: [{ codes: ["AC9M5A01", "AC9M5A02"], ownerRealm: "Pattern Peaks (Algebra)", implementationStatus: "owned-by-pattern-peaks", note: "Level 5 Algebra belongs exclusively to Pattern Peaks. Number Nexus lessons, quizzes and assessments contain only AC9M5N-coded outcomes." }],
    forms: FORM_MIXES[5],
  },
  {
    level: 6,
