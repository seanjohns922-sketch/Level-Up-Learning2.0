...
const PRETEST_SPECS: readonly ItemSpec[] = [
  ...
  { descriptor: "AC9M4N04", week: 10, lesson: 1, skillId: "fraction_sequence", skillLabel: "Count by Fractions", difficulty: "moderate", cognitiveCategory: "application", responseMode: "constructed_response", misconceptionTags: ["fraction-number-line"], contextKey: "y4-pre-quarter-sequence", structureKey: "y4-pre-enter-sequence-numerator", prompt: "Continue the quarter count. Enter the missing numerator.", correctAnswer: "4", type: "numeric", visual: { type: "number_y4_fraction_sequence", values: ["0/4", "1/4", "2/4", "3/4", "?/4"] } },
...
const POSTTEST_SPECS: readonly ItemSpec[] = [
  ...
  { descriptor: "AC9M4N04", week: 10, lesson: 1, skillId: "fraction_sequence", skillLabel: "Count by Fractions", difficulty: "moderate", cognitiveCategory: "application", responseMode: "constructed_response", misconceptionTags: ["fraction-number-line"], contextKey: "y4-post-three-quarter-sequence", structureKey: "y4-post-enter-sequence-numerator", prompt: "Continue the three-quarter count. Enter the missing numerator.", correctAnswer: "9", type: "numeric", visual: { type: "number_y4_fraction_sequence", values: ["0/4", "3/4", "6/4", "?/4"] } },
  ...
  { descriptor: "AC9M4N09", week: 11, lesson: 3, skillId: "create_addition_algorithm", skillLabel: "Create an Algorithm", difficulty: "challenging", cognitiveCategory: "application", responseMode: "manipulated_response", misconceptionTags: ["algorithm-step-order", "pattern-rule-vs-example"], contextKey: "y4-post-build-algorithm", structureKey: "y4-post-order-algorithm-steps", prompt: "Order the steps that generate this sequence.", correctAnswer: "Start at 8.||Record the number.||Add 9.||Repeat the last two steps.", type: "number_order", options: ["Repeat the last two steps.", "Add 9.", "Record the number.", "Start at 8."], visual: { type: "number_y4_sequence", values: [8, 17, 26, 35] } },
] as const;
