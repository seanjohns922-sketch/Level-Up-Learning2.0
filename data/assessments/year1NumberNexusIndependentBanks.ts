...
const PARALLEL_POST_VARIANTS: Array<Pick<ItemSpec,"prompt"|"correctAnswer"|"visual"> & Partial<Pick<ItemSpec,"options">>> = [
 ...
 {prompt:"Which grouping represents 120 counters?",correctAnswer:"24 groups of 5",options:["12 groups of 5","20 groups of 5","24 groups of 5"],visual:{type:"number_y1_group_choices",totals:[60,100,120]}},
