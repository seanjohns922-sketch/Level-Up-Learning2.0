...
const PRETEST_SPECS: readonly ItemSpec[] = [
  ...
  { descriptor: "AC9M1N05", week: 8, lesson: 2, skillId: "compare_coin_value", skillLabel: "Compare Money", difficulty: "challenging", cognitiveCategory: "reasoning", responseMode: "selected_response", misconceptionTags: ["coin-count-vs-value"], misconceptionDiagnosis: true, contextKey: "y1-pre-coin-count-value", structureKey: "y1-pre-diagnose-more-coins", prompt: "Mia has more coins. Does she always have more money?", correctAnswer: "No. Coin values matter.", type: "mcq", options: ["Yes. More coins means more money.", "No. Coin values matter.", "Yes. All coins have the same value."], visual: { type: "number_y1_money_compare", groups: [[1, 1, 1, 1], [5]], labels: ["Mia", "Sam"] } },
...
const POSTTEST_SPECS: readonly ItemSpec[] = [
  { descriptor: "AC9M1N01", week: 1, lesson: 1, skillId: "represent_number", skillLabel: "Represent Numbers", difficulty: "easy", cognitiveCategory: "recall", responseMode: "constructed_response", misconceptionTags: ["numeral-quantity-disconnect"], contextKey: "y1-post-seven-tens-three-ones", structureKey: "y1-post-enter-block-number", prompt: "Each rod is 10. Each small block is 1. Write the number shown.", correctAnswer: "73", type: "numeric", visual: { type: "number_y1_place_value", tens: 7, ones: 3 } },
  ...
  { descriptor: "AC9M1N05", week: 8, lesson: 1, skillId: "money_total", skillLabel: "Find a Money Total", difficulty: "moderate", cognitiveCategory: "application", responseMode: "constructed_response", misconceptionTags: ["coin-count-vs-value"], contextKey: "y1-post-six-dollar-five-dollar", structureKey: "y1-post-enter-money-total", prompt: "A puzzle costs $6. A kite costs $5. How much altogether?", correctAnswer: "11", type: "numeric", visual: { type: "number_y1_money", amounts: [6, 5], labels: ["Puzzle", "Kite"], unit: "$" } },
