/** @deprecated Legacy Measurelands banks. Retired; not used by production routes. */
...
const PRETEST_SELECTIONS: TaskSelection[] = [
  ...
  { week: 5, lesson: 1, index: 0, skillId: "time_unit_relationship", skillLabel: "Relate Formal Time Units" },
  { week: 6, lesson: 3, index: 0, skillId: "build_minute_time", skillLabel: "Build Time to the Minute" },
  { week: 7, lesson: 1, index: 0, skillId: "recognise_angle_turn", skillLabel: "Recognise an Angle as Turn" },
  { week: 7, lesson: 2, index: 0, skillId: "compare_right_angle", skillLabel: "Compare with a Right Angle" },
  { week: 6, lesson: 3, index: 1, skillId: "nearest_minute", skillLabel: "Read to the Nearest Minute" },
  { week: 7, lesson: 2, index: 1, skillId: "angle_benchmark", skillLabel: "Use a Right-Angle Benchmark" },
];
...
const POSTTEST_SELECTIONS: TaskSelection[] = [
  ...
  { week: 3, lesson: 1, index: 4, skillId: "choose_g_or_kg", skillLabel: "Choose Grams or Kilograms" },
  ...
  { week: 4, lesson: 1, index: 4, skillId: "choose_ml_or_l", skillLabel: "Choose Millilitres or Litres" },
  ...
  { week: 5, lesson: 3, index: 4, skillId: "duration_reasoning", skillLabel: "Reason about Duration" },
  { week: 6, lesson: 3, index: 3, skillId: "build_minute_time", skillLabel: "Build Time to the Minute" },
  { week: 7, lesson: 1, index: 4, skillId: "recognise_angle_turn", skillLabel: "Recognise an Angle as Turn" },
  { week: 7, lesson: 2, index: 4, skillId: "compare_right_angle", skillLabel: "Compare with a Right Angle" },
  { week: 6, lesson: 3, index: 2, skillId: "nearest_minute", skillLabel: "Reason About Nearest-Minute Time" },
  { week: 7, lesson: 2, index: 3, skillId: "angle_benchmark", skillLabel: "Use a Right-Angle Benchmark" },
];
