...
const YEAR6_POSTTEST_QUESTIONS: Question[] = [
  buildPostMcqQuestion(
    "y6-pt-01",
    "In 4.308, what is the value of the digit 3?",
    ["3", "0.3", "0.03", "0.003"],
    "0.3",
    "decimal_place_value",
    "Decimal Place Value",
  ...
  buildPostMcqQuestion(
    ...
    [
      "0.045, 0.054, 0.405, 0.45",
      "0.045, 0.405, 0.054, 0.45",
      "0.45, 0.405, 0.054, 0.045",
      "0.054, 0.045, 0.405, 0.45",
    ],
    "0.045, 0.054, 0.405, 0.45",
    "decimal_place_value",
    "Decimal Place Value",
  ...
  buildPostMcqQuestion(
    ...
    ["-12, -3, 0, 4, 9", "-3, -12, 0, 4, 9", "-12, 0, -3, 4, 9", "9, 4, 0, -3, -12"],
    "-12, -3, 0, 4, 9",
    "integer_reasoning",
    "Integer Reasoning",
    [4],
  ...
  buildPostMcqQuestion(
    "y6-pt-07",
    "Which number is a common factor of 24 and 36?",
    ["5", "6", "8", "9"],
    "6",
    "factors_multiples",
    "Factors & Multiples",
  ...
  buildPostMcqQuestion(
    "y6-pt-08",
    "Which number comes next in the square number pattern: 1, 4, 9, 16, __ ?",
    ["20", "25", "24", "36"],
    "25",
    "factors_multiples",
  ...
  buildPostMcqQuestion(
    "y6-pt-15",
    "A jacket costs $480. It is reduced by 25%. What is the sale price?",
    [
      "$120",
      "$360",
      "$420",
  ...
  buildPostMcqQuestion(
    ...
    [
      "Pack A: $18 for 6 bottles",
      "Pack B: $28 for 8 bottles",
      "Pack C: $35 for 10 bottles",
  ...
  buildPostMcqQuestion(
    "y6-pt-17",
    "Input → Output: 4 → 14, 6 → 20, 8 → 26. What is the rule?",
    ["×3 + 2", "×2 + 6", "+10", "×4 − 2"],
    "×3 + 2",
    "patterns_rules",
    "Patterns & Rules",
  ...
  buildPostMcqQuestion(
    "y6-pt-19",
    "Start at (-2, 3). Move right 4, then down 5. What is the new coordinate?",
    ["(2, -2)", "(2, 8)", "(-6, -2)", "(3, -1)"],
    "(2, -2)",
