...
const PRETEST_SELECTIONS: TaskSelection[] = [
  ...
  { week: 6, lesson: 2, index: 1, skillId: "elapsed_time_reasoning", skillLabel: "Reason About Elapsed Time" },
  { week: 6, lesson: 3, index: 1, skillId: "time_planning", skillLabel: "Plan with Time" },
  { week: 7, lesson: 1, index: 0, skillId: "recognise_angles", skillLabel: "Recognise Angles" },
  { week: 7, lesson: 1, index: 1, skillId: "right_angle_benchmark", skillLabel: "Use a Right-Angle Benchmark" },
  { week: 7, lesson: 2, index: 0, skillId: "compare_angles", skillLabel: "Compare Angles" },
  { week: 7, lesson: 3, index: 1, skillId: "named_angles", skillLabel: "Recognise Named Angles" },
];
...
const POSTTEST_SELECTIONS: TaskSelection[] = [
  ...
  { week: 3, lesson: 1, index: 4, skillId: "read_temperature", skillLabel: "Read a Thermometer" },
  ...
  { week: 6, lesson: 2, index: 3, skillId: "elapsed_time_reasoning", skillLabel: "Reason About Elapsed Time" },
  { week: 6, lesson: 3, index: 3, skillId: "time_context", skillLabel: "Plan an am/pm Schedule" },
  { week: 7, lesson: 1, index: 4, skillId: "right_angle_benchmark", skillLabel: "Use a Right-Angle Benchmark" },
  ...
  { week: 7, lesson: 3, index: 3, skillId: "named_angles", skillLabel: "Compare Named Angles" },
];
