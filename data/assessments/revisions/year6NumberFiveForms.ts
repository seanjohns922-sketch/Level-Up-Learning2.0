...
const profiles = [
 {temperatures:[7,-5,0,-12],point:[4,-3],prime:43,composites:[49,51],divisor:8,square:16,fractions:['5/12','2/5','3/8'],marker:7,addTop:16.58,subtractTop:14.3,fractionAdd:[3,1],fractionSubtract:['5/6','1/4',7],scale:3.086,divide:47.2,quantity:156,price:180,tank:840,estimate:[39.6,504],discountEstimate:198,budget:[1250,460,24,24.5],rates:[18,12],kits:[720,42]},
 {temperatures:[9,-6,0,-14],point:[-3,-4],prime:47,composites:[49,57],divisor:12,square:36,fractions:['5/8','7/12','3/5'],marker:5,addTop:26.58,subtractTop:15.3,fractionAdd:[1,3],fractionSubtract:['2/3','1/4',5],scale:4.073,divide:62.8,quantity:188,price:240,tank:680,estimate:[39.8,746],discountEstimate:398,budget:[1500,520,32,23.5],rates:[16,10],kits:[900,44]},
 {temperatures:[8,-7,0,-16],point:[-4,2],prime:53,composites:[49,63],divisor:18,square:36,fractions:['11/12','4/5','7/8'],marker:8,addTop:36.58,subtractTop:16.3,fractionAdd:[3,3],fractionSubtract:['5/6','3/4',1],scale:5.064,divide:78.4,quantity:236,price:260,tank:760,estimate:[39.7,654],discountEstimate:598,budget:[1550,560,28,26.5],rates:[20,13],kits:[1000,46]},
 {temperatures:[6,-8,0,-18],point:[2,4],prime:59,composites:[81,69],divisor:20,square:100,fractions:['5/12','2/5','5/8'],marker:9,addTop:46.58,subtractTop:17.3,fractionAdd:[1,7],fractionSubtract:['3/4','1/6',7],scale:6.047,divide:83.6,quantity:268,price:320,tank:920,estimate:[39.9,854],discountEstimate:798,budget:[1700,580,36,22.5],rates:[22,14],kits:[1100,48]},
 {temperatures:[5,-9,0,-17],point:[3,-2],prime:61,composites:[49,87],divisor:28,square:196,fractions:['4/5','7/12','5/8'],marker:11,addTop:56.58,subtractTop:18.3,fractionAdd:[1,1],fractionSubtract:['3/4','1/3',5],scale:7.038,divide:96.4,quantity:316,price:360,tank:880,estimate:[39.8,954],discountEstimate:998,budget:[1750,620,40,21.5],rates:[24,15],kits:[1200,52]},
] as const;
...
function make(form:NumberLevel6Form,f:number):NumberLevel6ReviewItem[] {
 ...
 const examples:Example[]=[
  ...
  numeric('The marker is ?/24. Enter the numerator.',p.marker*2,{type:'number_y6_number_line',min:0,max:1,divisions:12,marker:p.marker}),
...
function spoken(e:Example):string {
 ...
 :v.type==='number_y6_number_line'?`The line runs from zero to one, with twelve equal intervals and a marked point.`
