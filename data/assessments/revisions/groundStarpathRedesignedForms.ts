...
function makeTasks(f: number): GroundTask[] {
  ...
  return [
    ...
    { mode: "draw", prompt: `Make a triangle for ${["a flag", "a sail", "a roof", "a pennant", "a sign"][f]}.`, instruction: "Tap the dots to join them. Press Done when you have finished.", drawShape: "triangle" },
    { mode: "draw", prompt: `Make a ${c.draw} for ${["a window", "a door", "a tile", "a book cover", "a picture frame"][f]}.`, instruction: "Tap the dots to join them. Press Done when you have finished.", drawShape: c.draw },
