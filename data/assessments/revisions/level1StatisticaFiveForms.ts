...
export type StatsItem = {
 id:string;slot:number;skillLabel:string;code:'AC9M1ST01'|'AC9M1ST02'|'AC9M2ST01'|'AC9M2ST02'|'AC9M3ST01'|'AC9M3ST02'|'AC9M3ST03'|'AC9M4ST01'|'AC9M4ST02'|'AC9M4ST03'|'AC9M5ST01'|'AC9M5ST02'|'AC9M5ST03'|'AC9M6ST01'|'AC9M6ST02'|'AC9M6ST03';week:number;difficulty:'easy'|'moderate'|'challenging';
 prompt:string;instruction:string;context:string;categories:Category[];counts:number[];observations:number[];
 mode:'choice'|'counts'|'list'|'sort';source:'categories'|'objects'|'responses'|'graph'|'missing'|'duplicate'|'table'|'dual'|'brief'|'pictograph'|'comparison'|'line'|'records';
