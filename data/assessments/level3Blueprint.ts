...
export const LEVEL3_ASSESSMENT_BLUEPRINT: Level3AssessmentBlueprintItem[] = [
  {
    ...
    linkedWeeks: [1, 10],
    linkedLessons: [1, 2, 3],
    questionTypes: ["numeric_place_value", "number_order"],
    difficultyBand: "core",
    targetCountInTest: 2,
    allowedInPre: true,
    allowedInPost: true,
  },
  {
    ...
    linkedWeeks: [2, 9],
    linkedLessons: [1, 2, 3],
    questionTypes: ["numeric_rounding", "numeric_estimation", "mcq_estimation"],
  ...
  },
  {
    ...
    linkedWeeks: [3],
    linkedLessons: [1, 2, 3],
    questionTypes: ["numeric_addition"],
    difficultyBand: "mixed",
    targetCountInTest: 2,
    allowedInPre: true,
    allowedInPost: true,
  },
  {
    ...
    linkedWeeks: [4],
    linkedLessons: [1, 2, 3],
    questionTypes: ["numeric_subtraction"],
    difficultyBand: "mixed",
    targetCountInTest: 2,
    allowedInPre: true,
    allowedInPost: true,
  },
  {
    ...
    linkedWeeks: [5],
    linkedLessons: [1, 2, 3],
    questionTypes: ["numeric_written_method"],
  ...
  },
  {
    ...
    linkedWeeks: [6],
    linkedLessons: [1, 2, 3],
    questionTypes: ["numeric_word_problem"],
    difficultyBand: "stretch",
    targetCountInTest: 2,
    allowedInPre: true,
    allowedInPost: true,
  },
  {
    ...
    linkedWeeks: [7],
    linkedLessons: [1, 2, 3],
    questionTypes: ["numeric_equal_groups", "mcq_representation"],
    difficultyBand: "core",
    targetCountInTest: 2,
    allowedInPre: true,
    allowedInPost: true,
  },
  {
    ...
    linkedWeeks: [8, 10],
    linkedLessons: [1, 2],
    questionTypes: ["numeric_fact_family"],
    difficultyBand: "mixed",
    targetCountInTest: 1,
    allowedInPre: true,
    allowedInPost: true,
  ...
  place_value_number_knowledge: {
    A: [
      () => ({
        ...
        skillId: "place_value_number_knowledge",
        linkedWeeks: [1, 10],
        questionType: "numeric_place_value",
        difficultyBand: "core",
        instanceKey: "pv-a-1",
      }),
      () => ({
  ...
  rounding_estimation: {
    ...
    B: [
      ...
      () => ({
        ...
        skillId: "rounding_estimation",
        linkedWeeks: [2, 9],
        questionType: "numeric_estimation",
        difficultyBand: "mixed",
        instanceKey: "re-b-2",
      }),
    ],
  ...
  subtraction_fluency: {
    A: [
      () => ({
        ...
        skillId: "subtraction_fluency",
        linkedWeeks: [4],
        questionType: "numeric_subtraction",
        difficultyBand: "mixed",
        instanceKey: "sub-a-1",
      }),
      () => ({
  ...
  written_algorithms: {
    A: [
      () => ({
        ...
        skillId: "written_algorithms",
        linkedWeeks: [5],
        questionType: "numeric_written_method",
        difficultyBand: "stretch",
        instanceKey: "alg-a-1",
      }),
      () => ({
  ...
  two_step_word_problems: {
    A: [
      () => ({
        ...
        skillId: "two_step_word_problems",
        linkedWeeks: [6],
        questionType: "numeric_word_problem",
        difficultyBand: "stretch",
  ...
  multiplication_models: {
    A: [
      () => ({
        ...
        skillId: "multiplication_models",
        linkedWeeks: [7],
        questionType: "numeric_equal_groups",
        difficultyBand: "core",
      ...
      () => ({
        ...
        skillId: "multiplication_models",
        linkedWeeks: [7],
        questionType: "mcq_representation",
        difficultyBand: "core",
  ...
  division_and_fact_families: {
    A: [
      () => ({
        ...
        skillId: "division_and_fact_families",
        linkedWeeks: [8, 10],
        questionType: "numeric_fact_family",
        difficultyBand: "mixed",
        instanceKey: "div-a-1",
      }),
    ],
    B: [
      () => ({
        type: "numeric",
        prompt: "The fact family uses 3, 4 and 12. What number makes 12 ÷ 3 = ? true?",
        options: [],
        correctAnswer: "4",
        skillId: "division_and_fact_families",
        linkedWeeks: [8, 10],
  ...
  fractions_foundations: {
    ...
    B: [
      ...
      () => ({
        ...
        options: [
          { id: "a", label: "1/5", numerator: 1, denominator: 5 },
          { id: "b", label: "1/4", numerator: 1, denominator: 4 },
          { id: "c", label: "2/4", numerator: 2, denominator: 4 },
          { id: "d", label: "3/4", numerator: 3, denominator: 4 },
        ],
        correctAnswer: "b",
        skillId: "fractions_foundations",
...
export function validateLevel3AssessmentForms(): string[] {
  ...
  for (const [formLabel, questions] of [["A", formA], ["B", formB]] as const) {
    const constructedCount = questions.filter((question) => constructedTypes.has(question.type)).length;
    const selectedCount = questions.length - constructedCount;
    if (constructedCount !== 16 || selectedCount !== 4) {
      issues.push(`Form ${formLabel} response mix is ${constructedCount} constructed and ${selectedCount} selected; expected 16 and 4.`);
    }
    for (const question of questions.filter((item) => item.type === "numeric")) {
      if (question.options.length > 0) {
        issues.push(`${question.id} is a typed question but still exposes answer options.`);
      }
    }
  }
