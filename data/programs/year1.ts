    ...
    lessons: [
      {
        ...
        focus: "Identify the complete repeating unit rather than a partial or extended section",
        activityIdeas: ["Pattern scanner", "Unit comparison", "Repeat boundary check"],
        curriculum: ["AC9M1A02"],
        activities: [mc({ mode: "identify_repeating_unit", bank: "weekly_quiz" })],
      },
      {
        id: "y1-w11-l2",
        week: 11, lesson: 2,
        title: "Continue the Pattern",
        focus: "Continue AB, AAB, ABB and ABC patterns by preserving the complete unit",
        activityIdeas: ["Pattern extension", "Two-part prediction", "Broken continuation check"],
        curriculum: ["AC9M1A02"],
        activities: [mc({ mode: "continue_repeating_pattern", bank: "weekly_quiz" })],
      },
      {
        id: "y1-w11-l3",
        week: 11, lesson: 3,
        title: "Create and Check a Pattern",
        focus: "Construct multiple repeats of a stated unit and check that the rule stays unchanged",
        activityIdeas: ["Pattern constructor", "Rule test", "Pattern repair"],
        curriculum: ["AC9M1A02"],
        activities: [mc({ mode: "create_repeating_pattern", bank: "weekly_quiz" })],
      },
    ],
  },
  {
