...
const YEAR4_MEASURELANDS_RAW: WeekPlan[] = [
  ...
  },
  {
    ...
    curriculum: ["AC9M4M02"],
    lessons: [
      buildLesson(4, 1, "Measure the Outside", "Perimeter: recognise perimeter as the distance around a boundary.", ["Outside boundary", "Trace around", "Perimeter meaning"], ["AC9M4M02"]),
      buildLesson(4, 2, "Find the Perimeter", "Perimeter: calculate the total distance around simple shapes.", ["Add side lengths", "Total boundary", "Perimeter count"], ["AC9M4M02"]),
      buildLesson(4, 3, "Perimeter Problems", "Perimeter: solve real-world boundary measurement problems.", ["Real spaces", "Perimeter reasoning", "Problem solving"], ["AC9M4M02"]),
    ],
  },
  {
    ...
    curriculum: ["AC9M4M02"],
    lessons: [
      buildLesson(5, 1, "Measure Area", "Area: measure space covered using square units, including part units.", ["Square units", "Space covered", "Part units"], ["AC9M4M02"]),
      buildLesson(5, 2, "Compare Area", "Area: compare spaces using measured area.", ["Compare areas", "More space", "Less space"], ["AC9M4M02"]),
      buildLesson(5, 3, "Area Problems", "Area: solve real-world space-covering problems.", ["Area reasoning", "Covered space", "Problem solving"], ["AC9M4M02"]),
    ],
  },
  {
