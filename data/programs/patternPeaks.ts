...
const level3Seeds: WeekSeed[] = [
  ...
  },
  {
    ...
    lessons: [
      lesson("Addition and Subtraction", "Explain with a model how addition and subtraction undo each other.", "Inverse portals", "AC9M3A01"),
      ...
      lesson("Check with the Inverse", "Select and apply an inverse operation to verify a calculated answer.", "Balance check", "AC9M3A01", "AC9M3A03"),
    ],
  },
  {
    ...
    lessons: [
      lesson("Balance Both Sides", "Decide whether two additive number sentences represent equal values.", "Equation scales", "AC9M3A01"),
      lesson("True or False?", "Test and explain equivalence without treating equals as an answer cue.", "Truth gates", "AC9M3A01"),
      lesson("Make an Equivalent Sentence", "Partition a number to create a different but equivalent additive sentence.", "Equation builder", "AC9M3A01"),
    ],
  },
  {
    ...
    lessons: [
      lesson("Missing Addends", "Find an unknown part in addition and subtraction number sentences.", "Hidden-rune equations", "AC9M3A01"),
      ...
      lesson("Explain the Unknown", "Choose a strategy and justify why the missing value makes the sentence true.", "Reasoning chamber", "AC9M3A01", "AC9M3A03"),
    ],
  },
  {
    ...
    lessons: [
      lesson("Patterns in Addition Facts", "Use addition and subtraction facts to 20 to derive efficient calculations with larger numbers.", "Fact ladder", "AC9M3A02"),
...
const level5Seeds: WeekSeed[] = [
  ...
  },
  {
    ...
    lessons: [
      lesson("Unknown Products and Factors", "Distinguish missing products and factors, then choose the inverse needed.", "Factor lock mechanism", "AC9M5A02"),
      lesson("Unknown Dividends and Divisors", "Interpret each division value and determine a missing dividend or divisor.", "Division chamber controls", "AC9M5A02"),
      lesson("Large-Number Inverses", "Use multiplication as the inverse to solve division with larger multiples.", "High-altitude inverse lift", "AC9M5A02"),
    ],
  },
  {
