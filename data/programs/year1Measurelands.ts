...
const YEAR1_MEASURELANDS_RAW: WeekPlan[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      buildLesson(2, 3, "Fair or Unfair Measure?", "Mass: decide whether a measurement is fair — the balance cubes must all be the same.", ["Fair or unfair measure?", "Use the same cubes", "Fix the measurement"], ["AC9M1M01"]),
    ],
  },
  {
