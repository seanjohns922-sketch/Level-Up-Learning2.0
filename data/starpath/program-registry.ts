...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    weeks: [
      ...
      W("Make a Shape", "Compose familiar shapes from congruent parts.", ["AC9M1SP01"], skill("space-l1-make-shapes", "Make a shape from parts", "Composes a familiar shape from congruent parts and recognises the parts within the whole.", ["AC9M1SP01"], "construction-and-visualisation", ["space-l1-shape-features"]), [["Two Make One", "Join two shapes to make one bigger shape."], ["Build the Shape", "Make a shape from several parts."], ["Shape Maker", "Make different shapes from their parts."]], ["two-make-one", "build-the-shape", "shape-maker"], ["make", "part", "whole", "join", "shape"], ["A whole shape has no parts inside it.", "A shape can only be made one way."], "Composing familiar shapes from parts (part-whole reasoning)."),
      W("Build a Route", "Create an ordered set of moves to reach a goal.", ["AC9M1SP02"], skill("space-l1-give-directions", "Build and give a route", "Creates an ordered set of moves (an algorithm) that moves an object to a goal and records it for others.", ["AC9M1SP02"], "position-and-navigation", ["space-ground-follow-directions"]), [["Build a Route", "Choose moves in order that reach a goal."], ["Directions for a Friend", "Record an ordered route another explorer can follow."], ["Route Designer", "Design clear routes to different goals."]], ["route-builder", "direction-sequencer", "route-designer"], ["build", "instruction", "order", "route", "goal"], ["A route is clear without a starting point.", "The order of the moves does not matter."], "Creating and recording ordered routes (algorithms)."),
      W("Test & Fix", "Test a route, find the broken step and improve it.", ["AC9M1SP02"], skill("space-l1-fix-routes", "Test and fix a route", "Runs a route, diagnoses an incorrect step and revises a route until it reaches the goal.", ["AC9M1SP02"], "position-and-navigation", ["space-l1-give-directions"]), [["Find the Error", "Diagnose the wrong step in a route."], ["Fix the Route", "Finish a started route so it reaches the goal."], ["Test and Improve", "Run, repair and improve routes."]], ["route-debugger", "route-fixer", "route-test-lab"], ["test", "wrong", "fix", "improve", "route"], ["A failed route must be thrown away rather than fixed.", "A route only ever has one thing wrong."], "Testing, debugging and improving routes."),
...
const L1_MAKE_SHAPE_MECHANICS = ["make-1", "make-2", "make-3"] as const;
...
> = {
  ...
  "y1-space-w5-l1": { learningIntention: "I can join two shapes to make one shape.", mechanics: L1_MAKE_SHAPE_MECHANICS },
  "y1-space-w5-l2": { learningIntention: "I can make a shape from several parts.", mechanics: L1_MAKE_SHAPE_MECHANICS },
  "y1-space-w5-l3": { learningIntention: "I can make different shapes from their parts.", mechanics: L1_MAKE_SHAPE_MECHANICS },
  "y1-space-w6-l1": { learningIntention: "I can build a route to reach a goal.", mechanics: L1_BUILD_ROUTE_MECHANICS },
  "y1-space-w6-l2": { learningIntention: "I can record a clear route for someone else.", mechanics: L1_DIRECTIONS_FRIEND_MECHANICS },
  "y1-space-w6-l3": { learningIntention: "I can design routes to different goals.", mechanics: L1_ROUTE_DESIGNER_MECHANICS },
