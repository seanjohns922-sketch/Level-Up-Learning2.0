...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    weeks: [
      ...
      W("Build a Route", "Create routes, communicate displayed pathways and plan routes that follow mission rules.", ["AC9M1SP02"], skill("space-l1-give-directions", "Build and communicate routes", "Creates ordered routes, translates visual pathways into directions and plans routes that satisfy checkpoints and obstacles.", ["AC9M1SP02"], "position-and-navigation", ["space-ground-follow-directions"]), [["Build a Route", "Choose any valid sequence of moves that reaches the goal."], ["Directions for a Friend", "Translate a numbered trail into ordered directions another explorer can follow."], ["Route Designer", "Plan routes that visit checkpoints and avoid blocked squares."]], ["route-builder", "direction-sequencer", "route-designer"], ["build", "communicate", "order", "route", "checkpoint"], ["Only the shortest route can be correct.", "Reaching the goal is enough even when a mission rule was missed."], "Creating, communicating and planning routes with constraints."),
...
> = {
  ...
  "y1-space-w6-l2": { learningIntention: "I can turn a pathway into clear directions for someone else.", mechanics: L1_DIRECTIONS_FRIEND_MECHANICS },
  "y1-space-w6-l3": { learningIntention: "I can plan a route that follows mission rules.", mechanics: L1_ROUTE_DESIGNER_MECHANICS },
