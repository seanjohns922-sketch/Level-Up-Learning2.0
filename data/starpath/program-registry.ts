...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    progressionRationale: "Weeks 1-3 sharpen shape features (straight/curved, number of sides, opposite/parallel) using simple Year 2 language. Weeks 4-7 introduce two-dimensional maps: reading them, following pathways, giving and following directions, and using a map to reach a target. Week 8 combines shapes, maps and pathways in a Space Mapper mission before the Post-Test.",
    weeks: [
      ...
      W("Star Maps", "Read a two-dimensional map and locate places.", ["AC9M2SP02"], skill("space-l2-map-reading", "Read a star map", "Locates named places and positions on a simple two-dimensional map.", ["AC9M2SP02"], "spatial-representation", ["space-l1-shape-features"]), [["Reading a Space Map", "Find named places on a star map."], ["Find the Planet", "Name what is at a spot and find places."], ["Map Explorer", "Reason about positions on a map."]], ["read-the-map", "what-is-here", "map-explorer"], ["map", "place", "position", "spot", "next to"], ["A map shows things from the side.", "Places have no fixed position on a map."], "Reading a two-dimensional map and locating positions."),
      W("Space Pathways", "Follow and choose a pathway between places.", ["AC9M2SP02"], skill("space-l2-follow-pathways", "Follow a map pathway", "Follows and chooses a pathway between two places on a map.", ["AC9M2SP02"], "position-and-navigation", ["space-l2-map-reading"]), [["Follow the Path", "Follow a pathway between places."], ["Choose the Correct Route", "Choose the right pathway."], ["Space Maze", "Navigate a simple maze."]], ["follow-path", "choose-route", "space-maze"], ["path", "route", "follow", "maze", "between"], ["Any path reaches any place.", "A pathway needs no order."], "Following and choosing map pathways."),
      W("Navigation Missions", "Give and follow directions on a map.", ["AC9M2SP02"], skill("space-l2-navigation", "Navigate a mission", "Gives and follows directions to move an object across a map.", ["AC9M2SP02"], "position-and-navigation", ["space-l2-follow-pathways"]), [["Guide the Rover", "Follow directions to move the rover."], ["Move Geospin", "Give directions to move Geospin."], ["Mission Control", "Complete a navigation mission."]], ["guide-rover", "move-geospin", "mission-control"], ["direction", "move", "guide", "mission", "navigate"], ["Directions work without a starting point.", "The order of directions does not matter."], "Giving and following directions on a map."),
      W("Treasure Maps", "Use a map and directions to find a target.", ["AC9M2SP02"], skill("space-l2-treasure", "Find treasure on a map", "Uses a map and directions to locate a hidden target.", ["AC9M2SP02"], "position-and-navigation", ["space-l2-navigation"]), [["Map Reading", "Read a treasure map."], ["Find the Treasure", "Follow clues to the treasure."], ["Explorer Mission", "Apply map reading and directions together."]], ["map-reading", "find-treasure", "explorer-mission"], ["treasure", "map", "clue", "find", "target"], ["Treasure has no fixed spot on a map.", "A map is not needed to find a place."], "Using maps and directions to find a target."),
      W("Master Mapper", "Combine shapes, maps and pathways.", ["AC9M2SP01", "AC9M2SP02"], skill("space-l2-master-mapper", "Become a Master Mapper", "Combines shape features, map reading and pathway following to complete a cumulative mission.", ["AC9M2SP01", "AC9M2SP02"], "spatial-representation", ["space-l2-parallel-opposite", "space-l2-treasure"]), [["Shape and Map", "Combine shape features and map reading."], ["Pathway Master", "Follow and give pathways."], ["Master Mission", "Complete the final Space Mapper mission."]], ["shape-and-map", "pathway-master", "master-mission"], ["shape", "map", "pathway", "position", "mission"], ["Shapes and maps are unrelated.", "Only one route can solve a mission."], "Cumulative shapes, maps and pathways; the Post-Test unlocks the Space Mapper title."),
    ],
  },
  {
