...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    weeks: [
      ...
      W("Positions on a Map", "Describe how places sit next to, above and below each other on a map.", ["AC9M2SP02"], skill("space-l2-positions", "Describe positions on a map", "Describes which place is next to, above or below another on a two-dimensional map.", ["AC9M2SP02"], "spatial-representation", ["space-l2-map-reading"]), [["Next To and Beside", "Find the place to the left or right of another."], ["Above and Below", "Find the place above or below another."], ["Position Challenge", "Reason about next to, above and below."]], ["next-to", "above-below", "position-challenge"], ["position", "next to", "above", "below", "beside"], ["Position words need no reference place.", "A place can be in two spots at once."], "Describing positions of places on a map using next to, above and below."),
...
const L2_POSITIONS_MECHANICS = ["next-to", "above-below", "position-challenge"] as const;
