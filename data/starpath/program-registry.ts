...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    weeks: [
      W("3D Discoveries", "Recognise common three-dimensional objects and connect them with familiar uses and informal features.", ["AC9M3SP01"], skill("space-l3-object-recognition", "Recognise 3D objects", "Recognises cubes, spheres, cylinders, cones and rectangular prisms from their form, context and informal features.", ["AC9M3SP01"], "shape-and-object-reasoning", ["space-l2-compare"]), [["Meet the Space Objects", "Recognise and name the five 3D objects."], ["Objects at Work", "Use context and purpose to find familiar 3D objects."], ["3D Object Challenge", "Use feature clues to recognise objects independently."]], ["meet-the-objects", "find-the-object", "object-challenge"], ["3D object", "cube", "sphere", "cylinder", "cone", "rectangular prism"], ["A cube and a rectangular prism are the same object.", "Turning an object changes what it is."], "Recognition progressing from names to context, use and informal feature clues."),
