...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    weeks: [
      ...
      W("Direction Words", "Name, follow and give simple direction words to move on a grid.", ["AC9M1SP02"], skill("space-l1-direction-language", "Use direction words", "Names, follows and gives up, down, left and right to move an object one step on a grid.", ["AC9M1SP02"], "position-and-navigation", ["space-ground-movement-pathways"]), [["Which Way?", "Name the direction the rover moved."], ["Move the Rover", "Follow a direction word to make a move."], ["Say the Move", "Give the direction that reaches a goal."]], ["which-way", "move-rover", "say-the-move"], ["up", "down", "left", "right", "move"], ["A direction does not need a starting point.", "Up, down, left and right are hard to tell apart."], "Naming, following and giving single direction words."),
...
const L1_WHICH_WAY_MECHANICS = ["which-1", "which-2", "which-3"] as const;
const L1_MOVE_ROVER_MECHANICS = ["move-1", "move-2", "move-3"] as const;
const L1_SAY_MOVE_MECHANICS = ["say-1", "say-2", "say-3"] as const;
...
> = {
  ...
  "y1-space-w5-l1": { learningIntention: "I can name which way something moved.", mechanics: L1_WHICH_WAY_MECHANICS },
  "y1-space-w5-l2": { learningIntention: "I can follow a direction word to move the rover.", mechanics: L1_MOVE_ROVER_MECHANICS },
  "y1-space-w5-l3": { learningIntention: "I can give the direction that reaches a goal.", mechanics: L1_SAY_MOVE_MECHANICS },
