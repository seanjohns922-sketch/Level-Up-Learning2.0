...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    progressionRationale: "Students move from recognising 3D objects to comparing and choosing them for a purpose, then from reading maps to creating and navigating their own — object features are kept informal (rolls, stacks, slides); faces, edges, vertices and object views are reserved for Level 4.",
    weeks: [
      W("3D Discoveries", "Recognise and name common three-dimensional objects.", ["AC9M3SP01"], skill("space-l3-object-recognition", "Recognise 3D objects", "Recognises and names cubes, spheres, cylinders, cones and rectangular prisms.", ["AC9M3SP01"], "shape-and-object-reasoning", ["space-l2-compare"]), [["Meet the Space Objects", "Recognise and name the five 3D objects."], ["Find the Space Object", "Find a named 3D object in a scene."], ["3D Object Challenge", "Recognise and find objects on your own."]], ["meet-the-objects", "find-the-object", "object-challenge"], ["3D object", "cube", "sphere", "cylinder", "cone"], ["A cube and a rectangular prism are the same object.", "Turning an object changes what it is."], "Recognising and naming three-dimensional objects."),
      W("Object Detectives", "Compare and classify 3D objects using informal features.", ["AC9M3SP01"], skill("space-l3-object-features", "Compare 3D objects", "Compares and classifies 3D objects by informal features — whether they roll, stack or slide, and flat versus curved surfaces.", ["AC9M3SP01"], "shape-and-object-reasoning", ["space-l3-object-recognition"]), [["Which Object Is It?", "Name an object from a feature clue."], ["Compare Space Objects", "Compare objects by what they do — roll, stack, slide."], ["Space Object Sort", "Sort objects by a feature."]], ["which-object", "compare-objects", "object-sort"], ["roll", "stack", "slide", "flat", "curved"], ["All objects roll.", "An object can only do one thing."], "Comparing and classifying objects by informal features."),
      W("Building Starpath", "Choose objects whose features suit a purpose, and explain why.", ["AC9M3SP01"], skill("space-l3-object-design", "Choose objects for a purpose", "Chooses an object whose features suit a stated purpose and explains why it is suitable.", ["AC9M3SP01"], "construction-and-visualisation", ["space-l3-object-features"]), [["Build the Rover", "Build an object from 3D parts."], ["Choose the Best Shape", "Choose the best object for a job and say why."], ["Space Engineering", "Choose and justify objects for a design."]], ["build-the-rover", "choose-best-shape", "space-engineering"], ["purpose", "suitable", "because", "stable", "build"], ["The best-looking object is the best.", "A flat-sided object rolls."], "Choosing and justifying objects for a purpose."),
      W("Reading Space Maps", "Interpret a top-view map using its symbols, key and landmarks.", ["AC9M3SP02"], skill("space-l3-map-reading", "Read a space map", "Interprets a two-dimensional map using a key, symbols and the relative positions of landmarks.", ["AC9M3SP02"], "spatial-representation", ["space-l2-navigation"]), [["Map Symbols", "Read what a symbol stands for using the key."], ["Find the Landmark", "Find a landmark and say what is near it."], ["Map Explorer", "Read a map to answer questions about places."]], ["map-symbols", "find-landmark", "map-explorer"], ["map", "key", "symbol", "landmark", "relative"], ["A map shows things from the side.", "A symbol means whatever it looks like."], "Interpreting map symbols, keys and relative landmark positions."),
      ...
      W("Landmark Navigation", "Use a map and its landmarks to navigate to places.", ["AC9M3SP02"], skill("space-l3-navigation", "Navigate by landmarks", "Uses landmarks on a map to follow directions, plan routes and complete navigation missions.", ["AC9M3SP02"], "position-and-navigation", ["space-l3-map-creation"]), [["Treasure Hunt", "Follow landmark directions to a place."], ["Find the Observatory", "Plan a route to a landmark."], ["Mission Control", "Complete a multi-step navigation mission."]], ["treasure-hunt", "find-observatory", "mission-control"], ["route", "navigate", "landmark", "toward", "order"], ["Any path is as good as any other.", "Directions need no order."], "Navigating a map using landmarks and routes."),
...
> = {
  ...
  "y3-space-w2-l1": { learningIntention: "I can name an object from a feature clue.", mechanics: L3_OBJECT_FEATURES_MECHANICS },
  "y3-space-w2-l2": { learningIntention: "I can compare objects by what they do.", mechanics: L3_OBJECT_FEATURES_MECHANICS },
  "y3-space-w2-l3": { learningIntention: "I can sort objects by a feature.", mechanics: L3_OBJECT_FEATURES_MECHANICS },
