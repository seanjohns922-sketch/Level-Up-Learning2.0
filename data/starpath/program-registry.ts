...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  {
    ...
    summary: "Students name, sort, create and find familiar shapes, then describe position and movement in familiar spaces.",
    descriptors: [
    ...
    progressionRationale: "The sequence begins with concrete recognition and creation, then shifts to relational position and purposeful movement before combining both strands in a familiar-space mission.",
    weeks: [
      W("Shape Spotters", "Recognise and name familiar shapes in varied orientations.", ["AC9MFSP01"], skill("space-ground-shape-recognition", "Spot familiar shapes", "Recognises and names familiar shapes despite changes in size, colour or orientation.", ["AC9MFSP01"], "shape-and-object-reasoning"), [["Meet the Shape Crew", "Recognise circles, triangles, squares and rectangles."], ["Turned Shapes", "Match familiar shapes shown in different sizes and orientations."], ["Shape Hunt", "Find and justify familiar shapes in a scene."]], ["shape-sort", "rotation-match", "scene-shape-hunt"], ["circle", "triangle", "square", "rectangle", "shape"], ["A rotated square becomes a diamond.", "All four-sided shapes are squares."], "Recognition, naming and orientation invariance."),
      W("Sorting Stations", "Sort and compare shapes using visible features and reasons.", ["AC9MFSP01"], skill("space-ground-shape-sorting", "Sort shapes with a reason", "Sorts familiar shapes by a chosen feature and explains the grouping rule.", ["AC9MFSP01"], "shape-and-object-reasoning", ["space-ground-shape-recognition"]), [["Same and Different", "Compare one visible feature at a time."], ["Choose a Sorting Rule", "Sort a mixed set using shape features."], ["Mystery Sort", "Infer and explain another person's sorting rule."]], ["feature-match", "drag-sort", "rule-detective"], ["same", "different", "sort", "group", "reason"], ["Items can belong to only one possible group.", "Colour is always the most useful rule."], "Comparison, sorting rules and explanations."),
      W("Shape Makers", "Create and compose familiar shapes from parts.", ["AC9MFSP01"], skill("space-ground-shape-creation", "Make shapes", "Creates familiar shapes and combines parts while retaining shape language.", ["AC9MFSP01"], "construction-and-visualisation", ["space-ground-shape-recognition"]), [["Build One Shape", "Construct familiar shapes from moveable parts."], ["Shapes from Shapes", "Combine smaller shapes to make a larger familiar shape."], ["More Than One Way", "Create the same target in different ways and compare solutions."]], ["shape-builder", "compose-puzzle", "multiple-solution-builder"], ["make", "part", "whole", "join", "turn"], ["A target has only one valid construction.", "Parts stop being shapes when combined."], "Creating, composing and explaining shapes."),
      W("Shapes Around Us", "Recognise and describe shapes within everyday objects.", ["AC9MFSP01"], skill("space-ground-shapes-in-objects", "Find shapes in objects", "Identifies familiar shapes within environmental objects and gives a reason for the match.", ["AC9MFSP01"], "spatial-representation", ["space-ground-shape-recognition"]), [["Object Shape Hunt", "Locate familiar shapes inside everyday objects."], ["Which Shape Fits?", "Match object parts to shape representations."], ["Design a Space Station", "Use familiar shapes to design and explain an object."]], ["image-hotspot", "object-shape-match", "picture-composer"], ["object", "inside", "edge", "round", "corner"], ["An object must be exactly one shape.", "Only the outside outline can contain shapes."], "Environmental recognition and reasoned description."),
      W("Where Is It?", "Describe location relative to people and objects.", ["AC9MFSP02"], skill("space-ground-position-language", "Say where things are", "Uses relational position words from a clear viewpoint.", ["AC9MFSP02"], "position-and-navigation"), [["Position Words", "Connect above, below, beside, in front and behind to scenes."], ["Place the Astronaut", "Position an object by following one relational instruction."], ["Describe the Scene", "Choose precise words to communicate a location."]], ["position-match", "drag-place", "scene-description"], ["above", "below", "beside", "in front", "behind"], ["Left and right are the same from every viewpoint.", "Near and beside mean exactly the same thing."], "Relational position vocabulary and communication."),
      W("Near, Far, Inside", "Compare proximity and containment in familiar spaces.", ["AC9MFSP02"], skill("space-ground-location-relations", "Compare locations", "Describes inside, outside, near and far relationships between objects and locations.", ["AC9MFSP02"], "position-and-navigation", ["space-ground-position-language"]), [["Inside or Outside", "Identify containment relationships."], ["Near or Far", "Compare relative proximity using a shared scene."], ["Best Location", "Choose and justify a location from spatial clues."]], ["containment-sort", "proximity-compare", "location-reasoning"], ["inside", "outside", "near", "far", "between"], ["Near and far are absolute distances.", "An object cannot be between two others."], "Containment, proximity and location reasoning."),
      W("Move Through Space", "Follow and describe simple movements and pathways.", ["AC9MFSP02"], skill("space-ground-movement-pathways", "Follow a path", "Follows and communicates simple movement instructions in a familiar space.", ["AC9MFSP02"], "position-and-navigation", ["space-ground-location-relations"]), [["Move One Step", "Follow forward, backward and turn instructions."], ["Pathway Pilot", "Sequence several moves to reach a location."], ["Give the Directions", "Create directions for another character to follow."]], ["movement-simulator", "path-sequencer", "direction-builder"], ["forward", "backward", "turn", "path", "direction"], ["Turning changes location immediately.", "A route can omit the order of moves."], "Movement language, ordered pathways and communication."),
      W("Shape and Space Mission", "Apply shape, position and movement reasoning together.", ["AC9MFSP01", "AC9MFSP02"], skill("space-ground-spatial-mission", "Solve a shape and space mission", "Integrates shape recognition, location language and movement to solve familiar spatial problems.", ["AC9MFSP01", "AC9MFSP02"], "spatial-representation", ["space-ground-shapes-in-objects", "space-ground-movement-pathways"]), [["Read the Space Map", "Identify shapes and locations in a pictorial map."], ["Plan the Rescue", "Build a pathway from ordered spatial clues."], ["Explain the Mission", "Solve and justify a combined shape-and-position problem."]], ["picture-map-reader", "route-planner", "spatial-reasoning-choice"], ["map", "location", "pathway", "shape", "explain"], ["A map must look exactly like the real space.", "Only one route can be correct."], "Cumulative shape and familiar-space reasoning; assessed in the post-test."),
    ],
  },
  {
