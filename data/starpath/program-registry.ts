...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    weeks: [
      ...
      W("Star Maps", "Read a two-dimensional map and find named places.", ["AC9M2SP02"], skill("space-l2-map-reading", "Read a star map", "Locates named places on a simple two-dimensional map.", ["AC9M2SP02"], "spatial-representation", ["space-l2-compare"]), [["Reading a Space Map", "Find named places on a star map."], ["Find the Place", "Find each place by its name."], ["Map Reading Challenge", "Find places on the map independently."]], ["read-the-map", "find-the-place", "map-reading-challenge"], ["map", "place", "find", "label", "above"], ["A map shows things from the side.", "Places have no fixed position on a map."], "Reading a two-dimensional map and locating named places."),
      W("Positions on a Map", "Identify and describe the positions of places on a map.", ["AC9M2SP02"], skill("space-l2-positions", "Describe positions on a map", "Identifies what is at a position and describes which place is next to, above or below another on a two-dimensional map.", ["AC9M2SP02"], "spatial-representation", ["space-l2-map-reading"]), [["What Is Here?", "Name the place at a marked spot."], ["Next To and Nearby", "Find the place next to, above or below another."], ["Position Challenge", "Name spots and reason about positions."]], ["what-is-here", "next-to", "position-challenge"], ["position", "next to", "above", "below", "spot"], ["Position words need no reference place.", "A place can be in two spots at once."], "Identifying and describing positions of places on a map."),
      W("Pathways on a Map", "Follow a route, then give your own route to a place.", ["AC9M2SP02"], skill("space-l2-navigation", "Follow and give routes", "Follows a pathway to a named place and gives an ordered route across a two-dimensional map.", ["AC9M2SP02"], "position-and-navigation", ["space-l2-positions"]), [["Follow the Path", "Follow directions to a place."], ["Choose the Route", "Choose the first move toward a place."], ["Give a Route", "Build and give your own route."]], ["follow-path", "choose-route", "give-a-route"], ["path", "route", "follow", "give", "order"], ["Any path reaches any place.", "A route needs no order."], "Following and giving ordered routes on a map."),
...
const L2_READMAP_MECHANICS = ["read-the-map", "find-the-place", "map-reading-challenge"] as const;
const L2_POSITIONS_MECHANICS = ["what-is-here", "next-to", "position-challenge"] as const;
const L2_ROUTE_MECHANICS = ["follow-path", "choose-route", "give-a-route"] as const;
...
> = {
  ...
  "y2-space-w5-l1": { learningIntention: "I can read a star map and find a place.", mechanics: L2_READMAP_MECHANICS },
  "y2-space-w5-l2": { learningIntention: "I can find a place on the map by its name.", mechanics: L2_READMAP_MECHANICS },
  "y2-space-w5-l3": { learningIntention: "I can find places on the map on my own.", mechanics: L2_READMAP_MECHANICS },
  "y2-space-w6-l1": { learningIntention: "I can say which place is at a spot on the map.", mechanics: L2_POSITIONS_MECHANICS },
  "y2-space-w6-l2": { learningIntention: "I can work out which place is next to another.", mechanics: L2_POSITIONS_MECHANICS },
  "y2-space-w6-l3": { learningIntention: "I can reason about positions on the map.", mechanics: L2_POSITIONS_MECHANICS },
  "y2-space-w7-l1": { learningIntention: "I can follow a path to a place on the map.", mechanics: L2_ROUTE_MECHANICS },
  "y2-space-w7-l2": { learningIntention: "I can choose the first move toward a place.", mechanics: L2_ROUTE_MECHANICS },
  "y2-space-w7-l3": { learningIntention: "I can give my own route to a place.", mechanics: L2_ROUTE_MECHANICS },
