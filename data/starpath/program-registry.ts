...
const LEVEL_DEFINITIONS: LevelDefinition[] = [
  ...
  },
  {
    ...
    progressionRationale: "Weeks 1-4 sharpen shape features (straight/curved, number of sides, opposite/parallel, and comparing two shapes) using simple Year 2 language. Weeks 5-7 introduce two-dimensional maps: reading them, following and choosing pathways, and giving and following directions. Week 8 combines shapes, maps and pathways in a Space Mapper mission before the Post-Test.",
    weeks: [
      ...
      W("Star Maps", "Read a two-dimensional map and locate places.", ["AC9M2SP02"], skill("space-l2-map-reading", "Read a star map", "Locates named places and positions on a simple two-dimensional map.", ["AC9M2SP02"], "spatial-representation", ["space-l2-compare"]), [["Reading a Space Map", "Find named places on a star map."], ["Find the Planet", "Name what is at a spot and find places."], ["Map Explorer", "Reason about positions on a map."]], ["read-the-map", "what-is-here", "map-explorer"], ["map", "place", "position", "spot", "next to"], ["A map shows things from the side.", "Places have no fixed position on a map."], "Reading a two-dimensional map and locating positions."),
