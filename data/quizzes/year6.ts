...
export type Year6WeeklyQuizVisual =
  ...
  | {
      kind: "functionMachineCard";
      functionMachine: FunctionMachineCardVisualData;
    }
  | {
      kind: "inputOutputTable";
      inputOutputTable: InputOutputTableVisualData;
    }
  | {
      kind: "cartesianGrid";
...
const year6WeeklyQuizWeeks: Record<number, Year6WeeklyQuizWeek> = {
  ...
  10: {
    weekNumber: 10,
    quizTitle: "Week 10 Quiz",
    weeklyFocus: "Function machines, rule building, and tables to graph thinking",
    lesson1Title: "Function Machines",
    lesson2Title: "Build & Explain Rules",
    lesson3Title: "Tables to Graphs (Intro)",
    questions: [
      {
        id: "y6w10q1",
        lessonTag: 1,
        ...
        feedbackCorrect: "Correct — each input is doubled.",
        feedbackIncorrect: "Look at what happens from input to output.",
      },
      {
        id: "y6w10q2",
        lessonTag: 1,
        ...
        feedbackCorrect: "Correct — 4 multiplied by 3 is 12.",
        feedbackIncorrect: "Apply the rule to the input.",
      },
      {
        id: "y6w10q3",
        lessonTag: 1,
        ...
        feedbackCorrect: "Correct — each input is multiplied by 4.",
        feedbackIncorrect: "Try multiplication first.",
      },
      {
        id: "y6w10q4",
        lessonTag: 1,
        ...
        feedbackCorrect: "Correct — the outputs go up by 1.",
        feedbackIncorrect: "Look at how the output changes.",
      },
      {
        id: "y6w10q5",
        lessonTag: 1,
        questionText: "Describe the rule.",
        answerType: "typedShort",
        correctAnswer: "+5",
        acceptedAnswers: ["+5", "add 5", "plus 5"],
        ...
        feedbackCorrect: "Correct — the output is 5 more than the input.",
        feedbackIncorrect: "What changes from input to output each time?",
      },
      {
        id: "y6w10q6",
        lessonTag: 2,
        ...
        feedbackCorrect: "Correct — each output is 4 more than the input.",
        feedbackIncorrect: "Test the rule on all rows.",
      },
      {
        id: "y6w10q7",
        lessonTag: 2,
        ...
        feedbackCorrect: "Correct — each input is multiplied by 5.",
        feedbackIncorrect: "Try multiply first, then adjust.",
      },
      {
        id: "y6w10q8",
        lessonTag: 2,
        ...
        feedbackCorrect: "Correct — each input is multiplied by 3.",
        feedbackIncorrect: "Check whether the output is a multiple of the input.",
      },
      {
        id: "y6w10q9",
        lessonTag: 2,
        questionText: "Fill the missing value.",
        answerType: "multipleChoice",
        options: ["16", "18", "20"],
        correctAnswer: "18",
        visual: {
        ...
        feedbackCorrect: "Correct — the output is 3 times the input.",
        feedbackIncorrect: "Use the same rule on the last row.",
      },
      {
        id: "y6w10q10",
        lessonTag: 2,
        questionText: "Find the rule.",
        answerType: "typedShort",
        correctAnswer: "+5",
        acceptedAnswers: ["+5", "add 5", "plus 5"],
        placeholder: "Type the rule",
        ...
        feedbackCorrect: "Correct — both outputs are 5 more than the inputs.",
        feedbackIncorrect: "Look at how much is added each time.",
      },
      {
        id: "y6w10q11",
        lessonTag: 3,
        questionText: "Which coordinate matches?",
        answerType: "multipleChoice",
        options: ["(2, 6)", "(6, 2)", "(2, 4)"],
        correctAnswer: "(2, 6)",
        visual: {
          ...
          inputOutputTable: {
            type: "input_output_table",
            title: "Table to Point",
            pairs: [{ input: "2", output: "6" }],
          },
        },
        feedbackCorrect: "Correct — ordered pairs are written as (x, y).",
        feedbackIncorrect: "Use input as x and output as y.",
      },
      {
        id: "y6w10q12",
        lessonTag: 3,
        questionText: "Plot the point (3, 9).",
        answerType: "typedShort",
        correctAnswer: "(3, 9)",
        acceptedAnswers: ["(3, 9)", "(3,9)", "3,9", "3 9"],
        placeholder: "Tap the grid point",
        visual: {
          kind: "cartesianGrid",
          cartesianGrid: {
            type: "cartesian_grid",
            ...
            yMax: 10,
            points: [],
            targetCoordinate: "(3, 9)",
          },
        },
        feedbackCorrect: "Correct — input 3 and output 9 becomes the point (3, 9).",
        feedbackIncorrect: "Use input for x and output for y.",
      },
      {
        id: "y6w10q13",
        lessonTag: 3,
        questionText: "Which points match the rule ×2?",
        answerType: "multipleChoice",
        options: [
          "(2, 4), (3, 6), (4, 8)",
          "(2, 5), (3, 7), (4, 9)",
        ...
        feedbackCorrect: "Correct — each y-value is double x.",
        feedbackIncorrect: "Check whether each output is exactly 2 times the input.",
      },
      {
        id: "y6w10q14",
        lessonTag: 3,
        questionText: "Which point is wrong?",
        answerType: "multipleChoice",
        options: ["(2, 6)", "(3, 9)", "(4, 10)"],
        correctAnswer: "(4, 10)",
        visual: {
          kind: "cartesianGrid",
          cartesianGrid: {
        ...
        feedbackCorrect: "Correct — 4 multiplied by 3 should be 12, not 10.",
        feedbackIncorrect: "Check the rule ×3 against each point.",
      },
      {
        id: "y6w10q15",
        lessonTag: 3,
        questionText: "Rule: ×4. What is the output when input is 5?",
        answerType: "numeric",
        correctAnswer: "20",
        acceptedAnswers: ["20.0"],
        placeholder: "Type the answer",
        feedbackCorrect: "Correct — 5 multiplied by 4 is 20.",
        feedbackIncorrect: "Apply the rule to the input.",
      },
    ],
  },
