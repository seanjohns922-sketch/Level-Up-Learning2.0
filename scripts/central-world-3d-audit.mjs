...
check(environment.includes("SizedWorldModel") && environment.includes("getItemPresentation"), "Purchased items must render at a true per-item footprint scale (the AFL oval towers over a cubby)");
