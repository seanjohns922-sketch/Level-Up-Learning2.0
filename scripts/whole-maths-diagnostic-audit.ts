...
assert.equal(
  ...
  4.1,
  "The published Year 5 worked example must calculate to 4.10.",
);
assert.equal(
...
assert(panel.includes("Full diagnostic launch and the official weighted overall remain locked"), "The staged UI must not imply a complete six-strand release.");
