...
check("historical school reporting boundary is documented", has(docs, "Historical reporting", "does not rewrite prior class IDs", "cannot see learning completed under the new school"));
