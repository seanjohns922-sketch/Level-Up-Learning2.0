  ...
  select jsonb_build_object(
    'children', coalesce(jsonb_agg(jsonb_build_object(
      ...
      'realms', coalesce((select jsonb_agg(jsonb_build_object(
        ...
        'unlockedLegends', coalesce(progress.unlocked_legends,'[]'::jsonb),
      ...
      'gems', coalesce((select jsonb_agg(jsonb_build_object(
        'gemId', definition.id,
        ...
        where gem.student_id=student.id and definition.is_active), '[]'::jsonb),
