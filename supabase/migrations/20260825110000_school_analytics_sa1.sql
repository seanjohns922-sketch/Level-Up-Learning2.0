-- Phase SA1: canonical, school-scoped analytics for school leaders.
  ...
  select jsonb_build_object(
    ...
    'curriculum', coalesce((select jsonb_agg(jsonb_build_object(
      ...
      select coalesce(cl.topic_focus, 'Unlabelled lesson evidence') as topic_focus,
        co.year_level, count(distinct cl.student_id) as students, count(*) as evidence_count,
      ...
      group by coalesce(cl.topic_focus, 'Unlabelled lesson evidence'), co.year_level
    ) topics), '[]'::jsonb),
