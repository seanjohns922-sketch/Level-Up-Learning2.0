-- Phase SA1.2: base achievement bands on ASSESSMENT scores, not lesson
-- practice. Adds latest pre/post-test per student x realm (assessmentScore)
-- and rebuilds the curriculum rollup from per-level post-tests.
-- Regenerated from 20260826120000_school_analytics_realm_curriculum.sql.
