-- Preserve the original baseline and exclude incompatible Space versions.
begin;
...
begin
  ...
  select jsonb_build_object(
    ...
    'methodology', jsonb_build_object(
      ...
      'growth', 'Space: later post-test minus first baseline at the same working level, with matching assessment versions. Other realms: latest post-test minus latest pre-test at the same working level.',
