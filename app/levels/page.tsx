  ...
  return (
    <main className="min-h-screen relative px-6 py-10">
      <div className="fixed inset-0 z-0">
        <img src="/images/tower-hub-bg.jpg" alt="" className="w-full h-full object-cover" style={{ saturate: 1.15, objectPosition: "center 30%", transform: "scale(1.15)", transformOrigin: "center 35%" }} />
