      ...
      <div className="relative z-10 flex min-h-screen flex-col px-5 py-5 sm:px-8">
        ...
        <section className="mx-auto flex w-full max-w-5xl flex-1 flex-col justify-center py-12">
          <div className="text-center">
            ...
            <span className="inline-flex rounded-full border border-indigo-200/30 bg-indigo-300/10 px-3 py-1 text-[11px] font-black uppercase tracking-[0.16em] text-indigo-100">
              Demo · Preview
            </span>
          ...
          <div className="mt-10 border-y border-white/15 bg-black/25 py-7 backdrop-blur-md">
            <div className="grid gap-8 px-5 md:grid-cols-[1.2fr_1fr] md:px-8">
              <div>
                ...
                <p className="mt-4 text-sm font-bold text-indigo-100/70">Demo progress is not saved.</p>
                {persistenceReason ? <p className="mt-2 text-xs text-white/40">{persistenceReason}</p> : null}
              </div>
