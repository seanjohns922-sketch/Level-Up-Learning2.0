...
export const MEASURELANDS_LEVEL_THEMES: Record<RealmLevelId, MeasurelandsLevelTheme> = {
  ...
  "Year 3": { level: "Year 3", background: "/images/measurelands-panorama-y3-360-4k.jpg", panoramaSections: ["/images/measurelands-level3-detail/section-1.webp", "/images/measurelands-level3-detail/section-2.webp", "/images/measurelands-level3-detail/section-3.webp", "/images/measurelands-level3-detail/section-4.webp"], sky: "#9fc9ee", fog: "#9eac94", ambientLight: "#fff0d1", sunLight: "#ffd27d", accent: "#d6a64a", secondaryAccent: "#6d452d" },
