...
const TABLE: Record<string, SkillCoaching> = {
  ...
  ml_y5_w7_l1: { tip: "Compare the angle to a right angle (90°) and a straight angle (180°) to estimate its size." },
  ml_y5_w7_l2: { tip: "Centre on the vertex, baseline on 0°, then read the scale that starts at zero." },
  ml_y5_w7_l3: { tip: "Start at zero, then drag to the exact degree you need." },
