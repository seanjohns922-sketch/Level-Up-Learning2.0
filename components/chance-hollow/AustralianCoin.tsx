export default function AustralianCoin({side,size=64}:{side:"heads"|"tails";size?:number}){
 ...
 if(side==='tails')return <svg viewBox='0 0 64 64' width={size} height={size} role='img' aria-label={`Australian one dollar coin, ${side}`}><image href='/coins/coin-1.png' x='0' y='0' width='64' height='64'/></svg>;
 return <svg viewBox='0 0 64 64' width={size} height={size} role='img' aria-label={`Australian one dollar coin, ${side}`}>
