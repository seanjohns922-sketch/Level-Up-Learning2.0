...
export const MEASURELANDS_DASHBOARD_CONFIG = {
  ...
  theme: {
    pageBackground: "#1a0d00",
    accent: "#fde68a",
    accentRgb: "251,191,36",
    secondaryAccent: "#c4b5fd",
    secondaryRgb: "109,40,217",
    mutedAccent: "rgba(254,243,199,0.78)",
    pathText: "rgba(186,230,253,0.9)",
    text: "#fff7ed",
    navBackground: "rgba(20,8,0,0.72)",
    navBorder: "rgba(251,191,36,0.12)",
    realmChipBackground: "rgba(120,53,15,0.45)",
    realmChipBorder: "rgba(251,191,36,0.32)",
