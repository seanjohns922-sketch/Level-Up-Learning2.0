...
const reviews: Review[] = [
  ...
  ...Object.values(STARPATH_LEVEL_THEMES).map(t => ({ label: label("Starpath", t.level), panorama: { asset: t.background, sectionAssets: t.panoramaSections, sharpDetail: Boolean(t.panoramaSections), rearAsset: t.backBackground, radius: 52, height: t.panoramaHeight ?? 62, y: t.panoramaY ?? 24.7, horizontalScale: .86, rotationY: t.panoramaRotation, flipX: true, skyBlendColor: t.sky } })),
