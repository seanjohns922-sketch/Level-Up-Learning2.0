...
const ALL_REALMS = [
  ...
  { id: "statistica", name: "Statistica", symbol: "▣", description: "Data, graphs & interpretation", color: "rgb(240,107,100)", colorDim: "rgba(240,107,100,0.22)" },
...
export default function RealmCarousel() {
  ...
  async function enterRealm() {
    ...
    if (isChancePreview) {
      setLastRealm(current.id);
      exitReviewMode();
      const chanceRoute = displayedLevel === "Year 3" || displayedLevel === "Year 4" || displayedLevel === "Year 5" || displayedLevel === "Year 6" ? "/world/chance-hollow" : "/chance-hollow";
