...
const THEMES = {
  ...
  measurement: {
    ...
    pageBg: "#160d08",
    shellBg: "rgba(31, 19, 11, 0.96)",
    panelBg: "rgba(58, 38, 20, 0.78)",
    panelBorder: "rgba(253, 230, 138, 0.23)",
    accent: "#fde68a",
    accentSoft: "#fef3c7",
    secondary: "#c4b5fd",
    heroOverlay:
      "linear-gradient(90deg, rgba(45,25,8,0.98) 0%, rgba(58,35,13,0.86) 48%, rgba(43,24,9,0.25) 100%)",
    backdropOverlay:
      "linear-gradient(180deg, rgba(30,15,6,0.58), rgba(26,12,8,0.9))",
    videoBg: "linear-gradient(135deg, #2a1709 0%, #5b3512 52%, #6d28d9 130%)",
    buttonBg: "linear-gradient(90deg, #92400e, #ca8a04, #7c3aed)",
    buttonShadow: "0 16px 40px rgba(202,138,4,0.22)",
    gridColor: "rgba(253,230,138,0.32)",
    ThemeIcon: Ruler,
  },
} as const;
