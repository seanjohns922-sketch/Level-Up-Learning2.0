...
export const REALM_LESSON_THEMES = {
  ...
  measurement: {
    ...
    panelBg: "rgba(74, 47, 30, 0.72)",
    panelBorder: "rgba(214, 166, 74, 0.30)",
    accent: "#d6a64a",
    accentSoft: "#f3e3bf",
    secondary: "#e6c079",
    heroOverlay:
    ...
    backdropOverlay:
      "linear-gradient(180deg, rgba(23,15,9,0.6), rgba(15,10,6,0.92))",
    videoBg: "linear-gradient(135deg, #1f1409 0%, #3a2413 52%, #7a5518 120%)",
