...
export function StarpathRouteBuildCard({
  ...
  const paletteWord = task.mode === "record" ? "Record the route" : task.mode === "improve" ? "Fix the route" : "Build the route";
      ...
      <div className="mx-auto mt-4 max-w-xl">
        ...
        {status === "fail" ? (
          <p className="sp-path-shake mt-3 flex items-center justify-center gap-1.5 text-center text-sm font-black text-rose-600">
            <X className="h-4 w-4" strokeWidth={3} /> Not there yet — adjust your moves and run again.
          </p>
        ) : null}
        {status === "done" ? (
