...
export default function AssessmentQuestionCard({
  ...
  const isEarlyNumberVisual = visual?.type === "measurement_year8_panel" || visual?.type === "measurement_year7_panel" || visual?.type === "measurement_year6_panel" || visual?.type === "measurement_year5_panel" || visual?.type === "measurement_year4_panel" || visual?.type === "measurement_year3_panel" || visual?.type === "measurement_year2_panel" || visual?.type === "measurement_year1_panel" || visual?.type === "measurement_ground_panel" ||
