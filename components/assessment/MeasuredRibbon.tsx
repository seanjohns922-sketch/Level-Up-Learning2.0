...
export default function MeasuredRibbon({x,y,width,height=28,colour}:{x:number;y:number;width:number;height?:number;colour:string}) {
 const notch=Math.min(height*.45,width*.08);
 return <g>
