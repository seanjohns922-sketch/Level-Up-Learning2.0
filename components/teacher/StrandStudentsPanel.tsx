  ...
  return (
    <div className="space-y-5">
            ...
            return (
              <button
                ...
                className={[
                  ...
                  active
                    ? "border-lime-400 bg-gradient-to-b from-lime-50 to-lime-50/60 ring-2 ring-lime-300/60 shadow-[0_6px_18px_-8px_rgba(132,204,22,0.45)]"
                    : "border-[#E6E8EC] bg-white hover:border-lime-200 hover:bg-lime-50/30",
                  locked && "opacity-50 cursor-not-allowed",
                ].filter(Boolean).join(" ")}
              >
                <div className={`text-sm font-bold ${active ? "text-lime-800" : "text-[#0F172A]"}`}>
                  {g.strand}
                </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="relative overflow-hidden rounded-2xl p-5 bg-gradient-to-br from-white via-lime-50/30 to-lime-50/50 border border-lime-200/70 shadow-[0_10px_30px_-18px_rgba(132,204,22,0.45)]">
          <div className="absolute inset-y-0 left-0 w-1 bg-gradient-to-b from-lime-400 to-lime-400" />
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-extrabold text-lime-700 uppercase tracking-[0.18em]">
              Class Insight
            </span>
          ...
          <div className="mt-2 text-base font-bold text-lime-800">
            → {classInsight.gap}
          </div>
            ...
            return (
              <button
                ...
                className={[
                  ...
                  active ? "text-lime-700" : "text-[#94A3B8] hover:text-[#475569]",
                ].join(" ")}
              >
                {label}
              ...
              <div key={s.id} className="border-b border-[#F1F5F9] last:border-0">
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="h-8 w-8 rounded-full bg-gradient-to-br from-lime-400 to-lime-400 text-white flex items-center justify-center text-xs font-black shrink-0">
            ...
            return (
              <button
                ...
                className={[
                  ...
                  tone,
                  active && "ring-2 ring-lime-400 ring-offset-1",
      ...
      {week && expandedWeek === week.week && (
        <div className="bg-white rounded-2xl border border-[#E6E8EC] p-4 space-y-3">
          <div className="flex items-start justify-between gap-3 flex-wrap">
            <div>
              <div className="text-[10px] font-extrabold text-lime-700 uppercase tracking-[0.14em]">
            ...
            {week.lessons.map((lsn) => {
              ...
              return (
                <button
                  ...
                  className={[
                    "text-left rounded-xl border p-3 flex flex-col gap-2 transition hover:border-lime-300 hover:shadow-sm cursor-pointer",
                    done ? "border-emerald-200 bg-emerald-50/40" : "border-[#E6E8EC] bg-white",
                  ].join(" ")}
                >
                  <div className="flex items-center justify-between">
                    <span className="inline-flex items-center justify-center h-6 w-6 rounded-md bg-lime-50 text-lime-700 text-[11px] font-black">
                      L{lsn.lesson}
                    </span>
                    <span className={[
                  ...
                  <div className="flex items-center justify-between mt-auto pt-1">
                    ...
                    <span className="text-[10px] font-extrabold text-lime-700">
                      Preview →
                    </span>
                  </div>
                </button>
        ...
        <ul className="grid sm:grid-cols-2 gap-2">
          {insights.map((tip, i) => (
            <li key={i} className="flex items-start gap-2 text-xs text-[#0F172A] bg-[#F8FAFC] border border-[#E6E8EC] rounded-lg px-3 py-2">
              <span className="mt-0.5 h-1.5 w-1.5 rounded-full bg-lime-500 shrink-0" />
