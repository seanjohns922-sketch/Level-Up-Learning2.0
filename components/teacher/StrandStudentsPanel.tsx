  ...
  return (
    <div className="space-y-5">
            ...
            return (
              <button
                ...
                className={[
                  ...
                  active
                    ? "border-stone-500 bg-gradient-to-b from-stone-100 to-stone-100/60 ring-2 ring-stone-400/60 shadow-[0_6px_18px_-8px_rgba(120,113,108,0.45)]"
                    : "border-[#E6E8EC] bg-white hover:border-stone-300 hover:bg-stone-100/30",
                  locked && "opacity-50 cursor-not-allowed",
                ].filter(Boolean).join(" ")}
              >
                <div className={`text-sm font-bold ${active ? "text-stone-800" : "text-[#0F172A]"}`}>
                  {g.strand}
                </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="relative overflow-hidden rounded-2xl p-5 bg-gradient-to-br from-white via-stone-100/30 to-stone-100/50 border border-stone-300/70 shadow-[0_10px_30px_-18px_rgba(120,113,108,0.45)]">
          <div className="absolute inset-y-0 left-0 w-1 bg-gradient-to-b from-stone-500 to-stone-500" />
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-extrabold text-stone-700 uppercase tracking-[0.18em]">
              Class Insight
            </span>
          ...
          <div className="mt-2 text-base font-bold text-stone-800">
            → {classInsight.gap}
          </div>
            ...
            return (
              <button
                ...
                className={[
                  ...
                  active ? "text-stone-700" : "text-[#94A3B8] hover:text-[#475569]",
                ].join(" ")}
              >
                {label}
              ...
              <div key={s.id} className="border-b border-[#F1F5F9] last:border-0">
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="h-8 w-8 rounded-full bg-gradient-to-br from-stone-500 to-stone-500 text-white flex items-center justify-center text-xs font-black shrink-0">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 h-1.5 rounded-full bg-slate-100 overflow-hidden">
                      <div className="h-full bg-stone-1000 transition-all" style={{ width: `${pct}%` }} />
                    </div>
            ...
            return (
              <button
                ...
                className={[
                  ...
                  tone,
                  active && "ring-2 ring-stone-500 ring-offset-1",
      ...
      {week && expandedWeek === week.week && (
        <div className="bg-white rounded-2xl border border-[#E6E8EC] p-4 space-y-3">
          <div className="flex items-start justify-between gap-3 flex-wrap">
            <div>
              <div className="text-[10px] font-extrabold text-stone-700 uppercase tracking-[0.14em]">
            ...
            {week.lessons.map((lsn) => {
              ...
              return (
                <button
                  ...
                  className={[
                    "text-left rounded-xl border p-3 flex flex-col gap-2 transition hover:border-stone-400 hover:shadow-sm cursor-pointer",
                    done ? "border-emerald-200 bg-emerald-50/40" : "border-[#E6E8EC] bg-white",
                  ].join(" ")}
                >
                  <div className="flex items-center justify-between">
                    <span className="inline-flex items-center justify-center h-6 w-6 rounded-md bg-stone-100 text-stone-700 text-[11px] font-black">
                      L{lsn.lesson}
                    </span>
                    <span className={[
        ...
        <ul className="grid sm:grid-cols-2 gap-2">
          {insights.map((tip, i) => (
            <li key={i} className="flex items-start gap-2 text-xs text-[#0F172A] bg-[#F8FAFC] border border-[#E6E8EC] rounded-lg px-3 py-2">
              <span className="mt-0.5 h-1.5 w-1.5 rounded-full bg-stone-1000 shrink-0" />
