...
import {fetchStatisticsExtensionAssessments,type NormalizedAssessmentAttempt} from '@/lib/realm-progress-compat';
...
export default function StatisticsExtensionReport(props:{studentId:string;studentName:string}){return <div className="space-y-4"><ExtensionLevelReport {...props} level={7}/><ExtensionLevelReport {...props} level={8}/></div>;}
